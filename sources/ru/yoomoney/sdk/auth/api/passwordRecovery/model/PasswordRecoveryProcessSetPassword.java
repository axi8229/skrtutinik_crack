...
public final /* data */ class PasswordRecoveryProcessSetPassword extends PasswordRecoveryProcess {
    ...
    public PasswordRecoveryProcessSetPassword(String id, OffsetDateTime expireAt, boolean z) {
        super(null);
    ...
    public static /* synthetic */ PasswordRecoveryProcessSetPassword copy$default(PasswordRecoveryProcessSetPassword passwordRecoveryProcessSetPassword, String str, OffsetDateTime offsetDateTime, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 4) != 0) {
            z = passwordRecoveryProcessSetPassword.addToBackStack;
        }
        return passwordRecoveryProcessSetPassword.copy(str, offsetDateTime, z);
    }
    ...
    public final PasswordRecoveryProcessSetPassword copy(String id, OffsetDateTime expireAt, boolean addToBackStack) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(expireAt, "expireAt");
        return new PasswordRecoveryProcessSetPassword(id, expireAt, addToBackStack);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.id, passwordRecoveryProcessSetPassword.id) && Intrinsics.areEqual(this.expireAt, passwordRecoveryProcessSetPassword.expireAt) && this.addToBackStack == passwordRecoveryProcessSetPassword.addToBackStack;
    }
