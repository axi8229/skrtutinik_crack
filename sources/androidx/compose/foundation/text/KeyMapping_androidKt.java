...
public final class KeyMapping_androidKt {
    private static final KeyMapping platformDefaultKeyMapping = new KeyMapping() { // from class: androidx.compose.foundation.text.KeyMapping_androidKt$platformDefaultKeyMapping$1
        ...
        public KeyCommand mo414mapZmokQxo(KeyEvent event) {
            KeyCommand keyCommand = null;
            if (KeyEvent_androidKt.m1298isShiftPressedZmokQxo(event) && KeyEvent_androidKt.m1296isAltPressedZmokQxo(event)) {
            ...
            return keyCommand == null ? KeyMappingKt.getDefaultKeyMapping().mo414mapZmokQxo(event) : keyCommand;
        }
    };
