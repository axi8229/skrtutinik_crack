...
public final class PointerKeyboardModifiers {
    ...
    public static final /* synthetic */ PointerKeyboardModifiers m1368boximpl(int i) {
    ...
    public static boolean m1370equalsimpl(int i, Object obj) {
        return (obj instanceof PointerKeyboardModifiers) && i == ((PointerKeyboardModifiers) obj).getPackedValue();
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1371hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1372toStringimpl(int i) {
        return "PointerKeyboardModifiers(packedValue=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m1370equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1371hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m1372toStringimpl(this.packedValue);
    }
