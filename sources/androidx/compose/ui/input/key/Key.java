...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\b\b\u0087@\u0018\u0000 \u00162\u00020\u0001:\u0001\u0016B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u000f\u0010\t\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u0007\u0010\bJ\u0010\u0010\r\u001a\u00020\nHÖ\u0001¢\u0006\u0004\b\u000b\u0010\fJ\u001a\u0010\u0012\u001a\u00020\u000f2\b\u0010\u000e\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u0010\u0010\u0011R\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0013\u001a\u0004\b\u0014\u0010\u0015\u0088\u0001\u0003\u0092\u0001\u00020\u0002¨\u0006\u0017"}, d2 = {"Landroidx/compose/ui/input/key/Key;", "", "", "keyCode", "constructor-impl", "(J)J", "", "toString-impl", "(J)Ljava/lang/String;", "toString", "", "hashCode-impl", "(J)I", "hashCode", "other", "", "equals-impl", "(JLjava/lang/Object;)Z", "equals", "J", "getKeyCode", "()J", "Companion", "ui_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
@JvmInline
...
public final class Key {
    ...
    private static final long Button12 = Key_androidKt.Key(pjsip_status_code.PJSIP_SC_EARLY_DIALOG_TERMINATED);
    private static final long Button13 = Key_androidKt.Key(200);
    private static final long Button14 = Key_androidKt.Key(201);
    private static final long Button15 = Key_androidKt.Key(pjsip_status_code.PJSIP_SC_ACCEPTED);
    private static final long Button16 = Key_androidKt.Key(203);
    private static final long Forward = Key_androidKt.Key(125);
    private static final long F1 = Key_androidKt.Key(pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6);
    private static final long F2 = Key_androidKt.Key(pjsip_transport_type_e.PJSIP_TRANSPORT_DTLS6);
    ...
    private static final long NumPad6 = Key_androidKt.Key(TimelineAnimator.DURATION);
    ...
    private static final long MediaRecord = Key_androidKt.Key(pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6);
    ...
    private static final long MediaEject = Key_androidKt.Key(pjsip_transport_type_e.PJSIP_TRANSPORT_UDP6);
    ...
    private static final long SetTopBoxInput = Key_androidKt.Key(pjsip_status_code.PJSIP_SC_RINGING);
    private static final long AvReceiverPower = Key_androidKt.Key(pjsip_status_code.PJSIP_SC_CALL_BEING_FORWARDED);
    private static final long AvReceiverInput = Key_androidKt.Key(pjsip_status_code.PJSIP_SC_QUEUED);
    private static final long ProgramRed = Key_androidKt.Key(pjsip_status_code.PJSIP_SC_PROGRESS);
    ...
    private static final long LanguageSwitch = Key_androidKt.Key(pjsip_status_code.PJSIP_SC_NO_NOTIFICATION);
    ...
    private static final long TvZoomMode = Key_androidKt.Key(KotlinVersion.MAX_COMPONENT_VALUE);
    ...
    public static final /* synthetic */ Key m1263boximpl(long j) {
        return new Key(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1264constructorimpl(long j) {
        return j;
    }
    ...
    public static int m1267hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m1265equalsimpl(this.keyCode, obj);
    }

    public int hashCode() {
        return m1267hashCodeimpl(this.keyCode);
    }
    ...
    public static final class Companion {
        ...
        public final long m1270getBackEK5gGoQ() {
            return Key.Back;
        }

        /* renamed from: getDirectionUp-EK5gGoQ, reason: not valid java name */
        public final long m1275getDirectionUpEK5gGoQ() {
            return Key.DirectionUp;
        }

        /* renamed from: getDirectionDown-EK5gGoQ, reason: not valid java name */
        public final long m1272getDirectionDownEK5gGoQ() {
            return Key.DirectionDown;
        }

        /* renamed from: getDirectionLeft-EK5gGoQ, reason: not valid java name */
        public final long m1273getDirectionLeftEK5gGoQ() {
            return Key.DirectionLeft;
        }

        /* renamed from: getDirectionRight-EK5gGoQ, reason: not valid java name */
        public final long m1274getDirectionRightEK5gGoQ() {
            return Key.DirectionRight;
        }

        /* renamed from: getDirectionCenter-EK5gGoQ, reason: not valid java name */
        public final long m1271getDirectionCenterEK5gGoQ() {
            return Key.DirectionCenter;
        }

        /* renamed from: getTab-EK5gGoQ, reason: not valid java name */
        public final long m1281getTabEK5gGoQ() {
            return Key.Tab;
        }

        /* renamed from: getEnter-EK5gGoQ, reason: not valid java name */
        public final long m1276getEnterEK5gGoQ() {
            return Key.Enter;
        }

        /* renamed from: getEscape-EK5gGoQ, reason: not valid java name */
        public final long m1277getEscapeEK5gGoQ() {
            return Key.Escape;
        }

        /* renamed from: getPageUp-EK5gGoQ, reason: not valid java name */
        public final long m1280getPageUpEK5gGoQ() {
            return Key.PageUp;
        }

        /* renamed from: getPageDown-EK5gGoQ, reason: not valid java name */
        public final long m1279getPageDownEK5gGoQ() {
            return Key.PageDown;
        }

        /* renamed from: getNumPadEnter-EK5gGoQ, reason: not valid java name */
        public final long m1278getNumPadEnterEK5gGoQ() {
    ...
    public static String m1268toStringimpl(long j) {
        return "Key code: " + j;
    }

    public String toString() {
        return m1268toStringimpl(this.keyCode);
    }
}
