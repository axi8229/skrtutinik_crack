...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m393schedulePrefetchVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    public final PrefetchRequest m392createNestedPrefetchRequestVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    private final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest {
        ...
        public boolean execute(PrefetchRequestScope prefetchRequestScope) {
            ...
            if (!this.isMeasured && !Constraints.m2088isZeroimpl(this.constraints)) {
                ...
                try {
                    m394performMeasureBRTryo0(this.constraints);
        ...
        private final void m394performMeasureBRTryo0(long constraints) {
            if (this.isCanceled) {
            ...
            for (int i = 0; i < placeablesCount; i++) {
                precomposedSlotHandle.mo1432premeasure0kLqBqw(i, constraints);
            }
        }
        ...
        public String toString() {
            return "HandleAndRequestImpl { index = " + this.index + ", constraints = " + ((Object) Constraints.m2089toStringimpl(this.constraints)) + ", isComposed = " + isComposed() + ", isMeasured = " + this.isMeasured + ", isCanceled = " + this.isCanceled + " }";
        }
