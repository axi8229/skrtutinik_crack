...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m957getSrcOver0nO6VwU();
    }
    ...
    public long mo904getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo909setColor8_81llA(long j) {
        AndroidPaint_androidKt.m915setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo908setBlendModes9anfk8(int i) {
        if (BlendMode.m927equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m914setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo913setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m919setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo906getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo911setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m917setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo907getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo912setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m918setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo905getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo910setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m916setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
