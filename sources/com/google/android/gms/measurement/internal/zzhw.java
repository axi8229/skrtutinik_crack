...
final class zzhw<V> extends FutureTask<V> implements Comparable<zzhw<V>> {
    ...
    zzhw(zzhv zzhvVar, Runnable runnable, boolean z, String str) throws IllegalStateException {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    zzhw(zzhv zzhvVar, Callable<V> callable, boolean z, String str) throws IllegalStateException {
