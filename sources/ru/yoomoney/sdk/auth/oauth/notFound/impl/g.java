...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.oauth.notFound.impl.OauthNotFoundBusinessLogic$handleProgressLoginState$2$1", f = "OauthNotFoundBusinessLogic.kt", l = {81}, m = "invokeSuspend")
...
public final class g extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public g(OauthNotFoundBusinessLogic oauthNotFoundBusinessLogic, OauthNotFound.Action action, Continuation<? super g> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            OauthNotFound.Effect.ShowFailure showFailure = new OauthNotFound.Effect.ShowFailure(((OauthNotFound.Action.LoginFailure) this.c).getFailure());
            this.a = 1;
