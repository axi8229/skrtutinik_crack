...
public final class JsonKeysetWriter implements KeysetWriter {
    ...
    private JsonObject toJson(Keyset.Key key) {
        ...
        jsonObject.addProperty(UpdateKey.STATUS, key.getStatus().name());
    ...
    private JsonObject toJson(KeyData keyData) {
        ...
        jsonObject.addProperty(AppMeasurementSdk.ConditionalUserProperty.VALUE, Base64.encode(keyData.getValue().toByteArray()));
    ...
    private JsonObject toJson(KeysetInfo.KeyInfo keyInfo) {
        ...
        jsonObject.addProperty(UpdateKey.STATUS, keyInfo.getStatus().name());
