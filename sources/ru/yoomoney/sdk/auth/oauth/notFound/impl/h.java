...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.oauth.notFound.impl.OauthNotFoundBusinessLogic$handleProgressLoginState$2$2", f = "OauthNotFoundBusinessLogic.kt", l = {82}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class h extends SuspendLambda implements Function1<Continuation<? super OauthNotFound.Action>, Object> {
    public int a;
    ...
    public h(OauthNotFoundBusinessLogic oauthNotFoundBusinessLogic, Out.Builder<OauthNotFound.State.Content, OauthNotFound.Action> builder, Continuation<? super h> continuation) {
