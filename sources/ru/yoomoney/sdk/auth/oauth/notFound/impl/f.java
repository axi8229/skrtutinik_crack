...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.oauth.notFound.impl.OauthNotFoundBusinessLogic$handleProgressLoginState$1$2", f = "OauthNotFoundBusinessLogic.kt", l = {78}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class f extends SuspendLambda implements Function1<Continuation<? super OauthNotFound.Action>, Object> {
    public int a;
    ...
    public f(OauthNotFoundBusinessLogic oauthNotFoundBusinessLogic, Out.Builder<OauthNotFound.State.Content, OauthNotFound.Action> builder, Continuation<? super f> continuation) {
