...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2787receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object objMo2787receiveCatchingJP2dKIU = this._channel.mo2787receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2788tryReceivePtdJZtk() {
        return this._channel.mo2788tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2240trySendJP2dKIU(E element) {
        return this._channel.mo2240trySendJP2dKIU(element);
    }
