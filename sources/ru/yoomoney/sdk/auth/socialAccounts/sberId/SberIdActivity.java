...
@Metadata(d1 = {"\u0000z\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u000e\b\u0000\u0018\u0000 A2\u00020\u0001:\u0001AB\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010'\u001a\u00020(2\u0006\u0010)\u001a\u00020*H\u0002J\b\u0010+\u001a\u00020(H\u0002J\u0012\u0010,\u001a\u00020(2\b\u0010-\u001a\u0004\u0018\u00010.H\u0014J\u0010\u0010/\u001a\u00020(2\u0006\u00100\u001a\u000201H\u0014J\u0010\u00102\u001a\u00020\r2\u0006\u00103\u001a\u000204H\u0016J\b\u00105\u001a\u00020(H\u0014J\u0010\u00106\u001a\u00020(2\u0006\u00107\u001a\u00020.H\u0014J\u0010\u00108\u001a\u00020(2\u0006\u00109\u001a\u00020\rH\u0002J\u0010\u0010:\u001a\u00020(2\u0006\u0010;\u001a\u00020\rH\u0002J\u0010\u0010<\u001a\u00020(2\u0006\u0010=\u001a\u00020\u001dH\u0002J\b\u0010>\u001a\u00020(H\u0002J\u0010\u0010?\u001a\u00020(2\u0006\u0010@\u001a\u00020\u001bH\u0002R\u0016\u0010\u0003\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00050\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u001b\u0010\u0006\u001a\u00020\u00078BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\b\u0010\tR\u000e\u0010\f\u001a\u00020\rX\u0082\u000e¢\u0006\u0002\n\u0000R#\u0010\u000e\u001a\n \u0010*\u0004\u0018\u00010\u000f0\u000f8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0013\u0010\u000b\u001a\u0004\b\u0011\u0010\u0012R#\u0010\u0014\u001a\n \u0010*\u0004\u0018\u00010\u00150\u00158BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0018\u0010\u000b\u001a\u0004\b\u0016\u0010\u0017R1\u0010\u0019\u001a\u0018\u0012\u0004\u0012\u00020\u001b\u0012\u0004\u0012\u00020\u001c\u0012\u0004\u0012\u00020\u001d0\u001aj\u0002`\u001e8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b!\u0010\u000b\u001a\u0004\b\u001f\u0010 R#\u0010\"\u001a\n \u0010*\u0004\u0018\u00010#0#8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b&\u0010\u000b\u001a\u0004\b$\u0010%¨\u0006B"}, d2 = {"Lru/yoomoney/sdk/auth/socialAccounts/sberId/SberIdActivity;", "Landroidx/appcompat/app/AppCompatActivity;", "()V", SberIdActivity.KEY_CONFIG, "Lkotlin/Lazy;", "Lru/yoomoney/sdk/auth/Config;", "factory", "Landroidx/lifecycle/ViewModelProvider$Factory;", "getFactory", "()Landroidx/lifecycle/ViewModelProvider$Factory;", "factory$delegate", "Lkotlin/Lazy;", SberIdActivity.KEY_IS_INITIALIZED, "", "stateFlipper", "Lru/yoomoney/sdk/gui/widget/StateFlipViewGroup;", "kotlin.jvm.PlatformType", "getStateFlipper", "()Lru/yoomoney/sdk/gui/widget/StateFlipViewGroup;", "stateFlipper$delegate", "topBar", "Lru/yoomoney/sdk/auth/ui/TopBarDefault;", "getTopBar", "()Lru/yoomoney/sdk/auth/ui/TopBarDefault;", "topBar$delegate", "viewModel", "Lru/yoomoney/sdk/march/RuntimeViewModel;", "Lru/yoomoney/sdk/auth/socialAccounts/sberId/SberId$State;", "Lru/yoomoney/sdk/auth/socialAccounts/sberId/SberId$Action;", "Lru/yoomoney/sdk/auth/socialAccounts/sberId/SberId$Effect;", "Lru/yoomoney/sdk/auth/socialAccounts/sberId/impl/SberIdViewModel;", "getViewModel", "()Lru/yoomoney/sdk/march/RuntimeViewModel;", "viewModel$delegate", "waitingView", "Lru/yoomoney/sdk/auth/ui/EmptyStateLargeView;", "getWaitingView", "()Lru/yoomoney/sdk/auth/ui/EmptyStateLargeView;", "waitingView$delegate", "finishWithResult", "", RemoteMessageConst.DATA, "Landroid/net/Uri;", "initViews", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "onNewIntent", CommonCode.Resolution.HAS_RESOLUTION_FROM_APK, "Landroid/content/Intent;", "onOptionsItemSelected", "item", "Landroid/view/MenuItem;", "onResume", "onSaveInstanceState", "outState", "setContainerVisibility", "isVisible", "setDimEnabled", "isEnabled", "showEffect", "effect", "showOpenSberDialog", "showState", "state", "Companion", "auth_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class SberIdActivity extends AppCompatActivity {
    ...
    public static final class Companion {
        ...
        public final Intent createIntent(Context context, Config config, SberOauthCodeParameters parameters, String sberReturnUrl, String sberDialogText) {
            ...
            Intrinsics.checkNotNullParameter(sberReturnUrl, "sberReturnUrl");
    ...
    public static final class b extends Lambda implements Function0<SberIdViewModelFactoryImpl> {
    ...
    public static final class c extends Lambda implements Function0<Unit> {
        ...
        public final Unit invoke() {
            SberIdActivity.this.getViewModel().handleAction(SberId.Action.Open.INSTANCE);
            return Unit.INSTANCE;
        }
    }

    public /* synthetic */ class d extends FunctionReferenceImpl implements Function1<SberId.State, Unit> {
        public d(Object obj) {
            super(1, obj, SberIdActivity.class, "showState", "showState(Lru/yoomoney/sdk/auth/socialAccounts/sberId/SberId$State;)V", 0);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(SberId.State state) {
            SberId.State p0 = state;
            Intrinsics.checkNotNullParameter(p0, "p0");
            ((SberIdActivity) this.receiver).showState(p0);
            return Unit.INSTANCE;
        }
    }

    public /* synthetic */ class e extends FunctionReferenceImpl implements Function1<SberId.Effect, Unit> {
        public e(Object obj) {
            super(1, obj, SberIdActivity.class, "showEffect", "showEffect(Lru/yoomoney/sdk/auth/socialAccounts/sberId/SberId$Effect;)V", 0);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(SberId.Effect effect) {
            SberId.Effect p0 = effect;
            Intrinsics.checkNotNullParameter(p0, "p0");
            ((SberIdActivity) this.receiver).showEffect(p0);
            return Unit.INSTANCE;
        }
    }
    ...
    public SberIdActivity() {
        final Function0 function0 = null;
        this.viewModel = new ViewModelLazy(Reflection.getOrCreateKotlinClass(RuntimeViewModel.class), new Function0<ViewModelStore>() { // from class: ru.yoomoney.sdk.auth.socialAccounts.sberId.SberIdActivity$special$$inlined$viewModels$default$2
            {
                super(0);
            }
        ...
        }, new i(), new Function0<CreationExtras>() { // from class: ru.yoomoney.sdk.auth.socialAccounts.sberId.SberIdActivity$special$$inlined$viewModels$default$3
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final RuntimeViewModel<SberId.State, SberId.Action, SberId.Effect> getViewModel() {
    ...
    public static final void onResume$lambda$0(SberIdActivity this$0) {
        ...
        if ((intent != null ? intent.getData() : null) == null) {
            this$0.getViewModel().handleAction(SberId.Action.WaitForDeeplink.INSTANCE);
        }
    }
    ...
    public final void showEffect(final SberId.Effect effect) {
        ...
        if (effect instanceof SberId.Effect.FinishWithData) {
            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: ru.yoomoney.sdk.auth.socialAccounts.sberId.SberIdActivity$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SberIdActivity.showEffect$lambda$3(this.f$0, effect);
                }
            }, FINISH_VIEW_DELAY);
            return;
        }
        if (effect instanceof SberId.Effect.Open) {
            ...
            if (stringExtra == null || sberOauthCodeParameters == null) {
                getViewModel().handleAction(SberId.Action.Cancel.INSTANCE);
            } else {
    ...
    private final void showOpenSberDialog() {
        ...
        YmAlertDialog.DialogContent dialogContent = new YmAlertDialog.DialogContent(getIntent().getStringExtra(EXTRA_SBER_OAUTH_DIALOG_TEXT), null, getString(R.string.auth_loading_social_account_dialog_ok), getString(R.string.auth_loading_social_account_dialog_cancel), false, false, 50, null);
        AlertDialog.Companion companion = AlertDialog.INSTANCE;
        FragmentManager supportFragmentManager = getSupportFragmentManager();
        Intrinsics.checkNotNullExpressionValue(supportFragmentManager, "getSupportFragmentManager(...)");
        AlertDialog alertDialogCreate = companion.create(supportFragmentManager, dialogContent);
        alertDialogCreate.attachListener(new YmAlertDialog.DialogListener() { // from class: ru.yoomoney.sdk.auth.socialAccounts.sberId.SberIdActivity$showOpenSberDialog$1$1
            @Override // ru.yoomoney.sdk.gui.dialog.YmAlertDialog.DialogListener
            public void onDismiss() {
                this.this$0.getViewModel().handleAction(SberId.Action.Cancel.INSTANCE);
            }
            ...
            public void onPositiveClick() {
                this.this$0.getViewModel().handleAction(SberId.Action.Open.INSTANCE);
            }
        });
        FragmentManager supportFragmentManager2 = getSupportFragmentManager();
        Intrinsics.checkNotNullExpressionValue(supportFragmentManager2, "getSupportFragmentManager(...)");
        alertDialogCreate.show(supportFragmentManager2);
    }
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (data != null) {
            getViewModel().handleAction(new SberId.Action.DeeplinkReceived(data));
        } else {
            getViewModel().handleAction(SberId.Action.WaitForDeeplink.INSTANCE);
        }
    }
    ...
    public void onResume() {
        RuntimeViewModel<SberId.State, SberId.Action, SberId.Effect> viewModel;
        SberId.Action action;
        super.onResume();
        if (this.isInitialized) {
            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: ru.yoomoney.sdk.auth.socialAccounts.sberId.SberIdActivity$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    SberIdActivity.onResume$lambda$0(this.f$0);
                }
