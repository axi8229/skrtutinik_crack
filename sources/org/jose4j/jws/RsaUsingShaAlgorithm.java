...
public class RsaUsingShaAlgorithm extends BaseSignatureAlgorithm implements JsonWebSignatureAlgorithm {
    ...
    public static class RsaPssSha256 extends RsaUsingShaAlgorithm {
        public RsaPssSha256() {
            super("PS256", RsaUsingShaAlgorithm.choosePssAlgorithmName("SHA256withRSAandMGF1"));
            if (getJavaAlgorithm().equals("RSASSA-PSS")) {
    ...
    public static class RsaPssSha384 extends RsaUsingShaAlgorithm {
        public RsaPssSha384() {
            super("PS384", RsaUsingShaAlgorithm.choosePssAlgorithmName("SHA384withRSAandMGF1"));
            if (getJavaAlgorithm().equals("RSASSA-PSS")) {
    ...
    public static class RsaPssSha512 extends RsaUsingShaAlgorithm {
        public RsaPssSha512() {
            super("PS512", RsaUsingShaAlgorithm.choosePssAlgorithmName("SHA512withRSAandMGF1"));
            if (getJavaAlgorithm().equals("RSASSA-PSS")) {
