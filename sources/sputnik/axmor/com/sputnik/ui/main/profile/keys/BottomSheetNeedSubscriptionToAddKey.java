...
public final class BottomSheetNeedSubscriptionToAddKey extends BaseBottomSheetDialogFragment<BottomSheetKeyAddNeedSubscriptionBinding> {
    ...
    /* renamed from: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$1, reason: invalid class name */
    ...
    public BottomSheetNeedSubscriptionToAddKey() {
        super(AnonymousClass1.INSTANCE);
        this.navController = LazyKt.lazy(new Function0<NavController>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$navController$2
            {
                super(0);
            }
        ...
        this.keysViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(KeysViewModel.class), new Function0<ViewModelStore>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$special$$inlined$activityViewModels$default$1
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$special$$inlined$activityViewModels$default$2
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$keysViewModel$2
            {
                super(0);
            }
        ...
        this.navigationViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(NavigationViewModel.class), new Function0<ViewModelStore>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$special$$inlined$activityViewModels$default$4
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$special$$inlined$activityViewModels$default$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$navigationViewModel$2
            {
                super(0);
            }
        ...
        this.profileViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(ProfileViewModel.class), new Function0<ViewModelStore>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$special$$inlined$activityViewModels$default$7
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$special$$inlined$activityViewModels$default$8
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$profileViewModel$2
            {
                super(0);
            }
        ...
        this.subscriptionsViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(SubscriptionsViewModel.class), new Function0<ViewModelStore>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$special$$inlined$activityViewModels$default$10
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$special$$inlined$activityViewModels$default$11
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$subscriptionsViewModel$2
            {
                super(0);
            }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getAnalytics().trackLogEvent(new KeysEvents.StateSubscribeKeyPopup());
    ...
    public void initViews() {
        ...
        SafeClickListenerKt.setSafeOnClickListener$default(btnApply, 0L, new Function1<View, Unit>() { // from class: sputnik.axmor.com.sputnik.ui.main.profile.keys.BottomSheetNeedSubscriptionToAddKey$initViews$1$1
            {
                super(1);
            }
    ...
    public void localize() {
        ...
        PhysicalKeysLocale.NeedSubscriptionPopup registerKeyErrorPopup;
        ...
        if (localizationStorage == null || (data = localizationStorage.getData()) == null || (physicalKeys = data.getPhysicalKeys()) == null || (registerKeyErrorPopup = physicalKeys.getRegisterKeyErrorPopup()) == null) {
            return;
        }
        binding.tvTitle.setText(StringUtilsKt.orEmpty(registerKeyErrorPopup.getTitle()));
        TextView textView = binding.tvSubtitle;
        TitleWithParam subtitle = registerKeyErrorPopup.getSubtitle();
        String priceText = null;
        String strValueOf = String.valueOf(subtitle != null ? subtitle.getTitle() : null);
        TitleWithParam subtitle2 = registerKeyErrorPopup.getSubtitle();
        textView.setText(ViewUtilsKt.highlightText(strValueOf, String.valueOf(subtitle2 != null ? subtitle2.getParam1() : null), ContextCompat.getColor(requireContext(), R.color.sputnik_blue)));
        ...
        if (discountPrice != null) {
            ...
            String strValueOf2 = String.valueOf((data2 == null || (subscriptionBuy2 = data2.getSubscriptionBuy()) == null || (body2 = subscriptionBuy2.getBody()) == null || (buyButton2 = body2.getBuyButton()) == null) ? null : buyButton2.getTitle());
        ...
        String strValueOf3 = String.valueOf((data3 == null || (subscriptionBuy = data3.getSubscriptionBuy()) == null || (body = subscriptionBuy.getBody()) == null || (buyButton = body.getBuyButton()) == null) ? null : buyButton.getTitle());
        ...
        appCompatButton.setText(StringUtilsKt.formatSafe(strValueOf3, strOrEmpty3 + " " + priceText));
    }
}
