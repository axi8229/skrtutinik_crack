...
public final /* data */ class Style implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<Style> {
        ...
        public final Style createFromParcel(Parcel parcel) {
            ...
            PaletteParcelable paletteParcelableCreateFromParcel = parcel.readInt() == 0 ? null : PaletteParcelable.CREATOR.createFromParcel(parcel);
            if (parcel.readInt() != 0) {
                int i = parcel.readInt();
                ArrayList arrayList2 = new ArrayList(i);
                for (int i2 = 0; i2 != i; i2++) {
                    arrayList2.add(FontResource.CREATOR.createFromParcel(parcel));
                }
                arrayList = arrayList2;
            }
            return new Style(z, paletteParcelableCreateFromParcel, arrayList);
        }
    ...
    public static /* synthetic */ Style copy$default(Style style, boolean z, PaletteParcelable paletteParcelable, List list, int i, Object obj) {
        if ((i & 1) != 0) {
            z = style.darkTheme;
        }
        if ((i & 2) != 0) {
            paletteParcelable = style.palette;
        }
        if ((i & 4) != 0) {
            list = style.fontResources;
        }
        return style.copy(z, paletteParcelable, list);
    }
    ...
    public final Style copy(boolean darkTheme, PaletteParcelable palette, List<FontResource> fontResources) {
        return new Style(darkTheme, palette, fontResources);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.darkTheme == style.darkTheme && Intrinsics.areEqual(this.palette, style.palette) && Intrinsics.areEqual(this.fontResources, style.fontResources);
    }
    ...
    public String toString() {
        return "Style(darkTheme=" + this.darkTheme + ", palette=" + this.palette + ", fontResources=" + this.fontResources + ")";
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        PaletteParcelable paletteParcelable = this.palette;
        if (paletteParcelable == null) {
            parcel.writeInt(0);
        } else {
            parcel.writeInt(1);
            paletteParcelable.writeToParcel(parcel, flags);
        }
        List<FontResource> list = this.fontResources;
        if (list == null) {
            parcel.writeInt(0);
    ...
    public Style(boolean z, PaletteParcelable paletteParcelable, List<FontResource> list) {
        this.darkTheme = z;
        this.palette = paletteParcelable;
        this.fontResources = list;
    }

    public /* synthetic */ Style(boolean z, PaletteParcelable paletteParcelable, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {
