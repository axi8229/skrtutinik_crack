...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.confirm.impl.EmailConfirmBusinessLogic$handleProgressState$7$1", f = "EmailConfirmBusinessLogic.kt", l = {254}, m = "invokeSuspend")
...
public final class u extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public u(EmailConfirmBusinessLogic emailConfirmBusinessLogic, Continuation<? super u> continuation) {
