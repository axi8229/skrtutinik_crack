...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    public long getMediaTimeForChildMediaTime(Void id, long mediaTimeMs) {
        ...
        long jMax = Math.max(0L, mediaTimeMs - jUsToMs);
        long j = this.endUs;
        return j != Long.MIN_VALUE ? Math.min(C.usToMs(j) - jUsToMs, jMax) : jMax;
    }
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public ClippingTimeline(Timeline timeline, long startUs, long endUs) throws IllegalClippingException {
            ...
            if (window.isDynamic && (jMax2 == -9223372036854775807L || (j != -9223372036854775807L && jMax2 == j))) {
                z = true;
            }
            this.isDynamic = z;
        }
        ...
        public Timeline.Window getWindow(int windowIndex, Timeline.Window window, long defaultPositionProjectionUs) {
            ...
            long j = window.positionInFirstPeriodUs;
            long j2 = this.startUs;
            window.positionInFirstPeriodUs = j + j2;
            window.durationUs = this.durationUs;
            window.isDynamic = this.isDynamic;
            long j3 = window.defaultPositionUs;
            if (j3 != -9223372036854775807L) {
                long jMax = Math.max(j3, j2);
            ...
            long jUsToMs = C.usToMs(this.startUs);
            long j5 = window.presentationStartTimeMs;
            if (j5 != -9223372036854775807L) {
                window.presentationStartTimeMs = j5 + jUsToMs;
            }
            long j6 = window.windowStartTimeMs;
            if (j6 != -9223372036854775807L) {
                window.windowStartTimeMs = j6 + jUsToMs;
            }
            return window;
        }
