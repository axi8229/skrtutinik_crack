...
public final class EnterCodeFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        viewModel.observeState(viewLifecycleOwner, new C07501(this));
        CallCodeViewModel viewModel2 = getViewModel();
        LifecycleOwner viewLifecycleOwner2 = getViewLifecycleOwner();
        Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner2, "getViewLifecycleOwner(...)");
        viewModel2.observeSubState(viewLifecycleOwner2, new Function1<CallCodeViewState, Event<? extends Boolean>>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment.onViewCreated.2
            @Override // kotlin.jvm.functions.Function1
            public final Event<Boolean> invoke(CallCodeViewState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return it.isLoaded();
            }
        }, new Function1<Event<? extends Boolean>, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment.onViewCreated.3
            {
                super(1);
            }
            ...
            public final void invoke2(Event<Boolean> it) {
                ...
                if (contentIfNotHandled != null) {
                    final EnterCodeFragment enterCodeFragment = EnterCodeFragment.this;
                    if (contentIfNotHandled.booleanValue()) {
                        enterCodeFragment.getProfileViewModel().delayRequest(500L, new Function0<Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$onViewCreated$3$1$1
                            {
                                super(0);
                            }
                            ...
                            public final void invoke2() {
                                IProfileViewModel.DefaultImpls.loadProfile$default(enterCodeFragment.getProfileViewModel(), false, 1, null);
                            }
                        });
                    }
                }
        ...
        viewModel4.observeNotifications(viewLifecycleOwner4, new Function1<Notify, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment.onViewCreated.6
            {
                super(1);
            }
            ...
            public final void invoke2(Notify it) {
                ...
                NestedScrollView root = enterCodeFragment.getBinding().getRoot();
                Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
                ViewKt.renderNotifications(enterCodeFragment, root, it);
            }
        });
        ...
        loginViewModel2.observeNotifications(viewLifecycleOwner6, new Function1<Notify, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment.onViewCreated.8
            {
                super(1);
            }
        ...
        profileViewModel.observeSubState(viewLifecycleOwner7, new Function1<ProfileViewState, Resource.Status>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment.onViewCreated.9
            @Override // kotlin.jvm.functions.Function1
            public final Resource.Status invoke(ProfileViewState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return it.getProfileServerState();
            }
        }, new Function1<Resource.Status, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment.onViewCreated.10
            {
                super(1);
            }
            ...
            public final void invoke2(Resource.Status it) {
                ...
                if (it == Resource.Status.ERROR) {
                    LinearLayout layoutProgress = EnterCodeFragment.this.getBinding().layoutProgress;
        ...
        profileViewModel2.observeSubState(viewLifecycleOwner8, new Function1<ProfileViewState, Event<? extends ProfileNavigationState>>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment.onViewCreated.11
            @Override // kotlin.jvm.functions.Function1
            public final Event<ProfileNavigationState> invoke(ProfileViewState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return it.getProfileState();
            }
        }, new Function1<Event<? extends ProfileNavigationState>, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment.onViewCreated.12
            {
                super(1);
            }
            ...
            public final void invoke2(Event<? extends ProfileNavigationState> it) throws Resources.NotFoundException {
                ...
                if (contentIfNotHandled != null) {
                    EnterCodeFragment enterCodeFragment = EnterCodeFragment.this;
                    enterCodeFragment.getLoginViewModel().clearToRequestCode();
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToRegistrationState) {
                        PinView viewPin = enterCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin, "viewPin");
                        ViewKt.hideKeyboard(viewPin);
                        enterCodeFragment.getAnalytics().trackLogEvent(new AnalyticsTracker.Event("account_state", "unregistered", null, 4, null));
                        NavControllerKt.safeNavigate$default(FragmentKt.findNavController(enterCodeFragment), R$id.enterCodeFragment, R$id.action_enterCodeFragment_to_enterNameFragment, null, null, 12, null);
                        return;
                    }
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToVerifyAddressState) {
                        PinView viewPin2 = enterCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin2, "viewPin");
                        ViewKt.hideKeyboard(viewPin2);
                        NavControllerKt.safeNavigate$default(FragmentKt.findNavController(enterCodeFragment), R$id.enterCodeFragment, R$id.action_enterCodeFragment_to_confirmAddressFragment, null, null, 12, null);
                        return;
                    }
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToEnterFlatNumberState) {
                        PinView viewPin3 = enterCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin3, "viewPin");
                        ViewKt.hideKeyboard(viewPin3);
                        NavControllerKt.safeNavigate$default(FragmentKt.findNavController(enterCodeFragment), R$id.enterCodeFragment, R$id.action_enterCodeFragment_to_enterFlatNumberFragment, null, null, 12, null);
                        return;
                    }
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToIntercomState) {
                        PinView viewPin4 = enterCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin4, "viewPin");
                        ViewKt.hideKeyboard(viewPin4);
                        NavControllerKt.safeNavigate$default(FragmentKt.findNavController(enterCodeFragment), R$id.enterCodeFragment, R$id.action_enterCodeFragment_to_connectToIntercomFragment, null, null, 12, null);
                        return;
                    }
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToActivatedState) {
                        PinView viewPin5 = enterCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin5, "viewPin");
                        ViewKt.hideKeyboard(viewPin5);
                        Uri uri = Uri.parse(enterCodeFragment.getString(R$string.deeplink_main));
                        enterCodeFragment.getCamerasViewModel().setNeedLoadCameras(true);
                        FragmentKt.findNavController(enterCodeFragment).popBackStack(R$id.selectAccountFragment, true);
                        NavController navControllerFindNavController = FragmentKt.findNavController(enterCodeFragment);
    ...
    /* compiled from: EnterCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterCodeFragment$onViewCreated$1, reason: invalid class name and case insensitive filesystem */
    /* synthetic */ class C07501 extends FunctionReferenceImpl implements Function1<CallCodeViewState, Unit> {
        C07501(Object obj) {
            super(1, obj, EnterCodeFragment.class, "renderUi", "renderUi(Lcom/sputnik/common/viewmodels/CallCodeViewState;)V", 0);
        }
        ...
        public final void invoke2(CallCodeViewState p0) {
            ...
            ((EnterCodeFragment) this.receiver).renderUi(p0);
        }
    }

    /* compiled from: EnterCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterCodeFragment$onViewCreated$4, reason: invalid class name */
    ...
    /* compiled from: EnterCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterCodeFragment$onViewCreated$5, reason: invalid class name */
    /* synthetic */ class AnonymousClass5 extends FunctionReferenceImpl implements Function1<ErrorContainer, Unit> {
        AnonymousClass5(Object obj) {
            super(1, obj, EnterCodeFragment.class, "renderError", "renderError(Lcom/sputnik/common/viewmodels/ErrorContainer;)V", 0);
        }
        ...
        public final void invoke2(ErrorContainer p0) {
            Intrinsics.checkNotNullParameter(p0, "p0");
            ((EnterCodeFragment) this.receiver).renderError(p0);
        }
    }

    /* compiled from: EnterCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterCodeFragment$onViewCreated$7, reason: invalid class name */
    /* synthetic */ class AnonymousClass7 extends FunctionReferenceImpl implements Function1<LoginViewState, Unit> {
        AnonymousClass7(Object obj) {
            super(1, obj, EnterCodeFragment.class, "renderLogin", "renderLogin(Lcom/sputnik/common/viewmodels/LoginViewState;)V", 0);
        }
        ...
        public final void invoke2(LoginViewState p0) {
            Intrinsics.checkNotNullParameter(p0, "p0");
            ((EnterCodeFragment) this.receiver).renderLogin(p0);
        }
    }

    public EnterCodeFragment() {
        super(R$layout.fragment_reg_enter_code);
        this.binding = new ViewBindingFragmentDelegate(this, EnterCodeFragment$binding$2.INSTANCE);
        this.locale = LazyKt.lazy(new Function0<AuthorizationLimitExceededBody>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$locale$2
            {
                super(0);
            }
        ...
        this.localeForTimer = LazyKt.lazy(new Function0<String>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$localeForTimer$2
            {
                super(0);
            }
        ...
        this.phone = LazyKt.lazy(new Function0<String>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$phone$2
            {
                super(0);
            }
        ...
        this.prettyPhone = LazyKt.lazy(new Function0<String>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$prettyPhone$2
            {
                super(0);
            }
        ...
        this.profileViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(ProfileViewModel.class), new Function0<ViewModelStore>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$activityViewModels$default$1
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$activityViewModels$default$2
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$profileViewModel$2
            {
                super(0);
            }
        ...
        Function0<ViewModelProvider.Factory> function02 = new Function0<ViewModelProvider.Factory>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$viewModel$2
            {
                super(0);
            }
        ...
        final Function0<Fragment> function03 = new Function0<Fragment>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$viewModels$default$1
            {
                super(0);
            }
        ...
        final Lazy lazy = LazyKt.lazy(LazyThreadSafetyMode.NONE, new Function0<ViewModelStoreOwner>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$viewModels$default$2
            {
                super(0);
            }
        ...
        this.viewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(CallCodeViewModel.class), new Function0<ViewModelStore>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$viewModels$default$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        this.camerasViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(AllCamerasViewModel.class), new Function0<ViewModelStore>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$activityViewModels$default$4
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$activityViewModels$default$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$camerasViewModel$2
            {
                super(0);
            }
        ...
        this.loginViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(LoginViewModel.class), new Function0<ViewModelStore>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$activityViewModels$default$7
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$special$$inlined$activityViewModels$default$8
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$loginViewModel$2
            {
                super(0);
            }
    ...
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterCodeFragment$showCodeExpiredError$2, reason: invalid class name and case insensitive filesystem */
    static final class C07522 extends Lambda implements Function2<AlertDialog, DialogErrorSplashBinding, Unit> {
        C07522() {
            super(2);
        }
        ...
        public final void invoke2(final AlertDialog dialog, DialogErrorSplashBinding view) {
            ...
            Intrinsics.checkNotNullParameter(view, "view");
            final EnterCodeFragment enterCodeFragment = EnterCodeFragment.this;
            LocalizationLocalModel data = enterCodeFragment.getLocalizationScreen().getData();
            ...
            view.btnRepeat.setOnClickListener(new View.OnClickListener() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$showCodeExpiredError$2$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    EnterCodeFragment.C07522.invoke$lambda$2$lambda$1(dialog, enterCodeFragment, view2);
                }
            });
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void invoke$lambda$2$lambda$1(AlertDialog dialog, EnterCodeFragment this$0, View view) {
            Intrinsics.checkNotNullParameter(dialog, "$dialog");
    ...
    /* compiled from: EnterCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterCodeFragment$showCodeExpiredError$1, reason: invalid class name and case insensitive filesystem */
    /* synthetic */ class C07511 extends FunctionReferenceImpl implements Function3<LayoutInflater, ViewGroup, Boolean, DialogErrorSplashBinding> {
    ...
    private final void showCodeExpiredError() {
        ...
        companion.newInstance(contextRequireContext, C07511.INSTANCE, new C07522());
    }
    ...
    private final void initPhone(String phone) {
        ...
        SpansKt.addClickableSpan(spannableString, String.valueOf(numberInfo4 != null ? numberInfo4.getParam() : null), new Function1<View, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$initPhone$1$str$1$1
            {
                super(1);
            }
    ...
    private final void initView() {
        ...
        TextView btnLoginBySms = getBinding().btnLoginBySms;
        Intrinsics.checkNotNullExpressionValue(btnLoginBySms, "btnLoginBySms");
        SafeClickListenerKt.setSafeOnClickListener$default(btnLoginBySms, 0L, new Function1<View, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment.initView.1
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                Intrinsics.checkNotNullParameter(it, "it");
                ApplyRegistration applyRegistration = EnterCodeFragment.this.getLoginViewModel().getCurrentState().getApplyRegistration();
                if (applyRegistration != null ? Intrinsics.areEqual(applyRegistration.getShowHelpOnFail(), Boolean.TRUE) : false) {
                    NavControllerKt.safeNavigate$default(FragmentKt.findNavController(EnterCodeFragment.this), R$id.action_to_needHelpFragment, BundleKt.bundleOf(TuplesKt.to("phone", EnterCodeFragment.this.getPhone()), TuplesKt.to("pretty_phone", EnterCodeFragment.this.getPrettyPhone())), null, 4, null);
                    return;
                }
                TextView btnLoginBySms2 = EnterCodeFragment.this.getBinding().btnLoginBySms;
                Intrinsics.checkNotNullExpressionValue(btnLoginBySms2, "btnLoginBySms");
                ButtonsExtensionsKt.showProgress(btnLoginBySms2, ContextCompat.getColor(EnterCodeFragment.this.requireContext(), R$color.sputnik_blue));
                EnterCodeFragment.this.getLoginViewModel().handleDataNew(EnterCodeFragment.this.getPhone(), EnterCodeFragment.this.getPrettyPhone());
                TextView tvAboutCode = EnterCodeFragment.this.getBinding().tvAboutCode;
                Intrinsics.checkNotNullExpressionValue(tvAboutCode, "tvAboutCode");
                ViewKt.gone(tvAboutCode);
                TextView btnLoginBySms3 = EnterCodeFragment.this.getBinding().btnLoginBySms;
                Intrinsics.checkNotNullExpressionValue(btnLoginBySms3, "btnLoginBySms");
                ViewKt.gone(btnLoginBySms3);
                ProgressBar pbRequestSms = EnterCodeFragment.this.getBinding().pbRequestSms;
                Intrinsics.checkNotNullExpressionValue(pbRequestSms, "pbRequestSms");
    ...
    private final void setUpCodeField() {
        PinView pinView = getBinding().viewPin;
        pinView.addTextChangedListener(new TextWatcher() { // from class: com.sputnik.oboarding.ui.registration.EnterCodeFragment$setUpCodeField$1$1
    ...
    private final void localize() {
        ...
        AuthorizationPhone phone = authorizationCode.getPhone();
        String changeMethodButton = null;
        String strValueOf = String.valueOf((phone == null || (title2 = phone.getTitle()) == null) ? null : title2.getText());
        AuthorizationPhone phone2 = authorizationCode.getPhone();
        binding.tvTitle.setText(ViewUtilsKt.highlightText(strValueOf, String.valueOf((phone2 == null || (title = phone2.getTitle()) == null) ? null : title.getParam()), ContextCompat.getColor(requireContext(), R$color.sputnik_pink)));
