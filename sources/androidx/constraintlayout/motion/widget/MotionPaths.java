...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void setView(float position, View view, int[] toUse, double[] data, double[] slope, double[] cycle, boolean mForceMeasure) {
        ...
        while (true) {
            ...
            if (zIsNaN && (cycle == null || cycle[i4] == ConfigValue.DOUBLE_DEFAULT_VALUE)) {
                f2 = f7;
            } else {
                if (cycle != null) {
                    d = cycle[i4];
        ...
        if (i9 != view.getMeasuredWidth() || i10 != view.getMeasuredHeight() || mForceMeasure) {
            view.measure(View.MeasureSpec.makeMeasureSpec(i9, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH), View.MeasureSpec.makeMeasureSpec(i10, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH));
        }
