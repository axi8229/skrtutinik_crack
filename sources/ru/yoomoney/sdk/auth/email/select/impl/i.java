...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.select.impl.EmailSelectBusinessLogic$handleProgress$2$1", f = "EmailSelectBusinessLogic.kt", l = {81}, m = "invokeSuspend")
...
public final class i extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public i(EmailSelectBusinessLogic emailSelectBusinessLogic, EmailSelect.Action action, Continuation<? super i> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            EmailSelect.Effect.ShowFailure showFailure = new EmailSelect.Effect.ShowFailure(((EmailSelect.Action.SendEmailFailure) this.c).getFailure());
            this.a = 1;
