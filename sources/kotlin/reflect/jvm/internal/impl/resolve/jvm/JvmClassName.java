...
public class JvmClassName {
    ...
    public static JvmClassName byClassId(ClassId classId) {
        ...
        return new JvmClassName(packageFqName.asString().replace('.', JsonPointer.SEPARATOR) + "/" + strReplace);
    }
    ...
    public FqName getPackageFqName() {
        ...
        return new FqName(this.internalName.substring(0, iLastIndexOf).replace(JsonPointer.SEPARATOR, '.'));
    }
