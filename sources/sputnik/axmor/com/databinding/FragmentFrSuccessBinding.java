...
public final class FragmentFrSuccessBinding implements ViewBinding {
    ...
    private FragmentFrSuccessBinding(ScrollView scrollView, Guideline guideline, AppCompatButton appCompatButton, ImageView imageView, ScrollView scrollView2, Toolbar toolbar, TextView textView, TextView textView2, TextView textView3) {
    ...
    public static FragmentFrSuccessBinding bind(View view) {
                    ...
                    if (toolbar != null) {
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                ...
                                TextView textView3 = (TextView) ViewBindings.findChildViewById(view, R.id.tv_info_success);
                                if (textView3 != null) {
                                    return new FragmentFrSuccessBinding(scrollView, guideline, appCompatButton, imageView, scrollView, toolbar, textView, textView2, textView3);
                                }
                            }
                        }
                    }
