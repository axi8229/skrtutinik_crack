...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.enter.impl.PhoneEnterBusinessLogic$handleLoadingState$1$1", f = "PhoneEnterBusinessLogic.kt", l = {115}, m = "invokeSuspend")
...
public final class o extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public o(PhoneEnterBusinessLogic phoneEnterBusinessLogic, PhoneEnter.Action action, Continuation<? super o> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneEnter.Effect.ShowNextStep showNextStep = new PhoneEnter.Effect.ShowNextStep(((PhoneEnter.Action.PhoneSetSuccess) this.c).getProcess());
            this.a = 1;
