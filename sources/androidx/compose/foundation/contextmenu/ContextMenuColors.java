...
public final class ContextMenuColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m977equalsimpl0(this.backgroundColor, contextMenuColors.backgroundColor) && Color.m977equalsimpl0(this.textColor, contextMenuColors.textColor) && Color.m977equalsimpl0(this.iconColor, contextMenuColors.iconColor) && Color.m977equalsimpl0(this.disabledTextColor, contextMenuColors.disabledTextColor) && Color.m977equalsimpl0(this.disabledIconColor, contextMenuColors.disabledIconColor);
    }

    public int hashCode() {
        return (((((((Color.m983hashCodeimpl(this.backgroundColor) * 31) + Color.m983hashCodeimpl(this.textColor)) * 31) + Color.m983hashCodeimpl(this.iconColor)) * 31) + Color.m983hashCodeimpl(this.disabledTextColor)) * 31) + Color.m983hashCodeimpl(this.disabledIconColor);
    }

    public String toString() {
        return "ContextMenuColors(backgroundColor=" + ((Object) Color.m984toStringimpl(this.backgroundColor)) + ", textColor=" + ((Object) Color.m984toStringimpl(this.textColor)) + ", iconColor=" + ((Object) Color.m984toStringimpl(this.iconColor)) + ", disabledTextColor=" + ((Object) Color.m984toStringimpl(this.disabledTextColor)) + ", disabledIconColor=" + ((Object) Color.m984toStringimpl(this.disabledIconColor)) + ')';
    }
}
