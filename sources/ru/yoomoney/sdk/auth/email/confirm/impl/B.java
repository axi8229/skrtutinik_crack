...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.confirm.impl.EmailConfirmBusinessLogic$handleValidState$2$1", f = "EmailConfirmBusinessLogic.kt", l = {107}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class B extends SuspendLambda implements Function1<Continuation<? super EmailConfirm.Action>, Object> {
    public int a;
    ...
    public B(EmailConfirmBusinessLogic emailConfirmBusinessLogic, Out.Builder<EmailConfirm.State.Valid, EmailConfirm.Action> builder, Continuation<? super B> continuation) {
