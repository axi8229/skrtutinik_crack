...
public final class CloudMessage extends AbstractSafeParcelable {
                ...
                if (extras != null) {
                    for (String str : extras.keySet()) {
                        ...
                        if (obj instanceof String) {
                            ...
                            if (!str.startsWith("google.") && !str.equals(RemoteMessageConst.FROM) && !str.equals(RemoteMessageConst.MSGTYPE) && !str.equals("collapse_key")) {
    ...
    public String getFrom() {
        return this.zza.getStringExtra(RemoteMessageConst.FROM);
    }
    ...
    public String getMessageType() {
        return this.zza.getStringExtra(RemoteMessageConst.MSGTYPE);
    }
