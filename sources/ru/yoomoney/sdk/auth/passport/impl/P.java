...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.passport.impl.PassportProfileBusinessLogic$handleInitState$5$1", f = "PassportProfileBusinessLogic.kt", l = {67}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class P extends SuspendLambda implements Function1<Continuation<? super PassportProfile.Action>, Object> {
    public int a;
    ...
    public P(PassportProfileBusinessLogic passportProfileBusinessLogic, Out.Builder<PassportProfile.State.Loading, PassportProfile.Action> builder, Continuation<? super P> continuation) {
