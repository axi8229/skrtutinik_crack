...
public final class UpdatePermCodeDialog extends BaseDialog {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        digitalKeysViewModel.observeState(viewLifecycleOwner, new Function1<DigitalKeysViewState, Unit>() { // from class: sputnik.axmor.com.sputnik.ui.main.market.services.digital_keys_service.dialog.UpdatePermCodeDialog.onViewCreated.1
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (data != null && (digitalKeysMain = data.getDigitalKeysMain()) != null && (refreshPopup = digitalKeysMain.getRefreshPopup()) != null) {
            ...
            binding.btnReject.setOnClickListener(new View.OnClickListener() { // from class: sputnik.axmor.com.sputnik.ui.main.market.services.digital_keys_service.dialog.UpdatePermCodeDialog$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    UpdatePermCodeDialog.onCreateDialog$lambda$3$lambda$2$lambda$1$lambda$0(dialogOnCreateDialog, view);
                }
            });
            TextView btnAccept = binding.btnAccept;
            Intrinsics.checkNotNullExpressionValue(btnAccept, "btnAccept");
            SafeClickListenerKt.setSafeOnClickListener$default(btnAccept, 0L, new Function1<View, Unit>() { // from class: sputnik.axmor.com.sputnik.ui.main.market.services.digital_keys_service.dialog.UpdatePermCodeDialog$onCreateDialog$1$1$1$2
    ...
    public UpdatePermCodeDialog() {
        final Function0 function0 = null;
        this.digitalKeysViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(DigitalKeysViewModel.class), new Function0<ViewModelStore>() { // from class: sputnik.axmor.com.sputnik.ui.main.market.services.digital_keys_service.dialog.UpdatePermCodeDialog$special$$inlined$activityViewModels$default$1
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: sputnik.axmor.com.sputnik.ui.main.market.services.digital_keys_service.dialog.UpdatePermCodeDialog$special$$inlined$activityViewModels$default$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: sputnik.axmor.com.sputnik.ui.main.market.services.digital_keys_service.dialog.UpdatePermCodeDialog$digitalKeysViewModel$2
            {
                super(0);
            }
