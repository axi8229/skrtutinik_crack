        ...
        try {
            ...
            try {
                ...
                if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    continuationProbeCoroutineCreated.resumeWith(Result.m2628constructorimpl(objInvoke));
                }
            } finally {
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m2628constructorimpl(ResultKt.createFailure(th)));
        }
    }
