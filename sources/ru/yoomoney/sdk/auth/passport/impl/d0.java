...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.passport.impl.PassportProfileBusinessLogic$handleLoadingState$5$1", f = "PassportProfileBusinessLogic.kt", l = {211}, m = "invokeSuspend")
...
public final class d0 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public d0(PassportProfileBusinessLogic passportProfileBusinessLogic, PassportProfile.Action action, Continuation<? super d0> continuation) {
    ...
    public final Object invoke(Continuation<? super Unit> continuation) {
        return new d0(this.b, this.c, continuation).invokeSuspend(Unit.INSTANCE);
    }
