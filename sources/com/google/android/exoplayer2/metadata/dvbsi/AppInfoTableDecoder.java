                ...
                if (bits2 == 2) {
                    ...
                    if (bits4 == 3) {
                        while (sectionData.getBytePosition() < bytePosition3) {
                            bytesAsString = sectionData.readBytesAsString(sectionData.readBits(8), Charset.forName("US-ASCII"));
                    ...
                    bytesAsString2 = sectionData.readBytesAsString(bits3, Charset.forName("US-ASCII"));
                }
