...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo89measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo1420measureBRTryo0 = measurable.mo1420measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m2083getMaxHeightimpl(j)) < Constraints.m2084getMaxWidthimpl(j) ? j : Constraints.m2076copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int iMin = Math.min(placeableMo1420measureBRTryo0.getWidth(), Constraints.m2084getMaxWidthimpl(j));
        return MeasureScope.layout$default(measureScope, iMin, placeableMo1420measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(measureScope2, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, measureScope.getLayoutDirection() == LayoutDirection.Rtl, placeableMo1420measureBRTryo0.getWidth()), iMin, placeableMo1420measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo1420measureBRTryo0, Math.round(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
