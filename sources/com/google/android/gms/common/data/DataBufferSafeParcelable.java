...
public class DataBufferSafeParcelable<T extends SafeParcelable> extends AbstractDataBuffer<T> {
    ...
    public static <T extends SafeParcelable> void addValue(DataHolder.Builder builder, T t) {
        ...
        contentValues.put(RemoteMessageConst.DATA, parcelObtain.marshall());
    ...
    public T get(int i) {
        ...
        byte[] byteArray = dataHolder.getByteArray(RemoteMessageConst.DATA, i, dataHolder.getWindowIndex(i));
        Parcel parcelObtain = Parcel.obtain();
