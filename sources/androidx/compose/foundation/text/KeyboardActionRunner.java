...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m416runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActionScope, Unit> onSend;
        ImeAction.Companion companion = ImeAction.INSTANCE;
        Unit unit = null;
        if (ImeAction.m1886equalsimpl0(imeAction, companion.m1891getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m1886equalsimpl0(imeAction, companion.m1890getDefaulteUduSuo()) ? true : ImeAction.m1886equalsimpl0(imeAction, companion.m1894getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            m415defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    /* renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void m415defaultKeyboardActionKlQnJC8(int imeAction) {
        ImeAction.Companion companion = ImeAction.INSTANCE;
        if (ImeAction.m1886equalsimpl0(imeAction, companion.m1893getNexteUduSuo())) {
            getFocusManager().mo793moveFocus3ESFkO8(FocusDirection.INSTANCE.m788getNextdhqQ8s());
            return;
        }
        if (ImeAction.m1886equalsimpl0(imeAction, companion.m1895getPreviouseUduSuo())) {
            getFocusManager().mo793moveFocus3ESFkO8(FocusDirection.INSTANCE.m789getPreviousdhqQ8s());
            return;
        }
        if (!ImeAction.m1886equalsimpl0(imeAction, companion.m1891getDoneeUduSuo())) {
            if (ImeAction.m1886equalsimpl0(imeAction, companion.m1892getGoeUduSuo()) ? true : ImeAction.m1886equalsimpl0(imeAction, companion.m1896getSearcheUduSuo()) ? true : ImeAction.m1886equalsimpl0(imeAction, companion.m1897getSendeUduSuo()) ? true : ImeAction.m1886equalsimpl0(imeAction, companion.m1890getDefaulteUduSuo())) {
                return;
            }
            ImeAction.m1886equalsimpl0(imeAction, companion.m1894getNoneeUduSuo());
        } else {
