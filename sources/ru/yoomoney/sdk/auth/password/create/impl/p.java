...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.create.impl.PasswordCreateBusinessLogic$handleProgressState$3$2", f = "PasswordCreateBusinessLogic.kt", l = {127}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class p extends SuspendLambda implements Function1<Continuation<? super PasswordCreate.Action>, Object> {
    public int a;
    ...
    public p(PasswordCreateBusinessLogic passwordCreateBusinessLogic, Out.Builder<PasswordCreate.State.Content, PasswordCreate.Action> builder, Continuation<? super p> continuation) {
