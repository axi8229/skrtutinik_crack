...
public final class ClipScrollableContainerKt {
    ...
    private static final float MaxSupportedElevation = Dp.m2102constructorimpl(30);
    ...
    static {
        ...
        HorizontalScrollableClipModifier = ClipKt.clip(companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
            ...
            public Outline mo179createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
                float fMo248roundToPx0680j_4 = density.mo248roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
                return new Outline.Rectangle(new Rect(0.0f, -fMo248roundToPx0680j_4, Size.m878getWidthimpl(size), Size.m876getHeightimpl(size) + fMo248roundToPx0680j_4));
            }
        });
        VerticalScrollableClipModifier = ClipKt.clip(companion, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
            ...
            public Outline mo179createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
                float fMo248roundToPx0680j_4 = density.mo248roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
                return new Outline.Rectangle(new Rect(-fMo248roundToPx0680j_4, 0.0f, Size.m878getWidthimpl(size) + fMo248roundToPx0680j_4, Size.m876getHeightimpl(size)));
            }
        });
    }
}
