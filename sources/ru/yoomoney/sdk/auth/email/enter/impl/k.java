...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.enter.impl.EmailEnterBusinessLogic$handleLoadingState$1$2", f = "EmailEnterBusinessLogic.kt", l = {74}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class k extends SuspendLambda implements Function1<Continuation<? super EmailEnter.Action>, Object> {
    public int a;
    ...
    public k(EmailEnterBusinessLogic emailEnterBusinessLogic, Out.Builder<EmailEnter.State.Content, EmailEnter.Action> builder, Continuation<? super k> continuation) {
