    ...
    */
    private static final int takeKopecksFromDouble(java.lang.String r13) {
        ...
        L9c:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: spay.sdk.data.dto.response.CardAmountDataDtoKt.takeKopecksFromDouble(java.lang.String):int");
    }
    ...
    public static final CardAmountDataDto toDto(CardAmountData cardAmountData) {
        ...
        return new CardAmountDataDto(amount, Intrinsics.areEqual(currency, "₽") ? "RUB" : "");
    }
}
