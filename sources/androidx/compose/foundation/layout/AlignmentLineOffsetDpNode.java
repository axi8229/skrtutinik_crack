...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m292setBefore0680j_4(float f) {
        this.before = f;
    }

    /* renamed from: setAfter-0680j_4, reason: not valid java name */
    public final void m291setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo105measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m287alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, this.before, this.after, measurable, j);
    }
}
