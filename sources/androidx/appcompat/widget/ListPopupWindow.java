...
public class ListPopupWindow implements ShowableListMenu {
    ...
    private int buildDropDown() {
        ...
        if (i6 == -2) {
            ...
            iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i8 - (rect3.left + rect3.right), pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH);
        } else {
            iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i6, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH);
        }
