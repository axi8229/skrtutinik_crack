...
public abstract class KotlinBuiltIns {
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo2744getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo2744getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                ...
                if (!(classifierDescriptorMo2744getContributedClassifier instanceof ClassDescriptor)) {
                    throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo2744getContributedClassifier);
                }
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(classifierDescriptorMo2742getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo2742getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = kotlinType.getConstructor().mo2742getDeclarationDescriptor();
        return (classifierDescriptorMo2742getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo2742getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo2742getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = kotlinType.getConstructor().mo2742getDeclarationDescriptor();
        return (classifierDescriptorMo2742getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo2742getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo2742getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo2742getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public static boolean isUByteArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(pjsip_transport_type_e.PJSIP_TRANSPORT_UDP6);
        }
    ...
    public static boolean isUShortArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6);
        }
    ...
    public static boolean isUIntArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6);
        }
    ...
    public static boolean isULongArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(pjsip_transport_type_e.PJSIP_TRANSPORT_DTLS6);
        }
