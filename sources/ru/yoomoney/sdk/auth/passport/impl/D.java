...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.passport.impl.PassportProfileBusinessLogic$handleContentState$8$1", f = "PassportProfileBusinessLogic.kt", l = {pjsip_transport_type_e.PJSIP_TRANSPORT_DTLS6}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class D extends SuspendLambda implements Function1<Continuation<? super PassportProfile.Action>, Object> {
    public int a;
    ...
    public D(PassportProfileBusinessLogic passportProfileBusinessLogic, Out.Builder<PassportProfile.State.Loading, PassportProfile.Action> builder, Continuation<? super D> continuation) {
