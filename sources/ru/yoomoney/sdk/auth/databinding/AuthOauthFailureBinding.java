...
public final class AuthOauthFailureBinding implements ViewBinding {
    ...
    public static AuthOauthFailureBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.auth_oauth_failure, viewGroup, false);
        if (z) {
