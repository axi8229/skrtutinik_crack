...
public final class AndroidSelectionHandles_androidKt {
    ...
    */
    public static final void m559SelectionHandlepzduO1o(final androidx.compose.foundation.text.selection.OffsetProvider r18, final boolean r19, final androidx.compose.ui.text.style.ResolvedTextDirection r20, final boolean r21, long r22, final androidx.compose.ui.Modifier r24, androidx.compose.runtime.Composer r25, final int r26, final int r27) {
        /*
            Method dump skipped, instructions count: 416
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt.m559SelectionHandlepzduO1o(androidx.compose.foundation.text.selection.OffsetProvider, boolean, androidx.compose.ui.text.style.ResolvedTextDirection, boolean, long, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void SelectionHandleIcon(final Modifier modifier, final Function0<Boolean> function0, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m331sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), function0, z), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, Size.m878getWidthimpl(cacheDrawScope.m766getSizeNHjbRc()) / 2.0f);
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    if (function03.invoke().booleanValue()) {
                                        if (z3) {
                                            ...
                                            long jMo1175getCenterF1C5BW0 = contentDrawScope.mo1175getCenterF1C5BW0();
                                        ...
                                        DrawScope.m1168drawImagegbVJVH8$default(contentDrawScope, imageBitmapCreateHandleImage, 0L, 0.0f, null, colorFilterM992tintxETnrds$default, 0, 46, null);
                                    }
                                }
                            });
                        }
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || iCeil > imageBitmap.getWidth() || iCeil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m1028ImageBitmapx__hDU$default(iCeil, iCeil, ImageBitmapConfig.INSTANCE.m1022getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        drawParams2.m1156setSizeuvyYCjk(jSize);
        canvas2.save();
        DrawScope.m1173drawRectnJ9OG0$default(canvasDrawScope2, Color.INSTANCE.m986getBlack0d7_KjU(), 0L, canvasDrawScope2.mo1176getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m930getClear0nO6VwU(), 58, null);
        DrawScope.m1173drawRectnJ9OG0$default(canvasDrawScope2, ColorKt.Color(4278190080L), Offset.INSTANCE.m854getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, null, null, 0, 120, null);
        DrawScope.m1166drawCircleVaOC9Bg$default(canvasDrawScope2, ColorKt.Color(4278190080L), f, OffsetKt.Offset(f, f), 0.0f, null, null, 0, 120, null);
        canvas2.restore();
