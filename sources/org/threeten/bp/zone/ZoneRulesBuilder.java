...
class ZoneRulesBuilder {
    ...
    class TZRule implements Comparable<TZRule> {
        ...
        public int compareTo(TZRule tZRule) {
            ...
            long secondOfDay = this.time.toSecondOfDay() + (this.adjustDays * RemoteMessageConst.DEFAULT_TTL);
            long secondOfDay2 = tZRule.time.toSecondOfDay() + (tZRule.adjustDays * RemoteMessageConst.DEFAULT_TTL);
