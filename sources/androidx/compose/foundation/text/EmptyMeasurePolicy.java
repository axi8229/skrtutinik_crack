...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo87measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m2084getMaxWidthimpl(j), Constraints.m2083getMaxHeightimpl(j), null, placementBlock, 4, null);
    }
}
