...
public class BridgeActivity extends Activity {
    ...
    public static void setFullScreenWindowLayoutInDisplayCutout(Window window) throws IllegalAccessException, InstantiationException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            ...
            cls.getMethod("addHwFlags", Integer.TYPE).invoke(cls.getConstructor(WindowManager.LayoutParams.class).newInstance(attributes2), Integer.valueOf(pj_ssl_sock_proto.PJ_SSL_SOCK_PROTO_DTLS1));
    ...
    private static int a(String str, int i) throws ClassNotFoundException {
        try {
