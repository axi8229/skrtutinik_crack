...
final class NavHostFragment$navHostController$2 extends Lambda implements Function0<NavHostController> {
    ...
    public final NavHostController invoke() throws Resources.NotFoundException {
        ...
        Bundle bundleConsumeRestoredStateForKey2 = navHostFragment.getSavedStateRegistry().consumeRestoredStateForKey("android-support-nav:fragment:graphId");
        if (bundleConsumeRestoredStateForKey2 != null) {
            navHostFragment.graphId = bundleConsumeRestoredStateForKey2.getInt("android-support-nav:fragment:graphId");
        }
    ...
    public static final Bundle invoke$lambda$5$lambda$4(NavHostFragment this$0) {
        ...
        if (this$0.graphId != 0) {
            return BundleKt.bundleOf(TuplesKt.to("android-support-nav:fragment:graphId", Integer.valueOf(this$0.graphId)));
        }
