...
public final class ComposableSingletons$SnackbarHostKt {
    ...
    public static Function3<SnackbarData, Composer, Integer, Unit> f13lambda1 = ComposableLambdaKt.composableLambdaInstance(996639038, false, new Function3<SnackbarData, Composer, Integer, Unit>() { // from class: androidx.compose.material.ComposableSingletons$SnackbarHostKt$lambda-1$1
        ...
        public final void invoke(SnackbarData snackbarData, Composer composer, int i) {
            ...
            SnackbarKt.m668SnackbarsPrSdHI(snackbarData, null, false, null, 0L, 0L, 0L, 0.0f, composer, i2 & 14, 254);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function3<SnackbarData, Composer, Integer, Unit> m625getLambda1$material_release() {
        return f13lambda1;
    }
}
