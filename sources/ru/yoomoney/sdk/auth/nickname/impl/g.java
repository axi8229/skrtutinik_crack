...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.nickname.impl.NicknameBusinessLogic$handleProgressState$2$2", f = "NicknameBusinessLogic.kt", l = {64}, m = "invokeSuspend")
...
public final class g extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public g(NicknameBusinessLogic nicknameBusinessLogic, Nickname.Action action, Continuation<? super g> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Nickname.Effect.ShowError showError = new Nickname.Effect.ShowError(((Nickname.Action.SetNicknameFail) this.c).getFailure());
            this.a = 1;
