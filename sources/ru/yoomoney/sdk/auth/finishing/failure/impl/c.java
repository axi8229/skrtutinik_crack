...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.finishing.failure.impl.AuthFinishingFailureBusinessLogic$handleContentState$3$1", f = "AuthFinishingFailureBusinessLogic.kt", l = {50}, m = "invokeSuspend")
...
public final class c extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public c(AuthFinishingFailureBusinessLogic authFinishingFailureBusinessLogic, Continuation<? super c> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AuthFinishingFailure.Effect.CallPhone callPhone = AuthFinishingFailure.Effect.CallPhone.INSTANCE;
            this.a = 1;
