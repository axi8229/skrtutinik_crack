...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.loading.impl.AuthLoadingBusinessLogic$handleProgressState$6$1", f = "AuthLoadingBusinessLogic.kt", l = {60}, m = "invokeSuspend")
...
public final class r extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public r(AuthLoadingBusinessLogic authLoadingBusinessLogic, AuthLoading.Action action, Continuation<? super r> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AuthLoading.Effect.ShowLogin showLogin = new AuthLoading.Effect.ShowLogin(((AuthLoading.Action.LoginDefault) this.c).getProcess(), ((AuthLoading.Action.LoginDefault) this.c).isForceLogin());
            this.a = 1;
