...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.passport.impl.PassportProfileBusinessLogic$handleErrorState$1$1", f = "PassportProfileBusinessLogic.kt", l = {pjsip_status_code.PJSIP_SC_MOVED_TEMPORARILY}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class G extends SuspendLambda implements Function1<Continuation<? super PassportProfile.Action>, Object> {
    public int a;
    ...
    public G(PassportProfileBusinessLogic passportProfileBusinessLogic, Out.Builder<PassportProfile.State.Init, PassportProfile.Action> builder, Continuation<? super G> continuation) {
