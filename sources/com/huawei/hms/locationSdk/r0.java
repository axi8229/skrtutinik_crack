...
public class r0 extends n0<u, List<HWLocation>> {
    private Context b;
    ...
    public void doExecute(u uVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<List<HWLocation>> taskCompletionSource) throws ApiException {
        try {
            HMSLocationLog.i("GetFromLocationNameTaskApiCall", ((n0) this).a, "doExecute");
            ...
            HMSLocationLog.e("GetFromLocationNameTaskApiCall", ((n0) this).a, "getFromLocationName doExecute exception:" + e.getMessage());
            taskCompletionSource.setException(e);
        } catch (Exception unused) {
            HMSLocationLog.e("GetFromLocationNameTaskApiCall", ((n0) this).a, "getFromLocationName doExecute exception");
