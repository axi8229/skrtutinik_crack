    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeFixed32NoTag(int value) throws IOException {
            try {
                ...
                int i2 = i + 1;
                this.position = i2;
                bArr[i] = (byte) (value & KotlinVersion.MAX_COMPONENT_VALUE);
                int i3 = i + 2;
                this.position = i3;
                bArr[i2] = (byte) ((value >> 8) & KotlinVersion.MAX_COMPONENT_VALUE);
                int i4 = i + 3;
                this.position = i4;
                bArr[i3] = (byte) ((value >> 16) & KotlinVersion.MAX_COMPONENT_VALUE);
                this.position = i + 4;
                bArr[i4] = (byte) ((value >> 24) & KotlinVersion.MAX_COMPONENT_VALUE);
            } catch (IndexOutOfBoundsException e) {
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
            }
        }
        ...
        public final void writeFixed64NoTag(long value) throws IOException {
            try {
                ...
                int i2 = i + 1;
                this.position = i2;
                bArr[i] = (byte) (((int) value) & KotlinVersion.MAX_COMPONENT_VALUE);
                int i3 = i + 2;
                this.position = i3;
                bArr[i2] = (byte) (((int) (value >> 8)) & KotlinVersion.MAX_COMPONENT_VALUE);
                int i4 = i + 3;
                this.position = i4;
                bArr[i3] = (byte) (((int) (value >> 16)) & KotlinVersion.MAX_COMPONENT_VALUE);
                int i5 = i + 4;
                this.position = i5;
                bArr[i4] = (byte) (((int) (value >> 24)) & KotlinVersion.MAX_COMPONENT_VALUE);
                int i6 = i + 5;
                this.position = i6;
                bArr[i5] = (byte) (((int) (value >> 32)) & KotlinVersion.MAX_COMPONENT_VALUE);
                int i7 = i + 6;
                this.position = i7;
                bArr[i6] = (byte) (((int) (value >> 40)) & KotlinVersion.MAX_COMPONENT_VALUE);
                int i8 = i + 7;
                this.position = i8;
                bArr[i7] = (byte) (((int) (value >> 48)) & KotlinVersion.MAX_COMPONENT_VALUE);
                this.position = i + 8;
                bArr[i8] = (byte) (((int) (value >> 56)) & KotlinVersion.MAX_COMPONENT_VALUE);
            } catch (IndexOutOfBoundsException e) {
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
            }
        }
