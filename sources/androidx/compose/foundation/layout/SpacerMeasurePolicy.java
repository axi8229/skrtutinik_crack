...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo87measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m2082getHasFixedWidthimpl(j) ? Constraints.m2084getMaxWidthimpl(j) : 0, Constraints.m2081getHasFixedHeightimpl(j) ? Constraints.m2083getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
