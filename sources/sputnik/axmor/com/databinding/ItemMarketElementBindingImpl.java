...
public class ItemMarketElementBindingImpl extends ItemMarketElementBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.imageView23, 2);
        sparseIntArray.put(R.id.tv_open_catalog, 3);
    }

    public ItemMarketElementBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 4, null, sViewsWithIds));
    }

    private ItemMarketElementBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
