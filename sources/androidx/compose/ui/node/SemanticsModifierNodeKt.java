...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m1466requireCoordinator64DMado(node, NodeKind.m1552constructorimpl(8)));
        }
        return DelegatableNodeKt.m1466requireCoordinator64DMado(node, NodeKind.m1552constructorimpl(8)).touchBoundsInRoot();
    }
}
