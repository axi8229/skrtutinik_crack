...
public class CountryCodeToRegionCodeMap {
    static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList87.add("TZ");
        map.put(Integer.valueOf(KotlinVersion.MAX_COMPONENT_VALUE), arrayList87);
        ...
        arrayList125.add("UA");
        map.put(Integer.valueOf(pjsip_status_code.PJSIP_SC_ALTERNATIVE_SERVICE), arrayList125);
        ...
        arrayList133.add("CZ");
        map.put(Integer.valueOf(pjsip_status_code.PJSIP_SC_BAD_EXTENSION), arrayList133);
        ArrayList arrayList134 = new ArrayList(1);
        arrayList134.add("SK");
        map.put(421, arrayList134);
        ArrayList arrayList135 = new ArrayList(1);
        arrayList135.add("LI");
        map.put(Integer.valueOf(pjsip_status_code.PJSIP_SC_INTERVAL_TOO_BRIEF), arrayList135);
        ArrayList arrayList136 = new ArrayList(1);
        arrayList136.add("FK");
        map.put(500, arrayList136);
        ArrayList arrayList137 = new ArrayList(1);
        arrayList137.add("BZ");
        map.put(Integer.valueOf(pjsip_status_code.PJSIP_SC_NOT_IMPLEMENTED), arrayList137);
        ArrayList arrayList138 = new ArrayList(1);
        arrayList138.add("GT");
        map.put(Integer.valueOf(pjsip_status_code.PJSIP_SC_BAD_GATEWAY), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("SV");
        map.put(503, arrayList139);
        ArrayList arrayList140 = new ArrayList(1);
        arrayList140.add("HN");
        map.put(Integer.valueOf(pjsip_status_code.PJSIP_SC_SERVER_TIMEOUT), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        map.put(Integer.valueOf(pjsip_status_code.PJSIP_SC_VERSION_NOT_SUPPORTED), arrayList141);
