...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.select.impl.PhoneSelectBusinessLogic$handleProgressState$1$1", f = "PhoneSelectBusinessLogic.kt", l = {94}, m = "invokeSuspend")
...
public final class h extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public h(PhoneSelectBusinessLogic phoneSelectBusinessLogic, PhoneSelect.Action action, Continuation<? super h> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneSelect.Effect.ShowNextStep showNextStep = new PhoneSelect.Effect.ShowNextStep(((PhoneSelect.Action.SetPhoneSuccess) this.c).getProcess());
            this.a = 1;
