...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    final class Data extends KDeclarationContainerImpl.Data {
        ...
        public Data() {
            ...
            this.multifileFacade = LazyKt.lazy(lazyThreadSafetyMode, new Function0<Class<?>>() { // from class: kotlin.reflect.jvm.internal.KPackageImpl$Data$multifileFacade$2
                ...
                public final Class<?> invoke() {
                    ...
                    return kPackageImpl.getJClass().getClassLoader().loadClass(StringsKt.replace$default(multifileClassName, JsonPointer.SEPARATOR, '.', false, 4, (Object) null));
                }
            });
            this.metadata = LazyKt.lazy(lazyThreadSafetyMode, new Function0<Triple<? extends JvmNameResolver, ? extends ProtoBuf$Package, ? extends JvmMetadataVersion>>() { // from class: kotlin.reflect.jvm.internal.KPackageImpl$Data$metadata$2
                {
                    super(0);
                }
    ...
    public KPackageImpl(Class<?> jClass) {
        ...
        this.jClass = jClass;
        this.data = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0<Data>() { // from class: kotlin.reflect.jvm.internal.KPackageImpl$data$1
            {
                super(0);
            }
    ...
    public PropertyDescriptor getLocalProperty(int index) {
        ...
        ProtoBuf$Property protoBuf$Property = (ProtoBuf$Property) ProtoBufUtilKt.getExtensionOrNull(protoBuf$PackageComponent2, packageLocalVariable, index);
        ...
        return (PropertyDescriptor) UtilKt.deserializeToDescriptor(jClass, protoBuf$Property, jvmNameResolverComponent1, new TypeTable(typeTable), jvmMetadataVersionComponent3, KPackageImpl$getLocalProperty$1$1$1.INSTANCE);
    }
