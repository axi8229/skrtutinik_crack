        ...
        int encodeUtf8(CharSequence in, byte[] out, int offset, int length) {
            ...
            while (i4 < length2) {
                ...
                if (cCharAt2 < 128 && i5 < i3) {
                    ...
                    out[i5] = (byte) ((cCharAt2 >>> '\f') | pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE);
                    int i9 = i5 + 2;
            ...
            while (i2 < length2) {
                ...
                if (cCharAt2 >= 128 || j4 >= j5) {
                    if (cCharAt2 >= 2048 || j4 > j5 - 2) {
                        ...
                        UnsafeUtil.putByte(out, j4, (byte) ((cCharAt2 >>> '\f') | pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE));
                        long j7 = j4 + 2;
            ...
            while (i3 < length) {
                ...
                if (cCharAt2 >= c || jPosition >= jLimit) {
                    if (cCharAt2 >= 2048 || jPosition > jLimit - 2) {
                        ...
                        long j4 = jPosition + j;
                        UnsafeUtil.putByte(jPosition, (byte) ((cCharAt2 >>> '\f') | pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE));
                        long j5 = jPosition + 2;
