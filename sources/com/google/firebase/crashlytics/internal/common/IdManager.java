...
public class IdManager implements InstallIdProvider {
    ...
    public FirebaseInstallationId fetchTrueFid(boolean z) {
        ...
        if (z) {
            try {
                token = ((InstallationTokenResult) Tasks.await(this.firebaseInstallations.getToken(false), DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM, TimeUnit.MILLISECONDS)).getToken();
            } catch (Exception e) {
        ...
        try {
            str = (String) Tasks.await(this.firebaseInstallations.getId(), DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM, TimeUnit.MILLISECONDS);
        } catch (Exception e2) {
