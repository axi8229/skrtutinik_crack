...
public final class HelpViewModel$logout$$inlined$updateState$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ VMState $updatedState;
    int label;
    final /* synthetic */ BaseViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HelpViewModel$logout$$inlined$updateState$1(VMState vMState, BaseViewModel baseViewModel, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new HelpViewModel$logout$$inlined$updateState$1(this.$updatedState, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((HelpViewModel$logout$$inlined$updateState$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
