...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m751recordReadInh_f27i8$runtime_release(int reader) {
        int iM749constructorimpl;
        do {
            iM749constructorimpl = ReaderKind.m749constructorimpl(this.readerKind.get());
            if ((iM749constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(iM749constructorimpl, ReaderKind.m749constructorimpl(iM749constructorimpl | reader)));
    }

    /* renamed from: isReadIn-h_f27i8$runtime_release, reason: not valid java name */
    public final boolean m750isReadInh_f27i8$runtime_release(int reader) {
        return (reader & ReaderKind.m749constructorimpl(this.readerKind.get())) != 0;
    }
}
