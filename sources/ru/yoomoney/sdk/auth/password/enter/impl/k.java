...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.enter.impl.PasswordEnterBusinessLogic$handleProgressState$2$1", f = "PasswordEnterBusinessLogic.kt", l = {69}, m = "invokeSuspend")
...
public final class k extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public k(PasswordEnterBusinessLogic passwordEnterBusinessLogic, PasswordEnter.Action action, Continuation<? super k> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PasswordEnter.Effect.ShowNextStep showNextStep = new PasswordEnter.Effect.ShowNextStep(((PasswordEnter.Action.PasswordRecoverySuccess) this.c).getProcess());
            this.a = 1;
