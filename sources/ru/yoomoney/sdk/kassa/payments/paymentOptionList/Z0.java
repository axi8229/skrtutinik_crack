...
public final class Z0 extends SuspendLambda implements Function1 {
    ...
    public Z0(E1 e1, Out.Builder builder, Continuation continuation) {
    ...
    public final Continuation create(Continuation continuation) {
        return new Z0(this.b, this.c, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        return new Z0(this.b, this.c, (Continuation) obj).invokeSuspend(Unit.INSTANCE);
    }
