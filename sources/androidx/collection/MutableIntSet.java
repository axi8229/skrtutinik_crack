    ...
    private final void dropDeletes() {
        ...
        while (i3 != i2) {
            ...
            if (j == 128) {
                ...
                if (j == 254) {
                    int iHashCode = Integer.hashCode(iArr[i3]) * (-862048943);
