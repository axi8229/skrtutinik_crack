...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.enter.impl.PasswordEnterBusinessLogic$handleContentState$5$1", f = "PasswordEnterBusinessLogic.kt", l = {49}, m = "invokeSuspend")
...
public final class f extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public f(PasswordEnterBusinessLogic passwordEnterBusinessLogic, Continuation<? super f> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PasswordEnter.Effect.ShowExpireDialog showExpireDialog = PasswordEnter.Effect.ShowExpireDialog.INSTANCE;
            this.a = 1;
