...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.acceptTerms.impl.AcceptTermsBusinessLogic$handleProgressState$2$2", f = "AcceptTermsBusinessLogic.kt", l = {38}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class f extends SuspendLambda implements Function1<Continuation<? super AcceptTerms.Action>, Object> {
    public int a;
    ...
    public f(AcceptTermsBusinessLogic acceptTermsBusinessLogic, Out.Builder<AcceptTerms.State.Content, AcceptTerms.Action> builder, Continuation<? super f> continuation) {
