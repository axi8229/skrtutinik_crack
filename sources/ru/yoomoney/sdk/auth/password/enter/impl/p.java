...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.enter.impl.PasswordEnterBusinessLogic$handleProgressState$5$1", f = "PasswordEnterBusinessLogic.kt", l = {85}, m = "invokeSuspend")
...
public final class p extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public p(PasswordEnterBusinessLogic passwordEnterBusinessLogic, PasswordEnter.Action action, Continuation<? super p> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PasswordEnter.Effect.ShowFailure showFailure = new PasswordEnter.Effect.ShowFailure(((PasswordEnter.Action.PasswordRecoveryFailure) this.c).getFailure());
            this.a = 1;
