...
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(infiniteRepeatableSpec.animation, this.animation) && infiniteRepeatableSpec.repeatMode == this.repeatMode && StartOffset.m134equalsimpl0(infiniteRepeatableSpec.initialStartOffset, this.initialStartOffset);
    }
