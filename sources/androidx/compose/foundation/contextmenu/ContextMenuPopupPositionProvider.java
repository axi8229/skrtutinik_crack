...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo198calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m2138getXimpl(this.localPosition), IntSize.m2156getWidthimpl(popupContentSize), IntSize.m2156getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m2139getYimpl(this.localPosition), IntSize.m2155getHeightimpl(popupContentSize), IntSize.m2155getHeightimpl(windowSize), false, 8, null));
    }
}
