...
public final /* data */ class AuthorizationSms implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<AuthorizationSms> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final AuthorizationSms createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return new AuthorizationSms(parcel.readInt() == 0 ? null : TextWithParam.CREATOR.createFromParcel(parcel), parcel.readInt() != 0 ? TextWithParam.CREATOR.createFromParcel(parcel) : null);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final AuthorizationSms[] newArray(int i) {
            return new AuthorizationSms[i];
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AuthorizationSms)) {
            return false;
        }
        AuthorizationSms authorizationSms = (AuthorizationSms) other;
        return Intrinsics.areEqual(this.title, authorizationSms.title) && Intrinsics.areEqual(this.numberInfo, authorizationSms.numberInfo);
    }
    ...
    public String toString() {
        return "AuthorizationSms(title=" + this.title + ", numberInfo=" + this.numberInfo + ")";
    }
    ...
    public AuthorizationSms(TextWithParam textWithParam, TextWithParam textWithParam2) {
