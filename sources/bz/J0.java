...
public final class J0 extends AbstractC0538n1 implements A0 {
    public final Context c;
    public final Z0 d;
    public final LocationManager e;
    public final zone.bi.mobile.fingerprint.api.b f;

    public J0(Context context, Z0 z0, LocationManager locationManager, zone.bi.mobile.fingerprint.api.b bVar) {
        super(zone.bi.mobile.fingerprint.api.f.Latitude);
        this.c = context;
        this.d = z0;
    ...
    public final Serializable h() throws e2 {
        ...
        String strA = AbstractC0566x0.a(locationB.getLatitude());
        a(strA);
        return strA;
    }
}
