...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.qrAuth.failure.impl.QrAuthFailureBusinessLogic$handleContentState$1$1", f = "QrAuthFailureBusinessLogic.kt", l = {29}, m = "invokeSuspend")
...
public final class a extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public a(QrAuthFailureBusinessLogic qrAuthFailureBusinessLogic, Continuation<? super a> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            QrAuthFailureContract.Effect.CloseScreen closeScreen = QrAuthFailureContract.Effect.CloseScreen.INSTANCE;
            this.a = 1;
