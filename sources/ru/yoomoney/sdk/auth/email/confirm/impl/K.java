...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.confirm.impl.EmailConfirmBusinessLogic$handleValidState$9$1", f = "EmailConfirmBusinessLogic.kt", l = {165}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class K extends SuspendLambda implements Function1<Continuation<? super EmailConfirm.Action>, Object> {
    public int a;
    ...
    public K(EmailConfirmBusinessLogic emailConfirmBusinessLogic, Out.Builder<EmailConfirm.State.Progress, EmailConfirm.Action> builder, Continuation<? super K> continuation) {
