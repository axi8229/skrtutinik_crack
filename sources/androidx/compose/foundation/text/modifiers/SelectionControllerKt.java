    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar selectionRegistrar, final long j, final Function0<? extends LayoutCoordinates> function0) {
        TextDragObserver textDragObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
            ...
            /* JADX WARN: Multi-variable type inference failed */
            {
                ...
                this.lastPosition = companion.m854getZeroF1C5BW0();
            ...
            public void mo462onStartk4lQ0M(long startPoint) {
                ...
                if (layoutCoordinatesInvoke != null) {
                    ...
                    selectionRegistrar2.m572notifySelectionUpdateStartubNVwUQ(layoutCoordinatesInvoke, startPoint, SelectionAdjustment.INSTANCE.getWord(), true);
                    this.lastPosition = startPoint;
                }
                if (SelectionRegistrarKt.hasSelection(selectionRegistrar, j)) {
                    this.dragTotalDistance = Offset.INSTANCE.m854getZeroF1C5BW0();
                }
            }
            ...
            public void mo461onDragk4lQ0M(long delta) {
                ...
                if (layoutCoordinatesInvoke != null) {
                    ...
                    if (layoutCoordinatesInvoke.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2)) {
                        long jM847plusMKHz9U = Offset.m847plusMKHz9U(this.dragTotalDistance, delta);
                        this.dragTotalDistance = jM847plusMKHz9U;
                        long jM847plusMKHz9U2 = Offset.m847plusMKHz9U(this.lastPosition, jM847plusMKHz9U);
                        if (selectionRegistrar2.m571notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, jM847plusMKHz9U2, this.lastPosition, false, SelectionAdjustment.INSTANCE.getWord(), true)) {
                            this.lastPosition = jM847plusMKHz9U2;
                            this.dragTotalDistance = Offset.INSTANCE.m854getZeroF1C5BW0();
                        }
                    }
                }
        ...
        return SelectionGesturesKt.selectionGestureInput(Modifier.INSTANCE, new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            private long lastPosition = Offset.INSTANCE.m854getZeroF1C5BW0();
            ...
            public boolean mo553onExtendk4lQ0M(long downPosition) {
                ...
                if (selectionRegistrar2.m571notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
            ...
            public boolean mo554onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (!selectionRegistrar2.m571notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
                    return true;
                }
            ...
            public boolean mo555onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                selectionRegistrar2.m572notifySelectionUpdateStartubNVwUQ(layoutCoordinatesInvoke, downPosition, adjustment, false);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2);
            }
            ...
            public boolean mo552onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (!selectionRegistrar2.m571notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, adjustment, false)) {
                    return true;
                }
                this.lastPosition = dragPosition;
                return true;
