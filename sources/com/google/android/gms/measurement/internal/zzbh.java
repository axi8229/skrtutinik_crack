...
public final class zzbh {
    ...
    static {
        ...
        Integer numValueOf = Integer.valueOf(pj_ssl_sock_proto.PJ_SSL_SOCK_PROTO_DTLS1);
        zzh = zzb("measurement.upload.max_batch_size", numValueOf, new zzfx() { // from class: com.google.android.gms.measurement.internal.zzft
            @Override // com.google.android.gms.measurement.internal.zzfx
            public final Object zza() {
                return Integer.valueOf((int) com.google.android.gms.internal.measurement.zzng.zzan());
            }
        });
        zzi = zzb("measurement.upload.max_bundle_size", numValueOf, new zzfx() { // from class: com.google.android.gms.measurement.internal.zzbu
            @Override // com.google.android.gms.measurement.internal.zzfx
            public final Object zza() {
        ...
        zzal = zzb("measurement.service_client.idle_disconnect_millis", Long.valueOf(DeviceOrientationRequest.OUTPUT_PERIOD_FAST), new zzfx() { // from class: com.google.android.gms.measurement.internal.zzds
            @Override // com.google.android.gms.measurement.internal.zzfx
            public final Object zza() {
