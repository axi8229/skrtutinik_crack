...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild, ScrollingView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(ViewGroup.getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH));
            }
        }
    }
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (keyEvent.isAltPressed()) {
                return fullScroll(pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6);
            }
            return arrowScroll(pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6);
        }
        if (keyCode == 62) {
        ...
        pageScroll(pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6);
        return false;
    }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
