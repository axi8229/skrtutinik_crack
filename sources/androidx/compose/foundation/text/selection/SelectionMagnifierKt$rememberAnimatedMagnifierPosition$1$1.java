        ...
        if (i == 0) {
            ...
            Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m833boximpl(m568invokeF1C5BW0());
                }
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1$1.2
                ...
                public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                    return m569emit3MmeM6k(((Offset) obj2).getPackedValue(), continuation);
                }

                /* renamed from: emit-3MmeM6k, reason: not valid java name */
                public final Object m569emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    if (OffsetKt.m856isSpecifiedk4lQ0M(animatable.getValue().getPackedValue()) && OffsetKt.m856isSpecifiedk4lQ0M(j) && Offset.m843getYimpl(animatable.getValue().getPackedValue()) != Offset.m843getYimpl(j)) {
                        BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass1(animatable, j, null), 3, null);
                        return Unit.INSTANCE;
                    }
                    Object objSnapTo = animatable.snapTo(Offset.m833boximpl(j), continuation);
                ...
                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            Offset offsetM833boximpl = Offset.m833boximpl(this.$targetValue);
                            SpringSpec<Offset> magnifierSpringSpec = SelectionMagnifierKt.getMagnifierSpringSpec();
                            this.label = 1;
                            if (Animatable.animateTo$default(animatable, offsetM833boximpl, magnifierSpringSpec, null, null, this, 12, null) == coroutine_suspended) {
