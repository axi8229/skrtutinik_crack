...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.confirm.impl.PhoneConfirmBusinessLogic$processStateProgressAction$5$1", f = "PhoneConfirmBusinessLogic.kt", l = {pjsip_transport_type_e.PJSIP_TRANSPORT_UDP6}, m = "invokeSuspend")
...
public final class s extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public s(PhoneConfirmBusinessLogic phoneConfirmBusinessLogic, PhoneConfirm.Action action, Continuation<? super s> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneConfirm.Effect.ShowNextStep showNextStep = new PhoneConfirm.Effect.ShowNextStep(((PhoneConfirm.Action.ForgotPhoneSuccess) this.c).getProcess());
            this.a = 1;
