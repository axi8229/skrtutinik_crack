...
public final class DomainPlan$$serializer implements GeneratedSerializer<DomainPlan> {
    public static final DomainPlan$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        DomainPlan$$serializer domainPlan$$serializer = new DomainPlan$$serializer();
        INSTANCE = domainPlan$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sputnik.domain.entities.subscriptions.subscriptions.DomainPlan", domainPlan$$serializer, 5);
        pluginGeneratedSerialDescriptor.addElement("appstore_product_id", false);
        ...
        pluginGeneratedSerialDescriptor.addElement("promo", false);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private DomainPlan$$serializer() {
    }

    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public KSerializer<?>[] childSerializers() {
        StringSerializer stringSerializer = StringSerializer.INSTANCE;
        return new KSerializer[]{BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(IntSerializer.INSTANCE), BuiltinSerializersKt.getNullable(DomainPlan$DomainPromo$$serializer.INSTANCE)};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    public DomainPlan deserialize(Decoder decoder) {
        int i;
        String str;
        String str2;
        String str3;
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            domainPromo = (DomainPlan.DomainPromo) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, DomainPlan$DomainPromo$$serializer.INSTANCE, null);
            i = 31;
            str2 = str6;
            str = str5;
        } else {
            ...
            String str8 = null;
            Integer num2 = null;
            DomainPlan.DomainPromo domainPromo2 = null;
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    domainPromo2 = (DomainPlan.DomainPromo) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, DomainPlan$DomainPromo$$serializer.INSTANCE, domainPromo2);
                    i2 |= 16;
                }
            }
            i = i2;
            ...
            str3 = str8;
            num = num2;
            domainPromo = domainPromo2;
        }
        compositeDecoderBeginStructure.endStructure(descriptor2);
        return new DomainPlan(i, str, str2, str3, num, domainPromo, null);
    }
    ...
    public void serialize(Encoder encoder, DomainPlan value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        DomainPlan.write$Self(value, compositeEncoderBeginStructure, descriptor2);
