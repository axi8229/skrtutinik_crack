...
public final class AesGcmHkdfStreamingKeyManager extends KeyTypeManager<AesGcmHkdfStreamingKey> {
    ...
    public static AesGcmHkdfStreamingKeyFormat createKeyFormat(int mainKeySize, HashType hkdfHashType, int derivedKeySize, int ciphertextSegmentSize) {
        return AesGcmHkdfStreamingKeyFormat.newBuilder().setKeySize(mainKeySize).setParams(AesGcmHkdfStreamingParams.newBuilder().setCiphertextSegmentSize(ciphertextSegmentSize).setDerivedKeySize(derivedKeySize).setHkdfHashType(hkdfHashType).build()).build();
    }
}
