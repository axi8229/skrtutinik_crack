...
final class DefaultButtonColors implements ButtonColors {
    ...
    public State<Color> backgroundColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m971boximpl(z ? this.backgroundColor : this.disabledBackgroundColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> contentColor(boolean z, Composer composer, int i) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m971boximpl(z ? this.contentColor : this.disabledContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m977equalsimpl0(this.backgroundColor, defaultButtonColors.backgroundColor) && Color.m977equalsimpl0(this.contentColor, defaultButtonColors.contentColor) && Color.m977equalsimpl0(this.disabledBackgroundColor, defaultButtonColors.disabledBackgroundColor) && Color.m977equalsimpl0(this.disabledContentColor, defaultButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m983hashCodeimpl(this.backgroundColor) * 31) + Color.m983hashCodeimpl(this.contentColor)) * 31) + Color.m983hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m983hashCodeimpl(this.disabledContentColor);
    }
}
