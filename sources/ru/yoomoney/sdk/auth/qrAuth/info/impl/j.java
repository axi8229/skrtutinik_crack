...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.qrAuth.info.impl.QrAuthInfoBusinessLogic$handStateErrorInfo$2$1", f = "QrAuthInfoBusinessLogic.kt", l = {93}, m = "invokeSuspend")
...
public final class j extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public j(QrAuthInfoBusinessLogic qrAuthInfoBusinessLogic, Continuation<? super j> continuation) {
