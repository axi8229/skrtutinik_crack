...
public abstract class AlignmentLines {
    ...
    protected abstract long mo1460calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo1460calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            fM842getXimpl = Offset.m843getYimpl(jOffset);
        } else {
            fM842getXimpl = Offset.m842getXimpl(jOffset);
        }
        int iRound = Math.round(fM842getXimpl);
