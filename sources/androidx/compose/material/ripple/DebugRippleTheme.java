...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo689defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM700defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m700defaultRippleColor5vOe2sY(Color.INSTANCE.m986getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM700defaultRippleColor5vOe2sY;
    }
