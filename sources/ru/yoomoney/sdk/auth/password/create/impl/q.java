...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.create.impl.PasswordCreateBusinessLogic$handleProgressState$4$1", f = "PasswordCreateBusinessLogic.kt", l = {135}, m = "invokeSuspend")
...
public final class q extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public q(PasswordCreateBusinessLogic passwordCreateBusinessLogic, PasswordCreate.Action action, Continuation<? super q> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PasswordCreate.Effect.ShowFailure showFailure = new PasswordCreate.Effect.ShowFailure(((PasswordCreate.Action.PasswordCreateFailure) this.c).getFailure());
            this.a = 1;
