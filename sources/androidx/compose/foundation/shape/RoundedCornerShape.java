...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo396createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        if (topStart + topEnd + bottomEnd + bottomStart == 0.0f) {
            return new Outline.Rectangle(SizeKt.m886toRectuvyYCjk(size));
        }
        Rect rectM886toRectuvyYCjk = SizeKt.m886toRectuvyYCjk(size);
        LayoutDirection layoutDirection2 = LayoutDirection.Ltr;
        return new Outline.Rounded(RoundRectKt.m870RoundRectZAM2FJo(rectM886toRectuvyYCjk, CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? topStart : topEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? topEnd : topStart, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? bottomEnd : bottomStart, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? bottomStart : bottomEnd, 0.0f, 2, null)));
    }
