...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m1822getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m1847equalsimpl0(i, FontStyle.INSTANCE.m1851getItalic_LCdwA()));
    }
}
