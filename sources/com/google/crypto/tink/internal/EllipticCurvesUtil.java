...
public final class EllipticCurvesUtil {
    ...
    static JacobianEcPoint doubleJacobianPoint(JacobianEcPoint p, BigInteger a, BigInteger modulus) {
        ...
        BigInteger bigIntegerMod = bigInteger.multiply(bigInteger).mod(modulus);
        BigInteger bigInteger2 = p.y;
        BigInteger bigIntegerMod2 = bigInteger2.multiply(bigInteger2).mod(modulus);
        BigInteger bigIntegerMod3 = bigIntegerMod2.multiply(bigIntegerMod2).mod(modulus);
        BigInteger bigInteger3 = p.z;
        BigInteger bigIntegerMod4 = bigInteger3.multiply(bigInteger3).mod(modulus);
        ...
        BigInteger bigIntegerMultiply = bigIntegerSubtract.multiply(bigInteger4);
        BigInteger bigIntegerAdd2 = bigIntegerMod.multiply(THREE).add(a.multiply(bigIntegerMod4).multiply(bigIntegerMod4).mod(modulus));
        BigInteger bigIntegerMod5 = bigIntegerAdd2.multiply(bigIntegerAdd2).mod(modulus).subtract(bigIntegerMultiply.multiply(bigInteger4)).mod(modulus);
    ...
    static JacobianEcPoint addJacobianPoints(JacobianEcPoint p1, JacobianEcPoint p2, BigInteger a, BigInteger modulus) {
        ...
        BigInteger bigInteger = p1.z;
        BigInteger bigIntegerMod = bigInteger.multiply(bigInteger).mod(modulus);
        BigInteger bigInteger2 = p2.z;
        BigInteger bigIntegerMod2 = bigInteger2.multiply(bigInteger2).mod(modulus);
        ...
        BigInteger bigIntegerMod10 = bigIntegerSubtract.multiply(bigInteger3).mod(modulus);
        BigInteger bigIntegerMod11 = bigIntegerMod3.multiply(bigIntegerMod8).mod(modulus);
        BigInteger bigIntegerMod12 = bigIntegerMod10.multiply(bigIntegerMod10).mod(modulus).subtract(bigIntegerMod9).subtract(bigIntegerMod11.multiply(bigInteger3)).mod(modulus);
        BigInteger bigIntegerMod13 = bigIntegerMod10.multiply(bigIntegerMod11.subtract(bigIntegerMod12)).subtract(bigIntegerMod5.multiply(bigInteger3).multiply(bigIntegerMod9)).mod(modulus);
