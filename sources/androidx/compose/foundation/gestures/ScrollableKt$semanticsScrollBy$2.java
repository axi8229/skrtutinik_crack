...
final class ScrollableKt$semanticsScrollBy$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    ScrollableKt$semanticsScrollBy$2(ScrollingLogic scrollingLogic, long j, Ref$FloatRef ref$FloatRef, Continuation<? super ScrollableKt$semanticsScrollBy$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            float fM276toFloatk4lQ0M = this.$this_semanticsScrollBy.m276toFloatk4lQ0M(this.$offset);
            ...
            Function2<Float, Float, Unit> function2 = new Function2<Float, Float, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$semanticsScrollBy$2.1
                ...
                public final void invoke(float f, float f2) {
                    ...
                    ref$FloatRef.element += scrollingLogic2.reverseIfNeeded(scrollingLogic2.m276toFloatk4lQ0M(nestedScrollScope.mo246scrollByOzD1aCk(scrollingLogic2.m277toOffsettuRUvjQ(scrollingLogic2.reverseIfNeeded(f3)), NestedScrollSource.INSTANCE.m1313getUserInputWNlRxjI())));
                }
            };
            this.label = 1;
            if (SuspendAnimationKt.animate$default(0.0f, fM276toFloatk4lQ0M, 0.0f, null, function2, this, 12, null) == coroutine_suspended) {
