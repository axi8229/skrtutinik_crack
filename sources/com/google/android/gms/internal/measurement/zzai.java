...
public final class zzai implements zzaq {
    ...
    public final Boolean zzd() {
        return Boolean.valueOf((Double.isNaN(this.zza.doubleValue()) || this.zza.doubleValue() == ConfigValue.DOUBLE_DEFAULT_VALUE) ? false : true);
    }
    ...
    public final String zzf() throws NumberFormatException {
        ...
        if (Double.isInfinite(this.zza.doubleValue())) {
            if (this.zza.doubleValue() > ConfigValue.DOUBLE_DEFAULT_VALUE) {
                return "Infinity";
            }
            return "-Infinity";
        }
        BigDecimal bigDecimalValueOf = BigDecimal.valueOf(this.zza.doubleValue());
        BigDecimal bigDecimal = bigDecimalValueOf.signum() == 0 ? new BigDecimal(BigInteger.ZERO, 0) : x0$$ExternalSyntheticBackportWithForwarding0.m(bigDecimalValueOf);
