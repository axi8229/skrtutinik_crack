...
final class WOTSPlusOid implements XMSSOid {
    ...
    static {
        ...
        map.put(createKey("SHA-512", 64, 16, pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6), new WOTSPlusOid(33554434, "WOTSP_SHA2-512_W16"));
        map.put(createKey("SHAKE128", 32, 16, 67), new WOTSPlusOid(50331651, "WOTSP_SHAKE128_W16"));
        map.put(createKey("SHAKE256", 64, 16, pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6), new WOTSPlusOid(67108868, "WOTSP_SHAKE256_W16"));
