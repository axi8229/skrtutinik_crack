...
public class FillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        ...
        this.paint.setColor((MiscUtils.clamp((int) ((((i / 255.0f) * this.opacityAnimation.getValue().intValue()) / 100.0f) * 255.0f), 0, KotlinVersion.MAX_COMPONENT_VALUE) << 24) | (((ColorKeyframeAnimation) this.colorAnimation).getIntValue() & 16777215));
