...
public final class LongPressTextDragObserverKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, coroutineStart, new C00242(this.$this_detectDownAndDragGesturesWithObserver, this.$observer, null), 1, null);
        }
        ...
        static final class C00242 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00242(PointerInputScope pointerInputScope, TextDragObserver textDragObserver, Continuation<? super C00242> continuation) {
                super(2, continuation);
                this.$this_detectDownAndDragGesturesWithObserver = pointerInputScope;
                this.$observer = textDragObserver;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00242(this.$this_detectDownAndDragGesturesWithObserver, this.$observer, continuation);
            }
    ...
    static final class C04142 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ TextDragObserver $observer;
        private /* synthetic */ Object L$0;
        Object L$1;
        int label;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04142(TextDragObserver textDragObserver, Continuation<? super C04142> continuation) {
            super(2, continuation);
            this.$observer = textDragObserver;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04142 c04142 = new C04142(this.$observer, continuation);
            c04142.L$0 = obj;
            return c04142;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C04142) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r13) {
            ...
            L69:
                ...
                long r8 = r7.getId()
                long r10 = r1.getId()
                boolean r8 = androidx.compose.ui.input.pointer.PointerId.m1343equalsimpl0(r8, r10)
                if (r8 == 0) goto L86
            ...
            L89:
                ...
                return r13
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.LongPressTextDragObserverKt.C04142.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public static final Object detectPreDragGesturesWithObserver(PointerInputScope pointerInputScope, TextDragObserver textDragObserver, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C04142(textDragObserver, null), continuation);
    ...
    public static final Object detectDragGesturesWithObserver(PointerInputScope pointerInputScope, final TextDragObserver textDragObserver, Continuation<? super Unit> continuation) {
        Object objDetectDragGestures = DragGestureDetectorKt.detectDragGestures(pointerInputScope, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.LongPressTextDragObserverKt.detectDragGesturesWithObserver.2
            ...
            public final void m429invokek4lQ0M(long j) {
                textDragObserver.mo462onStartk4lQ0M(j);
            }
            ...
            public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                m430invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
            public final void m430invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
                textDragObserver.mo461onDragk4lQ0M(j);
            }
        }, continuation);
