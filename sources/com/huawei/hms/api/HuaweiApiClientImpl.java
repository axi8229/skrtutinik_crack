...
public class HuaweiApiClientImpl extends HuaweiApiClient implements InnerApiClient, ServiceConnection {
    ...
    public boolean isConnected() {
        ...
        Status status = ((ResolveResult) ConnectService.checkconnect(this, new CheckConnectInfo()).awaitOnAnyThread(YooProfilerImpl.TIMER_LIMIT, TimeUnit.MILLISECONDS)).getStatus();
        if (status.isSuccess()) {
