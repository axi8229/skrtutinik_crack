...
public final class AuthEmailConfirmModule_ProvideEmailConfirmFragmentFactory implements Factory<Fragment> {
    ...
    private final Provider<AuthEmailConfirmInteractor> interactorProvider;
    ...
    public static AuthEmailConfirmModule_ProvideEmailConfirmFragmentFactory create(AuthEmailConfirmModule authEmailConfirmModule, Provider<AuthEmailConfirmInteractor> provider, Provider<Router> provider2, Provider<ProcessMapper> provider3, Provider<ResourceMapper> provider4, Provider<Lazy<Config>> provider5, Provider<ResultData> provider6, Provider<ServerTimeRepository> provider7, Provider<AnalyticsLogger> provider8) {
        return new AuthEmailConfirmModule_ProvideEmailConfirmFragmentFactory(authEmailConfirmModule, provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8);
    }
    ...
    public static Fragment provideEmailConfirmFragment(AuthEmailConfirmModule authEmailConfirmModule, AuthEmailConfirmInteractor authEmailConfirmInteractor, Router router, ProcessMapper processMapper, ResourceMapper resourceMapper, Lazy<Config> lazy, ResultData resultData, ServerTimeRepository serverTimeRepository, AnalyticsLogger analyticsLogger) {
        return (Fragment) Preconditions.checkNotNullFromProvides(authEmailConfirmModule.provideEmailConfirmFragment(authEmailConfirmInteractor, router, processMapper, resourceMapper, lazy, resultData, serverTimeRepository, analyticsLogger));
    }
