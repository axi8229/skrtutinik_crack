...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0000\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u00022\u0014\u0012\u0004\u0012\u0002H\u0001\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u00040\u0003B\u001d\u0012\u0006\u0010\u0005\u001a\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00020\b\u0012\u0006\u0010\t\u001a\u00020\n¢\u0006\u0002\u0010\u000bJ\u001c\u0010\f\u001a\u00028\u00002\f\u0010\r\u001a\b\u0012\u0004\u0012\u00028\u00000\u0004H\u0096@¢\u0006\u0002\u0010\u000eR\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Lru/yoomoney/sdk/auth/api/migration/hardMigration/commands/MigrationLoginCommandExecutor;", "ACTION", "", "Lru/yoomoney/sdk/auth/api/migration/hardMigration/commands/CommandExecutor;", "Lru/yoomoney/sdk/auth/api/migration/hardMigration/commands/MigrationLoginCommand;", "migrationApiRepository", "Lru/yoomoney/sdk/auth/api/migration/MigrationRepository;", "profiler", "Lru/yoomoney/sdk/yooprofiler/YooProfiler;", "resultData", "Lru/yoomoney/sdk/auth/ResultData;", "(Lru/yoomoney/sdk/auth/api/migration/MigrationRepository;Lru/yoomoney/sdk/yooprofiler/YooProfiler;Lru/yoomoney/sdk/auth/ResultData;)V", "execute", "command", "(Lru/yoomoney/sdk/auth/api/migration/hardMigration/commands/MigrationLoginCommand;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "auth_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class MigrationLoginCommandExecutor<ACTION> implements CommandExecutor<ACTION, MigrationLoginCommand<ACTION>> {
    ...
    @DebugMetadata(c = "ru.yoomoney.sdk.auth.api.migration.hardMigration.commands.MigrationLoginCommandExecutor", f = "HardMigrationCommands.kt", l = {62}, m = "execute")
    public static final class a extends ContinuationImpl {
        public MigrationLoginCommandExecutor a;
        public MigrationLoginCommand b;
        public /* synthetic */ Object c;
        public final /* synthetic */ MigrationLoginCommandExecutor<ACTION> d;
        public int e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(MigrationLoginCommandExecutor<ACTION> migrationLoginCommandExecutor, Continuation<? super a> continuation) {
            super(continuation);
            this.d = migrationLoginCommandExecutor;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return this.d.execute((MigrationLoginCommand) null, (Continuation) this);
        }
    }
    ...
    */
    public java.lang.Object execute(ru.yoomoney.sdk.auth.api.migration.hardMigration.commands.MigrationLoginCommand<ACTION> r10, kotlin.coroutines.Continuation<? super ACTION> r11) {
        /*
            r9 = this;
        ...
        L18:
            ...
            if (r2 == 0) goto L3b
            if (r2 != r3) goto L33
            ru.yoomoney.sdk.auth.api.migration.hardMigration.commands.MigrationLoginCommand r10 = r0.b
            ru.yoomoney.sdk.auth.api.migration.hardMigration.commands.MigrationLoginCommandExecutor r0 = r0.a
        ...
        L9c:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: ru.yoomoney.sdk.auth.api.migration.hardMigration.commands.MigrationLoginCommandExecutor.execute(ru.yoomoney.sdk.auth.api.migration.hardMigration.commands.MigrationLoginCommand, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
