...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.confirm.impl.EmailConfirmBusinessLogic$handleValidState$10$1", f = "EmailConfirmBusinessLogic.kt", l = {169}, m = "invokeSuspend")
...
public final class x extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public x(EmailConfirmBusinessLogic emailConfirmBusinessLogic, Continuation<? super x> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            EmailConfirm.Effect.ShowExpireDialog showExpireDialog = EmailConfirm.Effect.ShowExpireDialog.INSTANCE;
            this.a = 1;
