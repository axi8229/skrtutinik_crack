...
import ru.yoomoney.sdk.auth.api.migration.method.MigrationSetPhoneSuggestionRequest;
import ru.yoomoney.sdk.auth.api.migration.model.InputType;

@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0003J \u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016¨\u0006\u000b"}, d2 = {"Lru/yoomoney/sdk/auth/api/migration/serializer/MigrationSetPhoneRequestSerializer;", "Lcom/google/gson/JsonSerializer;", "Lru/yoomoney/sdk/auth/api/migration/method/MigrationSetPhoneRequest;", "()V", "serialize", "Lcom/google/gson/JsonElement;", "src", "typeOfSrc", "Ljava/lang/reflect/Type;", "context", "Lcom/google/gson/JsonSerializationContext;", "auth_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class MigrationSetPhoneRequestSerializer implements JsonSerializer<MigrationSetPhoneRequest> {
    ...
    public JsonElement serialize(MigrationSetPhoneRequest src, Type typeOfSrc, JsonSerializationContext context) {
        ...
        if (i == 1) {
            obj = (MigrationSetPhoneRawRequest) src;
        } else {
            if (i != 2) {
                throw new NoWhenBranchMatchedException();
            }
            obj = (MigrationSetPhoneSuggestionRequest) src;
        }
