...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m872boximpl(Size.INSTANCE.m883getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            if (this.this$0.m1966getSizeNHjbRc() == 9205357640488583168L || Size.m880isEmptyimpl(this.this$0.m1966getSizeNHjbRc())) {
                return null;
            }
            return this.this$0.getShaderBrush().mo962createShaderuvyYCjk(this.this$0.m1966getSizeNHjbRc());
        }
    });
    ...
    public final long m1966getSizeNHjbRc() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m1967setSizeuvyYCjk(long j) {
