...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        FqName fqNameTail = FqNamesUtilKt.tail(fqName9, packageFqName16);
        ...
        for (int i2 = 0; i2 < 22; i2++) {
            ...
            INSTANCE.addKotlinToJava(new FqName((kSuspendFunction2.getPackageFqName().toString() + '.' + kSuspendFunction2.getClassNamePrefix()) + i2), K_FUNCTION_CLASS_ID);
        }
