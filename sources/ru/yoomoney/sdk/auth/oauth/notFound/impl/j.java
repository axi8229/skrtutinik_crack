...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.oauth.notFound.impl.OauthNotFoundBusinessLogic$handleProgressRegistrationState$1$2", f = "OauthNotFoundBusinessLogic.kt", l = {53}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class j extends SuspendLambda implements Function1<Continuation<? super OauthNotFound.Action>, Object> {
    public int a;
    ...
    public j(OauthNotFoundBusinessLogic oauthNotFoundBusinessLogic, Out.Builder<OauthNotFound.State.Content, OauthNotFound.Action> builder, Continuation<? super j> continuation) {
