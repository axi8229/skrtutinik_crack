...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.confirm.impl.EmailConfirmBusinessLogic$handleProgressState$3$1", f = "EmailConfirmBusinessLogic.kt", l = {216}, m = "invokeSuspend")
...
public final class o extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public o(EmailConfirmBusinessLogic emailConfirmBusinessLogic, EmailConfirm.Action action, Continuation<? super o> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            EmailConfirm.Effect.ShowFailure showFailure = new EmailConfirm.Effect.ShowFailure(((EmailConfirm.Action.ConfirmEmailTechnicalError) this.c).getFailure());
            this.a = 1;
