    ...
    public void mo153onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            ...
            if (PointerEventType.m1330equalsimpl0(type, companion.m1331getEnter7fucELk())) {
                onEnter();
            } else if (PointerEventType.m1330equalsimpl0(pointerEvent.getType(), companion.m1332getExit7fucELk())) {
                onExit();
            }
        }
    }
