...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.enter.impl.EmailEnterBusinessLogic$handleLoadingState$3$1", f = "EmailEnterBusinessLogic.kt", l = {81}, m = "invokeSuspend")
...
public final class n extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public n(EmailEnterBusinessLogic emailEnterBusinessLogic, EmailEnter.Action action, Continuation<? super n> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            EmailEnter.Effect.ShowNextRegistrationStep showNextRegistrationStep = new EmailEnter.Effect.ShowNextRegistrationStep(((EmailEnter.Action.ConfirmEmailSuccess) this.c).getProcess());
            this.a = 1;
