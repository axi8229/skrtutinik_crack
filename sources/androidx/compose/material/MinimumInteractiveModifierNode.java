...
public final class MinimumInteractiveModifierNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutModifierNode {
    ...
    public MeasureResult mo105measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (z) {
            width = Math.max(placeableMo1420measureBRTryo0.getWidth(), measureScope.mo248roundToPx0680j_4(DpSize.m2126getWidthD9Ej5fM(j2)));
        } else {
            width = placeableMo1420measureBRTryo0.getWidth();
        }
        final int i = width;
        if (z) {
            height = Math.max(placeableMo1420measureBRTryo0.getHeight(), measureScope.mo248roundToPx0680j_4(DpSize.m2125getHeightD9Ej5fM(j2)));
        } else {
        ...
        return MeasureScope.layout$default(measureScope, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.MinimumInteractiveModifierNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo1420measureBRTryo0, MathKt.roundToInt((i - placeableMo1420measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((i2 - placeableMo1420measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
