...
public final class zzb extends zze {
    ...
    private final void zza(long j, zzlk zzlkVar) throws IllegalStateException {
        if (zzlkVar == null) {
    ...
    private final void zza(String str, long j, zzlk zzlkVar) throws IllegalStateException {
        if (zzlkVar == null) {
