...
public final /* data */ class AuthorizationVoiced implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<AuthorizationVoiced> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final AuthorizationVoiced createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return new AuthorizationVoiced(parcel.readInt() == 0 ? null : TextWithParam.CREATOR.createFromParcel(parcel), parcel.readInt() != 0 ? TextWithParam.CREATOR.createFromParcel(parcel) : null);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final AuthorizationVoiced[] newArray(int i) {
            return new AuthorizationVoiced[i];
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AuthorizationVoiced)) {
            return false;
        }
        AuthorizationVoiced authorizationVoiced = (AuthorizationVoiced) other;
        return Intrinsics.areEqual(this.title, authorizationVoiced.title) && Intrinsics.areEqual(this.numberInfo, authorizationVoiced.numberInfo);
    }
    ...
    public String toString() {
        return "AuthorizationVoiced(title=" + this.title + ", numberInfo=" + this.numberInfo + ")";
    }
    ...
    public AuthorizationVoiced(TextWithParam textWithParam, TextWithParam textWithParam2) {
