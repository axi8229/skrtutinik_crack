        ...
        for (DeclarationDescriptor declarationDescriptor : ResolutionScope.DefaultImpls.getContributedDescriptors$default(memberScope, DescriptorKindFilter.CLASSIFIERS, null, 2, null)) {
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptor2.isExpect()) {
                    ...
                    ClassifierDescriptor classifierDescriptorMo2744getContributedClassifier = memberScope.mo2744getContributedClassifier(name, NoLookupLocation.WHEN_GET_ALL_DESCRIPTORS);
                    if (classifierDescriptorMo2744getContributedClassifier instanceof ClassDescriptor) {
                        classDescriptor2 = (ClassDescriptor) classifierDescriptorMo2744getContributedClassifier;
                    } else {
                        classDescriptor2 = classifierDescriptorMo2744getContributedClassifier instanceof TypeAliasDescriptor ? ((TypeAliasDescriptor) classifierDescriptorMo2744getContributedClassifier).getClassDescriptor() : null;
                    }
                }
