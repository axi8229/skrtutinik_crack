...
public final /* data */ class ChangeEmailConfirmPhone extends ChangeEmailProcess {
    ...
    public ChangeEmailConfirmPhone(String id, OffsetDateTime expireAt, boolean z, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int i, int i2, String phone) {
        super(null);
    ...
    public final ChangeEmailConfirmPhone copy(String id, OffsetDateTime expireAt, boolean addToBackStack, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int secretLength, int attemptsLeft, String phone) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(expireAt, "expireAt");
        Intrinsics.checkNotNullParameter(validUntil, "validUntil");
        Intrinsics.checkNotNullParameter(nextResendFrom, "nextResendFrom");
        Intrinsics.checkNotNullParameter(phone, "phone");
        return new ChangeEmailConfirmPhone(id, expireAt, addToBackStack, validUntil, nextResendFrom, secretLength, attemptsLeft, phone);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ChangeEmailConfirmPhone)) {
            return false;
        }
        ChangeEmailConfirmPhone changeEmailConfirmPhone = (ChangeEmailConfirmPhone) other;
        return Intrinsics.areEqual(this.id, changeEmailConfirmPhone.id) && Intrinsics.areEqual(this.expireAt, changeEmailConfirmPhone.expireAt) && this.addToBackStack == changeEmailConfirmPhone.addToBackStack && Intrinsics.areEqual(this.validUntil, changeEmailConfirmPhone.validUntil) && Intrinsics.areEqual(this.nextResendFrom, changeEmailConfirmPhone.nextResendFrom) && this.secretLength == changeEmailConfirmPhone.secretLength && this.attemptsLeft == changeEmailConfirmPhone.attemptsLeft && Intrinsics.areEqual(this.phone, changeEmailConfirmPhone.phone);
    }
    ...
    public String toString() {
        return "ChangeEmailConfirmPhone(id=" + this.id + ", expireAt=" + this.expireAt + ", addToBackStack=" + this.addToBackStack + ", validUntil=" + this.validUntil + ", nextResendFrom=" + this.nextResendFrom + ", secretLength=" + this.secretLength + ", attemptsLeft=" + this.attemptsLeft + ", phone=" + this.phone + ")";
    }
}
