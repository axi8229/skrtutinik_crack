...
public final class KotlinTypeFactory {
    ...
    private final MemberScope computeMemberScope(TypeConstructor typeConstructor, List<? extends TypeProjection> list, KotlinTypeRefiner kotlinTypeRefiner) {
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = typeConstructor.mo2742getDeclarationDescriptor();
        if (classifierDescriptorMo2742getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return ((TypeParameterDescriptor) classifierDescriptorMo2742getDeclarationDescriptor).getDefaultType().getMemberScope();
        }
        if (classifierDescriptorMo2742getDeclarationDescriptor instanceof ClassDescriptor) {
            if (kotlinTypeRefiner == null) {
                kotlinTypeRefiner = DescriptorUtilsKt.getKotlinTypeRefiner(DescriptorUtilsKt.getModule(classifierDescriptorMo2742getDeclarationDescriptor));
            }
            if (list.isEmpty()) {
                return ModuleAwareClassDescriptorKt.getRefinedUnsubstitutedMemberScopeIfPossible((ClassDescriptor) classifierDescriptorMo2742getDeclarationDescriptor, kotlinTypeRefiner);
            }
            return ModuleAwareClassDescriptorKt.getRefinedMemberScopeIfPossible((ClassDescriptor) classifierDescriptorMo2742getDeclarationDescriptor, TypeConstructorSubstitution.Companion.create(typeConstructor, list), kotlinTypeRefiner);
        }
        if (classifierDescriptorMo2742getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            ErrorScopeKind errorScopeKind = ErrorScopeKind.SCOPE_FOR_ABBREVIATION_TYPE;
            String string = ((TypeAliasDescriptor) classifierDescriptorMo2742getDeclarationDescriptor).getName().toString();
        ...
        throw new IllegalStateException("Unsupported classifier: " + classifierDescriptorMo2742getDeclarationDescriptor + " for constructor: " + typeConstructor);
    }
    ...
    public static final SimpleType simpleType(final TypeAttributes attributes, final TypeConstructor constructor, final List<? extends TypeProjection> arguments, final boolean z, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        Intrinsics.checkNotNullParameter(constructor, "constructor");
        Intrinsics.checkNotNullParameter(arguments, "arguments");
        if (attributes.isEmpty() && arguments.isEmpty() && !z && constructor.mo2742getDeclarationDescriptor() != null) {
            ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = constructor.mo2742getDeclarationDescriptor();
            Intrinsics.checkNotNull(classifierDescriptorMo2742getDeclarationDescriptor);
            SimpleType defaultType = classifierDescriptorMo2742getDeclarationDescriptor.getDefaultType();
    ...
    public final ExpandedTypeOrRefinedConstructor refineConstructor(TypeConstructor typeConstructor, KotlinTypeRefiner kotlinTypeRefiner, List<? extends TypeProjection> list) {
        ...
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = typeConstructor.mo2742getDeclarationDescriptor();
        if (classifierDescriptorMo2742getDeclarationDescriptor == null || (classifierDescriptorRefineDescriptor = kotlinTypeRefiner.refineDescriptor(classifierDescriptorMo2742getDeclarationDescriptor)) == null) {
            return null;
        }
