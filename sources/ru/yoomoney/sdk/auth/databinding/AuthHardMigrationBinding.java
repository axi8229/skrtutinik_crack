...
public final class AuthHardMigrationBinding implements ViewBinding {
    ...
    private AuthHardMigrationBinding(ConstraintLayout constraintLayout, PrimaryButtonView primaryButtonView, TextCaption2View textCaption2View, TopBarDefault topBarDefault, ConstraintLayout constraintLayout2, TextBodyView textBodyView, TextTitle1View textTitle1View) {
    ...
    public static AuthHardMigrationBinding bind(View view) {
        int i = R.id.action;
                ...
                if (topBarDefault != null) {
                    ...
                    if (textBodyView != null) {
                        ...
                        if (textTitle1View != null) {
                            return new AuthHardMigrationBinding(constraintLayout, primaryButtonView, textCaption2View, topBarDefault, constraintLayout, textBodyView, textTitle1View);
                        }
                    }
                }
            }
    ...
    public static AuthHardMigrationBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AuthHardMigrationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.auth_hard_migration, viewGroup, false);
        if (z) {
