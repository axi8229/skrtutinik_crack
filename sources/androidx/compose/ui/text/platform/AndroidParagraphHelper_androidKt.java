...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String str, float f, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean z) {
        ...
        if (z && EmojiCompat.isConfigured()) {
            ...
            EmojiSupportMatch emojiSupportMatchM1699boximpl = (platformStyle == null || (paragraphSyle = platformStyle.getParagraphSyle()) == null) ? null : EmojiSupportMatch.m1699boximpl(paragraphSyle.getEmojiSupportMatch());
            charSequenceProcess = EmojiCompat.get().process(str, 0, str.length(), Integer.MAX_VALUE, emojiSupportMatchM1699boximpl == null ? 0 : EmojiSupportMatch.m1702equalsimpl0(emojiSupportMatchM1699boximpl.getValue(), EmojiSupportMatch.INSTANCE.m1706getAll_3YsG6Y()));
            Intrinsics.checkNotNull(charSequenceProcess);
        } else {
            charSequenceProcess = str;
        }
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(textStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m2175isUnspecifiedR2X_6o(textStyle.m1812getLineHeightXSAIIZE())) {
        ...
        if (isIncludeFontPaddingEnabled(textStyle) && textStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m1962setLineHeightr9BaKPg(spannableString, textStyle.m1812getLineHeightXSAIIZE(), f, density);
        } else {
            LineHeightStyle lineHeightStyle = textStyle.getLineHeightStyle();
            if (lineHeightStyle == null) {
                lineHeightStyle = LineHeightStyle.INSTANCE.getDefault();
            }
            SpannableExtensions_androidKt.m1961setLineHeightKmRG4DE(spannableString, textStyle.m1812getLineHeightXSAIIZE(), f, density, lineHeightStyle);
        }
