...
public class FlussonicMosaicController_LifecycleAdapter implements GeneratedAdapter {
    final FlussonicMosaicController mReceiver;

    FlussonicMosaicController_LifecycleAdapter(FlussonicMosaicController receiver) {
