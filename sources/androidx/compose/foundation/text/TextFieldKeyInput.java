...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m472typedCommandZmokQxo(KeyEvent event) {
        Integer numM412consumeZmokQxo;
        if (TextFieldKeyInput_androidKt.m476isTypedEventZmokQxo(event) && (numM412consumeZmokQxo = this.keyCombiner.m412consumeZmokQxo(event)) != null) {
            return new CommitTextCommand(StringHelpers_jvmKt.appendCodePointX(new StringBuilder(), numM412consumeZmokQxo.intValue()).toString(), 1);
        }
        return null;
    }

    /* renamed from: process-ZmokQxo, reason: not valid java name */
    public final boolean m473processZmokQxo(KeyEvent event) {
        final KeyCommand keyCommandMo414mapZmokQxo;
        CommitTextCommand commitTextCommandM472typedCommandZmokQxo = m472typedCommandZmokQxo(event);
        if (commitTextCommandM472typedCommandZmokQxo != null) {
            if (!this.editable) {
                return false;
            }
            apply(commitTextCommandM472typedCommandZmokQxo);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        if (!KeyEventType.m1289equalsimpl0(KeyEvent_androidKt.m1294getTypeZmokQxo(event), KeyEventType.INSTANCE.m1290getKeyDownCS__XNY()) || (keyCommandMo414mapZmokQxo = this.keyMapping.mo414mapZmokQxo(event)) == null || (keyCommandMo414mapZmokQxo.getEditsText() && !this.editable)) {
            return false;
        }
        ...
        commandExecutionContext(new Function1<TextFieldPreparedSelection, Unit>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2
            ...
            public final void invoke2(TextFieldPreparedSelection textFieldPreparedSelection) {
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo414mapZmokQxo.ordinal()]) {
                    case 1:
                    ...
                    case 20:
                        List<EditCommand> listDeleteIfSelectedOr = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                return new DeleteSurroundingTextCommand(TextRange.m1787getEndimpl(textFieldPreparedSelection2.getSelection()) - textFieldPreparedSelection2.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr2 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m1787getEndimpl(textFieldPreparedSelection2.getSelection()));
                                }
                                return null;
                            }
                        });
                    ...
                    case 22:
                        List<EditCommand> listDeleteIfSelectedOr3 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                return new DeleteSurroundingTextCommand(TextRange.m1787getEndimpl(textFieldPreparedSelection2.getSelection()) - previousWordOffset.intValue(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr4 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (nextWordOffset != null) {
                                    return new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m1787getEndimpl(textFieldPreparedSelection2.getSelection()));
                                }
                                return null;
                            }
                        });
                    ...
                    case 24:
                        List<EditCommand> listDeleteIfSelectedOr5 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.7
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                return new DeleteSurroundingTextCommand(TextRange.m1787getEndimpl(textFieldPreparedSelection2.getSelection()) - lineStartByOffset.intValue(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr6 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.8
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (lineEndByOffset != null) {
                                    return new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m1787getEndimpl(textFieldPreparedSelection2.getSelection()));
                                }
                                return null;
                            }
                        });
                    ...
                    case 26:
                        if (!this.getSingleLine()) {
                            ...
                            this.getState().getOnImeActionPerformed().invoke(ImeAction.m1883boximpl(this.imeAction));
                            break;
                        }
                    case 27:
                        if (!this.getSingleLine()) {
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (TextRange.m1785equalsimpl0(textFieldPreparedSelection.getSelection(), this.value.getSelection()) && Intrinsics.areEqual(textFieldPreparedSelection.getAnnotatedString(), this.value.getText())) {
            return;
        }
