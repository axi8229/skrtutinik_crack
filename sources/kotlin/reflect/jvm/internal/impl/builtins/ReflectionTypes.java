...
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor classifierDescriptorMo2744getContributedClassifier = getKotlinReflectScope().mo2744getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
