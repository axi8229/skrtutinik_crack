...
final class UnsafeUtil {
    ...
    public static byte getByteBigEndian(Object target, long offset) {
        return (byte) ((getInt(target, (-4) & offset) >>> ((int) (((~offset) & 3) << 3))) & KotlinVersion.MAX_COMPONENT_VALUE);
    }
    ...
    public static void putByteBigEndian(Object target, long offset, byte value) {
        ...
        putInt(target, j, ((255 & value) << i2) | (i & (~(KotlinVersion.MAX_COMPONENT_VALUE << i2))));
    }
    ...
    public static void putByteLittleEndian(Object target, long offset, byte value) {
        ...
        putInt(target, j, ((255 & value) << i) | (getInt(target, j) & (~(KotlinVersion.MAX_COMPONENT_VALUE << i))));
    }
