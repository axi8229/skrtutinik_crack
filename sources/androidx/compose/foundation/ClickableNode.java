...
public class ClickableNode extends AbstractClickableNode {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (ClickableNode.this.getEnabled()) {
                    ...
                    this.label = 1;
                    if (clickableNode.m151handlePressInteractiond4ec7I(pressGestureScope, j, this) == coroutine_suspended) {
    ...
    public final void m173updateQzZPfjk(MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        m155updateCommonQzZPfjk(interactionSource, indicationNodeFactory, enabled, onClickLabel, role, onClick);
    }
}
