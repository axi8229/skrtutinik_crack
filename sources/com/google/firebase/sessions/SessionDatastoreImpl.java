...
public final class SessionDatastoreImpl implements SessionDatastore {
    ...
    public SessionDatastoreImpl(Context context, CoroutineContext backgroundDispatcher) {
        ...
        final Flow flowM2805catch = FlowKt.m2805catch(Companion.getDataStore(context).getData(), new SessionDatastoreImpl$firebaseSessionDataFlow$1(null));
        this.firebaseSessionDataFlow = new Flow<FirebaseSessionsData>() { // from class: com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1
            ...
            public Object collect(FlowCollector<? super FirebaseSessionsData> flowCollector, Continuation continuation) {
                Object objCollect = flowM2805catch.collect(new AnonymousClass2(flowCollector, this), continuation);
    ...
    static final class C05821 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C05821(String str, Continuation<? super C05821> continuation) {
            super(2, continuation);
            this.$sessionId = str;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionDatastoreImpl.this.new C05821(this.$sessionId, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i == 0) {
                    ...
                    C00751 c00751 = new C00751(this.$sessionId, null);
                    this.label = 1;
                    if (PreferencesKt.edit(dataStore, c00751, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        static final class C00751 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
            final /* synthetic */ String $sessionId;
            /* synthetic */ Object L$0;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00751(String str, Continuation<? super C00751> continuation) {
                super(2, continuation);
                this.$sessionId = str;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00751 c00751 = new C00751(this.$sessionId, continuation);
                c00751.L$0 = obj;
                return c00751;
            }
            ...
            public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
                return ((C00751) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
            }
    ...
    public void updateSessionId(String sessionId) {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(this.backgroundDispatcher), null, null, new C05821(sessionId, null), 3, null);
    }
