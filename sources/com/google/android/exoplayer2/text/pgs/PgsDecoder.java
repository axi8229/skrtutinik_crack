    ...
    private static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray buffer, int sectionLength) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                this.colors[unsignedByte] = (Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, KotlinVersion.MAX_COMPONENT_VALUE) << 8) | (buffer.readUnsignedByte() << 24) | (Util.constrainValue((int) ((1.402d * d2) + d), 0, KotlinVersion.MAX_COMPONENT_VALUE) << 16) | Util.constrainValue((int) (d + (d3 * 1.772d)), 0, KotlinVersion.MAX_COMPONENT_VALUE);
            }
            this.colorsSet = true;
        }
