        ...
        protected void onMeasure(int i, int i2) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt.getLayoutParams().width == -1) {
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH), View.MeasureSpec.makeMeasureSpec(childAt.getMeasuredHeight(), pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH));
                }
            }
        }
    }
