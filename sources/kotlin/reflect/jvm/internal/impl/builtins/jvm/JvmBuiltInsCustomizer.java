...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    public JvmBuiltInsCustomizer(ModuleDescriptor moduleDescriptor, final StorageManager storageManager, Function0<JvmBuiltIns.Settings> settingsComputation) {
        ...
        this.deprecationForSomeOfTheListMethods = storageManager.createMemoizedFunction(new Function1<Pair<? extends String, ? extends String>, Annotations>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer$deprecationForSomeOfTheListMethods$1
            ...
            public final Annotations invoke2(Pair<String, String> pair) {
                ...
                return Annotations.Companion.create(CollectionsKt.listOf(AnnotationUtilKt.createDeprecatedAnnotation$default(this.this$0.moduleDescriptor.getBuiltIns(), '\'' + strComponent1 + "()' member of List is redundant in Kotlin and might be removed soon. Please use '" + strComponent2 + "()' stdlib extension instead", strComponent2 + "()", null, true, 4, null)));
            }
        });
    }
            ...
            */
            public final java.lang.Boolean invoke(kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor r3) {
                ...
                L22:
                    ...
                    return r3
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer.C14272.invoke(kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor):java.lang.Boolean");
            }
        });
    ...
    public static final Iterable getJdkMethodStatus$lambda$9(JvmBuiltInsCustomizer this$0, ClassDescriptor classDescriptor) {
        ...
        Collection<KotlinType> collectionMo2743getSupertypes = classDescriptor.getTypeConstructor().mo2743getSupertypes();
        ...
        while (it.hasNext()) {
            ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = ((KotlinType) it.next()).getConstructor().mo2742getDeclarationDescriptor();
            LazyJavaClassDescriptor javaAnalogue = null;
            ClassifierDescriptor original = classifierDescriptorMo2742getDeclarationDescriptor != null ? classifierDescriptorMo2742getDeclarationDescriptor.getOriginal() : null;
            ClassDescriptor classDescriptor2 = original instanceof ClassDescriptor ? (ClassDescriptor) original : null;
            if (classDescriptor2 != null && (javaAnalogue = this$0.getJavaAnalogue(classDescriptor2)) == null) {
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo2742getDeclarationDescriptor();
            if (Intrinsics.areEqual(classifierDescriptorMo2742getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameUnsafe(classifierDescriptorMo2742getDeclarationDescriptor) : null, DescriptorUtilsKt.getFqNameUnsafe(classDescriptor))) {
                return true;
            }
        }
        return false;
