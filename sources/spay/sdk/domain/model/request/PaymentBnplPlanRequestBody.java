...
public final /* data */ class PaymentBnplPlanRequestBody {
    ...
    public PaymentBnplPlanRequestBody(String sessionId, String str, String orderId) {
    ...
    public static /* synthetic */ PaymentBnplPlanRequestBody copy$default(PaymentBnplPlanRequestBody paymentBnplPlanRequestBody, String str, String str2, String str3, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final PaymentBnplPlanRequestBody copy(String sessionId, String merchantLogin, String orderId) {
        Intrinsics.checkNotNullParameter(sessionId, "sessionId");
        Intrinsics.checkNotNullParameter(orderId, "orderId");
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.sessionId, paymentBnplPlanRequestBody.sessionId) && Intrinsics.areEqual(this.merchantLogin, paymentBnplPlanRequestBody.merchantLogin) && Intrinsics.areEqual(this.orderId, paymentBnplPlanRequestBody.orderId);
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PaymentBnplPlanRequestBody(sessionId=");
    ...
    public /* synthetic */ PaymentBnplPlanRequestBody(String str, String str2, String str3, int i, DefaultConstructorMarker defaultConstructorMarker) {
