...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.enter.impl.PasswordEnterBusinessLogic$handleProgressState$3$2", f = "PasswordEnterBusinessLogic.kt", l = {74}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class n extends SuspendLambda implements Function1<Continuation<? super PasswordEnter.Action>, Object> {
    public int a;
    ...
    public n(PasswordEnterBusinessLogic passwordEnterBusinessLogic, Out.Builder<PasswordEnter.State.Content, PasswordEnter.Action> builder, Continuation<? super n> continuation) {
