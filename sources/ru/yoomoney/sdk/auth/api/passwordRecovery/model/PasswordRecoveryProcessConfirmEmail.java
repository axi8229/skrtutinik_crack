...
public final /* data */ class PasswordRecoveryProcessConfirmEmail extends PasswordRecoveryProcess {
    ...
    public PasswordRecoveryProcessConfirmEmail(String id, OffsetDateTime expireAt, boolean z, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int i, int i2, String email) {
        super(null);
    ...
    public final PasswordRecoveryProcessConfirmEmail copy(String id, OffsetDateTime expireAt, boolean addToBackStack, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int secretLength, int attemptsLeft, String email) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(expireAt, "expireAt");
        Intrinsics.checkNotNullParameter(validUntil, "validUntil");
        Intrinsics.checkNotNullParameter(nextResendFrom, "nextResendFrom");
        Intrinsics.checkNotNullParameter(email, "email");
        return new PasswordRecoveryProcessConfirmEmail(id, expireAt, addToBackStack, validUntil, nextResendFrom, secretLength, attemptsLeft, email);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PasswordRecoveryProcessConfirmEmail)) {
            return false;
        }
        PasswordRecoveryProcessConfirmEmail passwordRecoveryProcessConfirmEmail = (PasswordRecoveryProcessConfirmEmail) other;
        return Intrinsics.areEqual(this.id, passwordRecoveryProcessConfirmEmail.id) && Intrinsics.areEqual(this.expireAt, passwordRecoveryProcessConfirmEmail.expireAt) && this.addToBackStack == passwordRecoveryProcessConfirmEmail.addToBackStack && Intrinsics.areEqual(this.validUntil, passwordRecoveryProcessConfirmEmail.validUntil) && Intrinsics.areEqual(this.nextResendFrom, passwordRecoveryProcessConfirmEmail.nextResendFrom) && this.secretLength == passwordRecoveryProcessConfirmEmail.secretLength && this.attemptsLeft == passwordRecoveryProcessConfirmEmail.attemptsLeft && Intrinsics.areEqual(this.email, passwordRecoveryProcessConfirmEmail.email);
    }
    ...
    public String toString() {
        return "PasswordRecoveryProcessConfirmEmail(id=" + this.id + ", expireAt=" + this.expireAt + ", addToBackStack=" + this.addToBackStack + ", validUntil=" + this.validUntil + ", nextResendFrom=" + this.nextResendFrom + ", secretLength=" + this.secretLength + ", attemptsLeft=" + this.attemptsLeft + ", email=" + this.email + ")";
    }
}
