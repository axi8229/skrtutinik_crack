...
public interface SoftKeyboardInterceptionModifierNode extends DelegatableNode {
    ...
    boolean m1300onInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event);

    /* renamed from: onPreInterceptKeyBeforeSoftKeyboard-ZmokQxo, reason: not valid java name */
    boolean m1301onPreInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event);
}
