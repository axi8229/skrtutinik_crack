...
public class q0 extends n0<s, Void> {
    ...
    public void doExecute(s sVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<Void> taskCompletionSource) throws ApiException {
        HMSLocationLog.i("EnableBackgroundLocationTaskApiCall", ((n0) this).a, "doExecute");
        try {
            ...
            HMSLocationLog.e("EnableBackgroundLocationTaskApiCall", ((n0) this).a, "enable background location doExecute exception");
