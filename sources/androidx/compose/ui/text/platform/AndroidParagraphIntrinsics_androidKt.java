...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static final int m1945resolveTextDirectionHeuristicsHklW4sA(int i, LocaleList localeList) {
        Locale platformLocale;
        TextDirection.Companion companion = TextDirection.INSTANCE;
        if (TextDirection.m2044equalsimpl0(i, companion.m2049getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (!TextDirection.m2044equalsimpl0(i, companion.m2050getContentOrRtls_7Xco())) {
            if (TextDirection.m2044equalsimpl0(i, companion.m2051getLtrs_7Xco())) {
                return 0;
            }
            if (TextDirection.m2044equalsimpl0(i, companion.m2052getRtls_7Xco())) {
                return 1;
            }
            if (TextDirection.m2044equalsimpl0(i, companion.m2048getContents_7Xco()) ? true : TextDirection.m2044equalsimpl0(i, companion.m2053getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle textStyle) {
        ...
        return !(((platformStyle == null || (paragraphSyle = platformStyle.getParagraphSyle()) == null) ? null : EmojiSupportMatch.m1699boximpl(paragraphSyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m1702equalsimpl0(r1.getValue(), EmojiSupportMatch.INSTANCE.m1708getNone_3YsG6Y()));
    }
}
