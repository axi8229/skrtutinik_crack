...
@DebugMetadata(c = "sputnik.axmor.com.sputnik.ui.main.cameras.CameraStreamFragment$playersCallback$1$onStateChanged$1$1$1$1", f = "CameraStreamFragment.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes5.dex */
final class CameraStreamFragment$playersCallback$1$onStateChanged$1$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CameraStreamFragment$playersCallback$1$onStateChanged$1$1$1$1(CameraStreamFragment cameraStreamFragment, PlayersCallback.Players players, PlayerStates playerStates, Continuation<? super CameraStreamFragment$playersCallback$1$onStateChanged$1$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CameraStreamFragment$playersCallback$1$onStateChanged$1$1$1$1(this.this$0, this.$player, this.$state, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CameraStreamFragment$playersCallback$1$onStateChanged$1$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
