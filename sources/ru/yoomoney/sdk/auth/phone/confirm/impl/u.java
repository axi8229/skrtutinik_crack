...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.confirm.impl.PhoneConfirmBusinessLogic$processStateProgressAction$6$1", f = "PhoneConfirmBusinessLogic.kt", l = {133}, m = "invokeSuspend")
...
public final class u extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public u(PhoneConfirmBusinessLogic phoneConfirmBusinessLogic, Continuation<? super u> continuation) {
    ...
    public final Object invoke(Continuation<? super Unit> continuation) {
        return new u(this.b, continuation).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneConfirm.Effect.ShowHelp showHelp = PhoneConfirm.Effect.ShowHelp.INSTANCE;
            this.a = 1;
