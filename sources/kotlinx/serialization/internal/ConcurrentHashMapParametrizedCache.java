...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo2813getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                objM2628constructorimpl = Result.m2628constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM2628constructorimpl = Result.m2628constructorimpl(ResultKt.createFailure(th));
            }
            Result resultM2627boximpl = Result.m2627boximpl(objM2628constructorimpl);
            Object objPutIfAbsent = concurrentHashMap2.putIfAbsent(arrayList, resultM2627boximpl);
            obj = objPutIfAbsent == null ? resultM2627boximpl : objPutIfAbsent;
        }
