...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH);
    ...
    private class TabView extends LinearLayout {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0) {
                ...
                if (measuredWidth > i3) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(i3, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH), i2);
                }
            }
        }
