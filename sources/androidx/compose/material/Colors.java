...
public final class Colors {
    ...
    private Colors(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, boolean z) {
        this.primary = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j), SnapshotStateKt.structuralEqualityPolicy());
        this.primaryVariant = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j2), SnapshotStateKt.structuralEqualityPolicy());
        this.secondary = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j3), SnapshotStateKt.structuralEqualityPolicy());
        this.secondaryVariant = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j4), SnapshotStateKt.structuralEqualityPolicy());
        this.background = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j5), SnapshotStateKt.structuralEqualityPolicy());
        this.surface = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j6), SnapshotStateKt.structuralEqualityPolicy());
        this.error = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j7), SnapshotStateKt.structuralEqualityPolicy());
        this.onPrimary = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j8), SnapshotStateKt.structuralEqualityPolicy());
        this.onSecondary = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j9), SnapshotStateKt.structuralEqualityPolicy());
        this.onBackground = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j10), SnapshotStateKt.structuralEqualityPolicy());
        this.onSurface = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j11), SnapshotStateKt.structuralEqualityPolicy());
        this.onError = SnapshotStateKt.mutableStateOf(Color.m971boximpl(j12), SnapshotStateKt.structuralEqualityPolicy());
    ...
    public String toString() {
        return "Colors(primary=" + ((Object) Color.m984toStringimpl(m608getPrimary0d7_KjU())) + ", primaryVariant=" + ((Object) Color.m984toStringimpl(m609getPrimaryVariant0d7_KjU())) + ", secondary=" + ((Object) Color.m984toStringimpl(m610getSecondary0d7_KjU())) + ", secondaryVariant=" + ((Object) Color.m984toStringimpl(m611getSecondaryVariant0d7_KjU())) + ", background=" + ((Object) Color.m984toStringimpl(m601getBackground0d7_KjU())) + ", surface=" + ((Object) Color.m984toStringimpl(m612getSurface0d7_KjU())) + ", error=" + ((Object) Color.m984toStringimpl(m602getError0d7_KjU())) + ", onPrimary=" + ((Object) Color.m984toStringimpl(m605getOnPrimary0d7_KjU())) + ", onSecondary=" + ((Object) Color.m984toStringimpl(m606getOnSecondary0d7_KjU())) + ", onBackground=" + ((Object) Color.m984toStringimpl(m603getOnBackground0d7_KjU())) + ", onSurface=" + ((Object) Color.m984toStringimpl(m607getOnSurface0d7_KjU())) + ", onError=" + ((Object) Color.m984toStringimpl(m604getOnError0d7_KjU())) + ", isLight=" + isLight() + ')';
    }
}
