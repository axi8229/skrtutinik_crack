...
public final class M0 extends SuspendLambda implements Function1 {
    ...
    public M0(E1 e1, Out.Builder builder, Continuation continuation) {
    ...
    public final Continuation create(Continuation continuation) {
        return new M0(this.b, this.c, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        return new M0(this.b, this.c, (Continuation) obj).invokeSuspend(Unit.INSTANCE);
    }
