    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo2743getSupertypes = simpleType.getConstructor().mo2743getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo2743getSupertypes, "getSupertypes(...)");
                Collection<KotlinType> collection = collectionMo2743getSupertypes;
