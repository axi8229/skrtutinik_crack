...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    public void mo1364onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        boolean z;
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
            ...
            if (changes.get(i).isConsumed()) {
                if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                    ...
                    if (layoutCoordinates != null) {
                        long jMo1425localToRootMKHz9U = layoutCoordinates.mo1425localToRootMKHz9U(Offset.INSTANCE.m854getZeroF1C5BW0());
                        final PointerInteropFilter pointerInteropFilter = this.this$0;
                        PointerInteropUtils_androidKt.m1365toCancelMotionEventScoped4ec7I(pointerEvent, jMo1425localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                            {
                                super(1);
                            }
        ...
        if (layoutCoordinates2 != null) {
            long jMo1425localToRootMKHz9U2 = layoutCoordinates2.mo1425localToRootMKHz9U(Offset.INSTANCE.m854getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m1366toMotionEventScoped4ec7I(pointerEvent, jMo1425localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
