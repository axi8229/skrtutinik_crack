    ...
    */
    final long zza(android.content.Context r7, java.lang.String r8) throws java.lang.IllegalStateException, java.security.NoSuchAlgorithmException {
        ...
        L56:
            ...
            goto L66
        L58:
            com.google.android.gms.measurement.internal.zzgo r7 = r6.zzj()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            com.google.android.gms.measurement.internal.zzgq r7 = r7.zzu()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
        ...
        L74:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzos.zza(android.content.Context, java.lang.String):long");
    }
    ...
    public static ArrayList<Bundle> zzb(List<zzae> list) {
        ...
        for (zzae zzaeVar : list) {
            Bundle bundle = new Bundle();
            bundle.putString(HiAnalyticsConstant.BI_KEY_APP_ID, zzaeVar.zza);
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdo zzdoVar, boolean z) throws IllegalStateException {
        Bundle bundle = new Bundle();
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdo zzdoVar, ArrayList<Bundle> arrayList) throws IllegalStateException {
        Bundle bundle = new Bundle();
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdo zzdoVar, Bundle bundle) throws IllegalStateException {
        try {
            zzdoVar.zza(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdo zzdoVar, byte[] bArr) throws IllegalStateException {
        Bundle bundle = new Bundle();
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdo zzdoVar, int i) throws IllegalStateException {
        Bundle bundle = new Bundle();
        bundle.putInt("r", i);
        try {
            zzdoVar.zza(bundle);
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdo zzdoVar, long j) throws IllegalStateException {
        Bundle bundle = new Bundle();
        bundle.putLong("r", j);
        try {
            zzdoVar.zza(bundle);
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdo zzdoVar, String str) throws IllegalStateException {
        Bundle bundle = new Bundle();
    ...
    @TargetApi(30)
    private final boolean zzy() throws ExecutionException, IllegalStateException, InterruptedException, TimeoutException {
        Integer num;
        if (this.zzg == null) {
            ...
            Integer num2 = null;
            try {
                num = measurementManagerFuturesZzo.getMeasurementApiStatusAsync().get(DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM, TimeUnit.MILLISECONDS);
                if (num != null) {
                    try {
                        if (num.intValue() == 1) {
                            z = true;
