...
public final /* data */ class Rect {
    ...
    /* compiled from: Rect.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R \u0010\u0005\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u0012\n\u0004\b\u0005\u0010\u0006\u0012\u0004\b\t\u0010\u0003\u001a\u0004\b\u0007\u0010\b¨\u0006\n"}, d2 = {"Landroidx/compose/ui/geometry/Rect$Companion;", "", "<init>", "()V", "Landroidx/compose/ui/geometry/Rect;", "Zero", "Landroidx/compose/ui/geometry/Rect;", "getZero", "()Landroidx/compose/ui/geometry/Rect;", "getZero$annotations", "ui-geometry_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public final long m861getSizeNHjbRc() {
    ...
    public final Rect m863translatek4lQ0M(long offset) {
        return new Rect(this.left + Offset.m842getXimpl(offset), this.top + Offset.m843getYimpl(offset), this.right + Offset.m842getXimpl(offset), this.bottom + Offset.m843getYimpl(offset));
    }
    ...
    public final long m862getTopLeftF1C5BW0() {
        return OffsetKt.Offset(this.left, this.top);
    }

    /* renamed from: getCenter-F1C5BW0, reason: not valid java name */
    public final long m860getCenterF1C5BW0() {
        return OffsetKt.Offset(this.left + (getWidth() / 2.0f), this.top + (getHeight() / 2.0f));
    }

    /* renamed from: getBottomRight-F1C5BW0, reason: not valid java name */
    public final long m859getBottomRightF1C5BW0() {
        return OffsetKt.Offset(this.right, this.bottom);
    }

    /* renamed from: contains-k-4lQ0M, reason: not valid java name */
    public final boolean m858containsk4lQ0M(long offset) {
        return Offset.m842getXimpl(offset) >= this.left && Offset.m842getXimpl(offset) < this.right && Offset.m843getYimpl(offset) >= this.top && Offset.m843getYimpl(offset) < this.bottom;
    }
