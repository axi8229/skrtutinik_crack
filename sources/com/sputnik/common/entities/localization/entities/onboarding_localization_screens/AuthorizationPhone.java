...
public final /* data */ class AuthorizationPhone implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<AuthorizationPhone> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final AuthorizationPhone createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return new AuthorizationPhone(parcel.readInt() == 0 ? null : TextWithParam.CREATOR.createFromParcel(parcel), parcel.readInt() != 0 ? TextWithParam.CREATOR.createFromParcel(parcel) : null);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final AuthorizationPhone[] newArray(int i) {
            return new AuthorizationPhone[i];
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AuthorizationPhone)) {
            return false;
        }
        AuthorizationPhone authorizationPhone = (AuthorizationPhone) other;
        return Intrinsics.areEqual(this.title, authorizationPhone.title) && Intrinsics.areEqual(this.numberInfo, authorizationPhone.numberInfo);
    }
    ...
    public String toString() {
        return "AuthorizationPhone(title=" + this.title + ", numberInfo=" + this.numberInfo + ")";
    }
    ...
    public AuthorizationPhone(TextWithParam textWithParam, TextWithParam textWithParam2) {
