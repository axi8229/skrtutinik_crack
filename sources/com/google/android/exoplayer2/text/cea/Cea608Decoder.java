...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = {193, 201, 211, 218, 220, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, 192, 194, pjsip_status_code.PJSIP_SC_EARLY_DIALOG_TERMINATED, 200, pjsip_status_code.PJSIP_SC_ACCEPTED, 203, 235, 206, 207, 239, 212, 217, 249, 219, 171, 187};
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = {195, 227, 205, pjsip_status_code.PJSIP_SC_NO_NOTIFICATION, 236, 210, 242, 213, 245, 123, 125, 92, 94, 95, 124, 126, 196, 228, 214, 246, 223, 165, 164, 9474, 197, 229, 216, 248, 9484, 9488, 9492, 9496};
    ...
    */
    ...
    private static final class CueBuilder {
        ...
        public Cue build(int forcedPositionAnchor) {
            ...
            return new Cue(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, i, 1, i2, f2, forcedPositionAnchor, -3.4028235E38f);
        }
