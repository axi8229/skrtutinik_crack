...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.api.login.impl.LoginEnterBusinessLogic$handleProgressState$2$2", f = "LoginEnterBusinessLogic.kt", l = {70}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class k extends SuspendLambda implements Function1<Continuation<? super LoginEnter.Action>, Object> {
    public int a;
    ...
    public k(LoginEnterBusinessLogic loginEnterBusinessLogic, Out.Builder<LoginEnter.State.Content, LoginEnter.Action> builder, Continuation<? super k> continuation) {
