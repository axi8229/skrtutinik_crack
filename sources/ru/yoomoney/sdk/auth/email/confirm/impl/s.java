...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.confirm.impl.EmailConfirmBusinessLogic$handleProgressState$6$1", f = "EmailConfirmBusinessLogic.kt", l = {250}, m = "invokeSuspend")
...
public final class s extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public s(EmailConfirmBusinessLogic emailConfirmBusinessLogic, EmailConfirm.Action action, Continuation<? super s> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            EmailConfirm.Effect.ShowNextStep showNextStep = new EmailConfirm.Effect.ShowNextStep(((EmailConfirm.Action.ForgotEmailSuccess) this.c).getProcess());
            this.a = 1;
