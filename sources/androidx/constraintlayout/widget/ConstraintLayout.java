...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget widget, BasicMeasure.Measure measure) {
            ...
            if (i7 == 1) {
                iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i3, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH);
            } else if (i7 == 2) {
                ...
                if (i8 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i8 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                    ...
                    if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z || ((z && z2) || (view instanceof Placeholder) || widget.isResolvedHorizontally())) {
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(widget.getWidth(), pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH);
                    }
                }
            }
            int i9 = iArr[dimensionBehaviour2.ordinal()];
            if (i9 == 1) {
                iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i4, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH);
            } else if (i9 == 2) {
                ...
                if (i10 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i10 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                    ...
                    if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z3 || ((z3 && z4) || (view instanceof Placeholder) || widget.isResolvedVertically())) {
                        iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(widget.getHeight(), pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH);
                    }
                }
            }
            ...
            if (i11 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i11 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z5 && widget.mMatchConstraintDefaultWidth == 0 && z6 && widget.mMatchConstraintDefaultHeight == 0) {
                ...
                if (measuredWidth != iMax || measuredHeight2 != measuredHeight) {
                    int iMakeMeasureSpec3 = measuredWidth != iMax ? View.MeasureSpec.makeMeasureSpec(iMax, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH) : i;
                    if (measuredHeight2 != measuredHeight) {
                        iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(measuredHeight, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH);
                    }
    ...
    protected void resolveMeasuredDimension(int widthMeasureSpec, int heightMeasureSpec, int measuredWidth, int measuredHeight, boolean isWidthMeasuredTooSmall, boolean isHeightMeasuredTooSmall) {
        ...
        int iResolveSizeAndState2 = View.resolveSizeAndState(measuredHeight + i, heightMeasureSpec, 0) & 16777215;
