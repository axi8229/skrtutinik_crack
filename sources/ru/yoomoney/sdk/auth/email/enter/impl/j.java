...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.enter.impl.EmailEnterBusinessLogic$handleLoadingState$1$1", f = "EmailEnterBusinessLogic.kt", l = {73}, m = "invokeSuspend")
...
public final class j extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public j(EmailEnterBusinessLogic emailEnterBusinessLogic, EmailEnter.Action action, Continuation<? super j> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            EmailEnter.Effect.ShowNextStep showNextStep = new EmailEnter.Effect.ShowNextStep(((EmailEnter.Action.SendEmailSuccess) this.c).getProcess());
            this.a = 1;
