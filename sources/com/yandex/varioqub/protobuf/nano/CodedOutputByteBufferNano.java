    ...
    private static void encodeDirect(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (cCharAt < 128) {
                ...
                byteBuffer.put((byte) ((cCharAt >>> '\f') | pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE));
    ...
    private static int encode(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i5 < length) {
            ...
            if (cCharAt2 < 128 && i6 < i4) {
                ...
                bArr[i6] = (byte) ((cCharAt2 >>> '\f') | pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE);
                int i10 = i6 + 2;
