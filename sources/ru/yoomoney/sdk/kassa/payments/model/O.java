...
public final class O implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel) {
        ...
        return new PaymentIdCscConfirmation(i, amountCreateFromParcel, aCreateFromParcel, string, string2, string3, string4, string5, string6, string7, enumC2333qValueOf, z, arrayList, parcel.readInt() != 0);
    }

    @Override // android.os.Parcelable.Creator
    public final Object[] newArray(int i) {
        return new PaymentIdCscConfirmation[i];
    }
}
