...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    protected abstract void mo2745reportSupertypeLoopError(KotlinType kotlinType);
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo2743getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo2743getSupertypes();
        if (listMo2743getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo2743getSupertypes;
    }
    ...
    private class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        protected void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo2745reportSupertypeLoopError(kotlinType);
        }
