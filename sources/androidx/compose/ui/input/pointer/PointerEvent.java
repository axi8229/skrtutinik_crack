...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m1322constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m1369constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m1323calculatePointerEventType7fucELk();
    }
    ...
    public final void m1326setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m1323calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
            ...
            if (actionMasked != 0) {
                if (actionMasked != 1) {
                    if (actionMasked != 2) {
                        ...
                        return PointerEventType.INSTANCE.m1334getPress7fucELk();
                    }
                    return PointerEventType.INSTANCE.m1333getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m1335getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m1334getPress7fucELk();
        }
