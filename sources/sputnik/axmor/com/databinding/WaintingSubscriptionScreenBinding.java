...
public final class WaintingSubscriptionScreenBinding implements ViewBinding {
    ...
    private WaintingSubscriptionScreenBinding(ScrollView scrollView, AppCompatButton appCompatButton, ProgressBar progressBar, TextView textView, TextView textView2) {
    ...
    public static WaintingSubscriptionScreenBinding bind(View view) {
        ...
        if (appCompatButton != null) {
            ...
            if (progressBar != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        return new WaintingSubscriptionScreenBinding((ScrollView) view, appCompatButton, progressBar, textView, textView2);
                    }
                }
            }
        }
