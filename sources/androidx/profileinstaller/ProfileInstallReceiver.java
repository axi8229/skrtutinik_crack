...
public class ProfileInstallReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) throws PackageManager.NameNotFoundException, IOException {
        ...
        if ("androidx.profileinstaller.action.INSTALL_PROFILE".equals(action)) {
            ProfileInstaller.writeProfile(context, new MeasurementManager$Api33Ext5Impl$$ExternalSyntheticLambda11(), new ResultDiagnostics(), true);
            return;
        }
        if ("androidx.profileinstaller.action.SKIP_FILE".equals(action)) {
            ...
            if (extras2 != null) {
                ...
                if ("WRITE_SKIP_FILE".equals(string)) {
                    ProfileInstaller.writeSkipFile(context, new MeasurementManager$Api33Ext5Impl$$ExternalSyntheticLambda11(), new ResultDiagnostics());
                    return;
                } else {
                    if ("DELETE_SKIP_FILE".equals(string)) {
                        ProfileInstaller.deleteSkipFile(context, new MeasurementManager$Api33Ext5Impl$$ExternalSyntheticLambda11(), new ResultDiagnostics());
                        return;
                    }
                    return;
                }
