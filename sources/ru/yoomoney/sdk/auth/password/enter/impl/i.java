...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.enter.impl.PasswordEnterBusinessLogic$handleProgressState$1$1", f = "PasswordEnterBusinessLogic.kt", l = {65}, m = "invokeSuspend")
...
public final class i extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public i(PasswordEnterBusinessLogic passwordEnterBusinessLogic, PasswordEnter.Action action, Continuation<? super i> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PasswordEnter.Effect.ShowNextStep showNextStep = new PasswordEnter.Effect.ShowNextStep(((PasswordEnter.Action.EnterPasswordSuccess) this.c).getProcess());
            this.a = 1;
