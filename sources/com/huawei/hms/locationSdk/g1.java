...
public class g1 extends n0<r, Void> {
    private f0 b;

    public g1(String str, String str2, f0 f0Var) {
    ...
    public void doExecute(r rVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<Void> taskCompletionSource) throws ApiException {
        try {
            HMSLocationLog.i("RequestActivityUpdatesTaskApiCall", ((n0) this).a, "request activity doExecute");
            ...
            HMSLocationLog.e("RequestActivityUpdatesTaskApiCall", ((n0) this).a, "request activity doExecute exception");
