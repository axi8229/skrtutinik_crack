...
public abstract class KeySerializer<KeyT extends Key, SerializationT extends Serialization> {
    ...
    public interface KeySerializationFunction<KeyT extends Key, SerializationT extends Serialization> {
        SerializationT serializeKey(KeyT key, SecretKeyAccess access) throws GeneralSecurityException;
    }

    public abstract SerializationT serializeKey(KeyT key, SecretKeyAccess access) throws GeneralSecurityException;
