...
import com.sputnik.common.entities.localization.entities.onboarding_localization_screens.AuthorizationTelegram;
...
public final class EnterTelegramCodeFragment extends Fragment {
    ...
    public final FragmentRegEnterTelegramCodeBinding getBinding() {
        return (FragmentRegEnterTelegramCodeBinding) this.binding.getValue2((Fragment) this, $$delegatedProperties[0]);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        viewModel.observeState(viewLifecycleOwner, new C07621(this));
        CallCodeViewModel viewModel2 = getViewModel();
        LifecycleOwner viewLifecycleOwner2 = getViewLifecycleOwner();
        Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner2, "getViewLifecycleOwner(...)");
        viewModel2.observeSubState(viewLifecycleOwner2, new Function1<CallCodeViewState, Event<? extends Boolean>>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment.onViewCreated.2
            @Override // kotlin.jvm.functions.Function1
            public final Event<Boolean> invoke(CallCodeViewState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return it.isLoaded();
            }
        }, new Function1<Event<? extends Boolean>, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment.onViewCreated.3
            {
                super(1);
            }
            ...
            public final void invoke2(Event<Boolean> it) {
                ...
                if (contentIfNotHandled != null) {
                    final EnterTelegramCodeFragment enterTelegramCodeFragment = EnterTelegramCodeFragment.this;
                    if (contentIfNotHandled.booleanValue()) {
                        enterTelegramCodeFragment.getProfileViewModel().delayRequest(500L, new Function0<Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$onViewCreated$3$1$1
                            {
                                super(0);
                            }
                            ...
                            public final void invoke2() {
                                IProfileViewModel.DefaultImpls.loadProfile$default(enterTelegramCodeFragment.getProfileViewModel(), false, 1, null);
                            }
                        });
                    }
                }
        ...
        viewModel4.observeNotifications(viewLifecycleOwner4, new Function1<Notify, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment.onViewCreated.6
            {
                super(1);
            }
            ...
            public final void invoke2(Notify it) {
                Intrinsics.checkNotNullParameter(it, "it");
                EnterTelegramCodeFragment enterTelegramCodeFragment = EnterTelegramCodeFragment.this;
                NestedScrollView root = enterTelegramCodeFragment.getBinding().getRoot();
                Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
                ViewKt.renderNotifications(enterTelegramCodeFragment, root, it);
            }
        });
        ...
        loginViewModel2.observeNotifications(viewLifecycleOwner6, new Function1<Notify, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment.onViewCreated.8
            {
                super(1);
            }
        ...
        profileViewModel.observeSubState(viewLifecycleOwner7, new Function1<ProfileViewState, Event<? extends ProfileNavigationState>>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment.onViewCreated.9
            @Override // kotlin.jvm.functions.Function1
            public final Event<ProfileNavigationState> invoke(ProfileViewState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return it.getProfileState();
            }
        }, new Function1<Event<? extends ProfileNavigationState>, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment.onViewCreated.10
            {
                super(1);
            }
            ...
            public final void invoke2(Event<? extends ProfileNavigationState> it) throws Resources.NotFoundException {
                ...
                if (contentIfNotHandled != null) {
                    EnterTelegramCodeFragment enterTelegramCodeFragment = EnterTelegramCodeFragment.this;
                    enterTelegramCodeFragment.getLoginViewModel().clearToRequestCode();
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToRegistrationState) {
                        PinView viewPin = enterTelegramCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin, "viewPin");
                        ViewKt.hideKeyboard(viewPin);
                        enterTelegramCodeFragment.getAnalytics().trackLogEvent(new AnalyticsTracker.Event("account_state", "unregistered", null, 4, null));
                        NavControllerKt.safeNavigate$default(FragmentKt.findNavController(enterTelegramCodeFragment), R$id.action_enterTelegramCodeFragment_to_enterNameFragment, null, null, 6, null);
                        return;
                    }
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToVerifyAddressState) {
                        PinView viewPin2 = enterTelegramCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin2, "viewPin");
                        ViewKt.hideKeyboard(viewPin2);
                        NavControllerKt.safeNavigate$default(FragmentKt.findNavController(enterTelegramCodeFragment), R$id.action_enterTelegramCodeFragment_to_confirmAddressFragment, null, null, 6, null);
                        return;
                    }
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToEnterFlatNumberState) {
                        PinView viewPin3 = enterTelegramCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin3, "viewPin");
                        ViewKt.hideKeyboard(viewPin3);
                        NavControllerKt.safeNavigate$default(FragmentKt.findNavController(enterTelegramCodeFragment), R$id.action_enterTelegramCodeFragment_to_enterFlatNumberFragment, null, null, 6, null);
                        return;
                    }
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToIntercomState) {
                        PinView viewPin4 = enterTelegramCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin4, "viewPin");
                        ViewKt.hideKeyboard(viewPin4);
                        NavControllerKt.safeNavigate$default(FragmentKt.findNavController(enterTelegramCodeFragment), R$id.action_enterTelegramCodeFragment_to_connectToIntercomFragment, null, null, 6, null);
                        return;
                    }
                    if (contentIfNotHandled instanceof ProfileNavigationState.ToActivatedState) {
                        PinView viewPin5 = enterTelegramCodeFragment.getBinding().viewPin;
                        Intrinsics.checkNotNullExpressionValue(viewPin5, "viewPin");
                        ViewKt.hideKeyboard(viewPin5);
                        Uri uri = Uri.parse(enterTelegramCodeFragment.getString(R$string.deeplink_main));
                        enterTelegramCodeFragment.getCamerasViewModel().setNeedLoadCameras(true);
                        FragmentKt.findNavController(enterTelegramCodeFragment).popBackStack(R$id.selectAccountFragment, true);
                        NavController navControllerFindNavController = FragmentKt.findNavController(enterTelegramCodeFragment);
    ...
    /* compiled from: EnterTelegramCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$onViewCreated$1, reason: invalid class name and case insensitive filesystem */
    /* synthetic */ class C07621 extends FunctionReferenceImpl implements Function1<CallCodeViewState, Unit> {
        C07621(Object obj) {
            super(1, obj, EnterTelegramCodeFragment.class, "renderUi", "renderUi(Lcom/sputnik/common/viewmodels/CallCodeViewState;)V", 0);
        }
        ...
        public final void invoke2(CallCodeViewState p0) {
            ...
            ((EnterTelegramCodeFragment) this.receiver).renderUi(p0);
        }
    }

    /* compiled from: EnterTelegramCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$onViewCreated$4, reason: invalid class name */
    ...
    /* compiled from: EnterTelegramCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$onViewCreated$5, reason: invalid class name */
    /* synthetic */ class AnonymousClass5 extends FunctionReferenceImpl implements Function1<ErrorContainer, Unit> {
        AnonymousClass5(Object obj) {
            super(1, obj, EnterTelegramCodeFragment.class, "renderError", "renderError(Lcom/sputnik/common/viewmodels/ErrorContainer;)V", 0);
        }
        ...
        public final void invoke2(ErrorContainer p0) {
            Intrinsics.checkNotNullParameter(p0, "p0");
            ((EnterTelegramCodeFragment) this.receiver).renderError(p0);
        }
    }

    /* compiled from: EnterTelegramCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$onViewCreated$7, reason: invalid class name */
    /* synthetic */ class AnonymousClass7 extends FunctionReferenceImpl implements Function1<LoginViewState, Unit> {
        AnonymousClass7(Object obj) {
            super(1, obj, EnterTelegramCodeFragment.class, "renderLogin", "renderLogin(Lcom/sputnik/common/viewmodels/LoginViewState;)V", 0);
        }
        ...
        public final void invoke2(LoginViewState p0) {
            Intrinsics.checkNotNullParameter(p0, "p0");
            ((EnterTelegramCodeFragment) this.receiver).renderLogin(p0);
        }
    }

    public EnterTelegramCodeFragment() {
        super(R$layout.fragment_reg_enter_telegram_code);
        this.binding = new ViewBindingFragmentDelegate(this, EnterTelegramCodeFragment$binding$2.INSTANCE);
        this.locale = LazyKt.lazy(new Function0<AuthorizationLimitExceededBody>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$locale$2
            {
                super(0);
            }
        ...
        this.localeForTimer = LazyKt.lazy(new Function0<String>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$localeForTimer$2
            {
                super(0);
            }
        ...
        this.phone = LazyKt.lazy(new Function0<String>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$phone$2
            {
                super(0);
            }
        ...
        this.prettyPhone = LazyKt.lazy(new Function0<String>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$prettyPhone$2
            {
                super(0);
            }
        ...
        this.profileViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(ProfileViewModel.class), new Function0<ViewModelStore>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$activityViewModels$default$1
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$activityViewModels$default$2
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$profileViewModel$2
            {
                super(0);
            }
        ...
        Function0<ViewModelProvider.Factory> function02 = new Function0<ViewModelProvider.Factory>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$viewModel$2
            {
                super(0);
            }
        ...
        final Function0<Fragment> function03 = new Function0<Fragment>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$viewModels$default$1
            {
                super(0);
            }
        ...
        final Lazy lazy = LazyKt.lazy(LazyThreadSafetyMode.NONE, new Function0<ViewModelStoreOwner>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$viewModels$default$2
            {
                super(0);
            }
        ...
        this.viewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(CallCodeViewModel.class), new Function0<ViewModelStore>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$viewModels$default$3
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$viewModels$default$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        this.camerasViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(AllCamerasViewModel.class), new Function0<ViewModelStore>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$activityViewModels$default$4
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$activityViewModels$default$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$camerasViewModel$2
            {
                super(0);
            }
        ...
        this.loginViewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(LoginViewModel.class), new Function0<ViewModelStore>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$activityViewModels$default$7
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$special$$inlined$activityViewModels$default$8
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$loginViewModel$2
            {
                super(0);
            }
    ...
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$showCodeExpiredError$2, reason: invalid class name and case insensitive filesystem */
    static final class C07642 extends Lambda implements Function2<AlertDialog, DialogErrorSplashBinding, Unit> {
        C07642() {
            super(2);
        }
        ...
        public final void invoke2(final AlertDialog dialog, DialogErrorSplashBinding view) {
            ...
            Intrinsics.checkNotNullParameter(view, "view");
            final EnterTelegramCodeFragment enterTelegramCodeFragment = EnterTelegramCodeFragment.this;
            LocalizationLocalModel data = enterTelegramCodeFragment.getLocalizationScreen().getData();
            ...
            view.btnRepeat.setOnClickListener(new View.OnClickListener() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$showCodeExpiredError$2$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    EnterTelegramCodeFragment.C07642.invoke$lambda$2$lambda$1(dialog, enterTelegramCodeFragment, view2);
                }
            });
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void invoke$lambda$2$lambda$1(AlertDialog dialog, EnterTelegramCodeFragment this$0, View view) {
            Intrinsics.checkNotNullParameter(dialog, "$dialog");
    ...
    /* compiled from: EnterTelegramCodeFragment.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$showCodeExpiredError$1, reason: invalid class name and case insensitive filesystem */
    /* synthetic */ class C07631 extends FunctionReferenceImpl implements Function3<LayoutInflater, ViewGroup, Boolean, DialogErrorSplashBinding> {
    ...
    private final void showCodeExpiredError() {
        ...
        companion.newInstance(contextRequireContext, C07631.INSTANCE, new C07642());
    }
    ...
    public final void renderUi(CallCodeViewState data) {
        FragmentRegEnterTelegramCodeBinding binding = getBinding();
    ...
    private final void initPhone(String phone) {
        AuthorizationBody authorizationCode;
        AuthorizationTelegram telegram;
        Integer countryCode;
        String string;
        Log.e("phone", phone);
        Context contextRequireContext = requireContext();
        ...
        LocalizationLocalModel data = getLocalizationScreen().getData();
        if (data == null || (authorizationCode = data.getAuthorizationCode()) == null || (telegram = authorizationCode.getTelegram()) == null) {
            return;
        }
        TextWithParam numberInfo = telegram.getNumberInfo();
        ...
        TextWithParam numberInfo2 = telegram.getNumberInfo();
        ...
        TextWithParam numberInfo3 = telegram.getNumberInfo();
        ...
        TextWithParam numberInfo4 = telegram.getNumberInfo();
        SpansKt.addClickableSpan(spannableString, String.valueOf(numberInfo4 != null ? numberInfo4.getParam() : null), new Function1<View, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$initPhone$1$str$1$1
            {
                super(1);
            }
    ...
    private final void initView() {
        ...
        TextView btnLoginBySms = getBinding().btnLoginBySms;
        Intrinsics.checkNotNullExpressionValue(btnLoginBySms, "btnLoginBySms");
        SafeClickListenerKt.setSafeOnClickListener$default(btnLoginBySms, 0L, new Function1<View, Unit>() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment.initView.1
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                Intrinsics.checkNotNullParameter(it, "it");
                ApplyRegistration applyRegistration = EnterTelegramCodeFragment.this.getLoginViewModel().getCurrentState().getApplyRegistration();
                if (!(applyRegistration != null ? Intrinsics.areEqual(applyRegistration.getShowHelpOnFail(), Boolean.TRUE) : false)) {
                    TextView btnLoginBySms2 = EnterTelegramCodeFragment.this.getBinding().btnLoginBySms;
                    Intrinsics.checkNotNullExpressionValue(btnLoginBySms2, "btnLoginBySms");
                    ButtonsExtensionsKt.showProgress(btnLoginBySms2, ContextCompat.getColor(EnterTelegramCodeFragment.this.requireContext(), R$color.sputnik_blue));
                    EnterTelegramCodeFragment.this.getLoginViewModel().handleDataNew(EnterTelegramCodeFragment.this.getPhone(), EnterTelegramCodeFragment.this.getPrettyPhone());
                    TextView tvAboutCode = EnterTelegramCodeFragment.this.getBinding().tvAboutCode;
                    Intrinsics.checkNotNullExpressionValue(tvAboutCode, "tvAboutCode");
                    ViewKt.gone(tvAboutCode);
                    TextView btnLoginBySms3 = EnterTelegramCodeFragment.this.getBinding().btnLoginBySms;
                    Intrinsics.checkNotNullExpressionValue(btnLoginBySms3, "btnLoginBySms");
                    ViewKt.gone(btnLoginBySms3);
                    ProgressBar pbRequestSms = EnterTelegramCodeFragment.this.getBinding().pbRequestSms;
                    Intrinsics.checkNotNullExpressionValue(pbRequestSms, "pbRequestSms");
                    ViewKt.visible(pbRequestSms);
                    return;
                }
                NavControllerKt.safeNavigate$default(FragmentKt.findNavController(EnterTelegramCodeFragment.this), R$id.action_to_needHelpFragment, BundleKt.bundleOf(TuplesKt.to("phone", EnterTelegramCodeFragment.this.getPhone()), TuplesKt.to("pretty_phone", EnterTelegramCodeFragment.this.getPrettyPhone())), null, 4, null);
            }
        }, 1, null);
    ...
    private final void setUpCodeField() {
        PinView pinView = getBinding().viewPin;
        pinView.addTextChangedListener(new TextWatcher() { // from class: com.sputnik.oboarding.ui.registration.EnterTelegramCodeFragment$setUpCodeField$1$1
    ...
    private final void localize() {
        ...
        AuthorizationTelegram telegram = authorizationCode.getTelegram();
        String changeMethodButton = null;
        String strValueOf = String.valueOf((telegram == null || (title2 = telegram.getTitle()) == null) ? null : title2.getText());
        AuthorizationTelegram telegram2 = authorizationCode.getTelegram();
        binding.tvTitle.setText(ViewUtilsKt.highlightText(strValueOf, String.valueOf((telegram2 == null || (title = telegram2.getTitle()) == null) ? null : title.getParam()), ContextCompat.getColor(requireContext(), R$color.sputnik_pink)));
        binding.tvErrorCode.setText(String.valueOf(authorizationCode.getError()));
        TextView textView = binding.btnLoginBySms;
        LocalizationLocalModel data2 = getLocalizationScreen().getData();
        if (data2 != null && (authorizationCode2 = data2.getAuthorizationCode()) != null) {
            changeMethodButton = authorizationCode2.getChangeMethodButton();
        }
        textView.setText(String.valueOf(changeMethodButton));
    }
}
