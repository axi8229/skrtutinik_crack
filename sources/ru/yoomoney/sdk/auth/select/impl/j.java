...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.select.impl.SelectAccountBusinessLogic$handleContentState$8$1", f = "SelectAccountBusinessLogic.kt", l = {74}, m = "invokeSuspend")
...
public final class j extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public j(SelectAccountBusinessLogic selectAccountBusinessLogic, SelectAccount.Action action, Continuation<? super j> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            SelectAccount.Effect.ShowFailure showFailure = new SelectAccount.Effect.ShowFailure(((SelectAccount.Action.ShowFailure) this.c).getFailure());
            this.a = 1;
