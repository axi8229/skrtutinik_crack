...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.confirm.impl.PhoneConfirmBusinessLogic$processStateProgressAction$1$1", f = "PhoneConfirmBusinessLogic.kt", l = {99}, m = "invokeSuspend")
...
public final class m extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public m(PhoneConfirmBusinessLogic phoneConfirmBusinessLogic, PhoneConfirm.Action action, Continuation<? super m> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneConfirm.Effect.ShowNextStep showNextStep = new PhoneConfirm.Effect.ShowNextStep(((PhoneConfirm.Action.ConfirmPhoneSuccess) this.c).getProcess());
            this.a = 1;
