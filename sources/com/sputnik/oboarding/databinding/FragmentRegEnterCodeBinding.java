...
public final class FragmentRegEnterCodeBinding implements ViewBinding {
    ...
    private FragmentRegEnterCodeBinding(NestedScrollView nestedScrollView, TextView textView, CardView cardView, LinearLayout linearLayout, ProgressBar progressBar, FrameLayout frameLayout, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, PinView pinView) {
    ...
    public static FragmentRegEnterCodeBinding bind(View view) {
                                    ...
                                    if (textView4 != null) {
                                        ...
                                        if (textView5 != null) {
                                            ...
                                            if (textView6 != null) {
                                                ...
                                                if (pinView != null) {
                                                    return new FragmentRegEnterCodeBinding((NestedScrollView) view, textView, cardView, linearLayout, progressBar, frameLayout, textView2, textView3, textView4, textView5, textView6, pinView);
                                                }
                                            }
                                        }
                                    }
