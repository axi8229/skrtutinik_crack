...
public final class LayoutNodeLayoutDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            this.this$0.getOuterCoordinator().mo1420measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    ...
    public final Constraints m1496getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m1503getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m1497getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        public MeasurePassDelegate() {
            ...
            this.lastPosition = companion.m2145getZeronOccac();
            ...
            this.placeOuterCoordinatorPosition = companion.m2145getZeronOccac();
            this.placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinatorBlock$1
                ...
                public final void invoke2() {
                    ...
                    if (graphicsLayer != null) {
                        placementScope2.m1455placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, graphicsLayer, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else if (function1 == null) {
                        placementScope2.m1450place70tqf50(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else {
                        placementScope2.m1454placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex, function1);
                    }
                }
            };
        }
        ...
        /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
        public final Constraints m1503getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m2073boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo1420measureBRTryo0(long constraints) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                lookaheadPassDelegate.mo1420measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m1504remeasureBRTryo0(constraints);
            return this;
        }

        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m1504remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m2078equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            long jMo1422getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo1422getSizeYbymL2g();
            m1443setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m1495performMeasureBRTryo0(constraints);
            if (IntSize.m2154equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo1422getSizeYbymL2g(), jMo1422getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m1442setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        public void mo1421placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m1502placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        public void mo1441placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m1502placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        private final void m1502placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            Placeable.PlacementScope placementScope;
            this.isPlacedByParent = true;
            if (!IntOffset.m2137equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate, IntOffset.m2138getXimpl(position), IntOffset.m2139getYimpl(position), 0.0f, 4, null);
            }
            ...
            m1501placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
        }

        /* renamed from: placeOuterCoordinator-MLgxB_4, reason: not valid java name */
        private final void m1501placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLayoutPending() && getIsPlaced()) {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m1544placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
        ...
        public final void replace() {
            ...
            try {
                ...
                boolean isPlaced = getIsPlaced();
                m1501placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m1479remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        private int placeOrder = Integer.MAX_VALUE;
        private LayoutNode.UsageByParent measuredByParent = LayoutNode.UsageByParent.NotUsed;
        private long lastPosition = IntOffset.INSTANCE.m2145getZeronOccac();
        ...
        */
        public androidx.compose.ui.layout.Placeable mo1420measureBRTryo0(long r4) {
            /*
                r3 = this;
            ...
            L51:
                r3.m1500remeasureBRTryo0(r4)
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.mo1420measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
        }
        ...
        public final boolean m1500remeasureBRTryo0(long constraints) {
            ...
            this.lookaheadConstraints = Constraints.m2073boximpl(constraints);
            m1443setMeasurementConstraintsBRTryo0(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            LayoutNodeLayoutDelegate.this.m1494performLookaheadMeasureBRTryo0(constraints);
            m1442setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m2156getWidthimpl(jIntSize) == lookaheadDelegate.getWidth() && IntSize.m2155getHeightimpl(jIntSize) == lookaheadDelegate.getHeight()) ? false : true;
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo1421placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m1498placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo1441placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m1498placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
        private final void m1498placeSelfMLgxB_4(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
                InlineClassHelperKt.throwIllegalArgumentException("place is called on a deactivated node");
            }
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            this.onNodePlacedCalled = false;
            if (!IntOffset.m2137equalsimpl0(position, this.lastPosition)) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() && getIsPlaced()) {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m1510placeSelfApparentToRealOffsetgyyYBs$ui_release(position);
                onNodePlaced$ui_release();
            } else {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeSelf$2
                    ...
                    public final void invoke2() {
                        ...
                        Placeable.PlacementScope.m1444place70tqf50$default(placementScope, lookaheadDelegate3, j, 0.0f, 2, null);
                    }
                }, 2, null);
            }
            this.lastPosition = position;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        LookaheadPassDelegate lookaheadPassDelegate = layoutNode2.getLayoutDelegate().getLookaheadPassDelegate();
                        Intrinsics.checkNotNull(lookaheadPassDelegate);
                        Constraints constraintsM1497getLastLookaheadConstraintsDWUhwKw = layoutNode2.getLayoutDelegate().m1497getLastLookaheadConstraintsDWUhwKw();
                        Intrinsics.checkNotNull(constraintsM1497getLastLookaheadConstraintsDWUhwKw);
                        if (lookaheadPassDelegate.m1500remeasureBRTryo0(constraintsM1497getLastLookaheadConstraintsDWUhwKw.getValue())) {
        ...
        public final void replace() {
            ...
            try {
                ...
                this.onNodePlacedCalled = false;
                boolean isPlaced = getIsPlaced();
                m1498placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
                if (isPlaced && !this.onNodePlacedCalled && (parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release()) != null) {
                    LayoutNode.requestLookaheadRelayout$ui_release$default(parent$ui_release, false, 1, null);
                }
                this.relayoutWithoutParentInProgress = false;
    ...
    public final void m1495performMeasureBRTryo0(long constraints) {
    ...
    public final void m1494performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo1420measureBRTryo0(constraints);
            }
        }, 2, null);
