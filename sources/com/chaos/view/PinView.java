...
public class PinView extends AppCompatEditText {
    ...
    public PinView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, R$styleable.PinView, i, 0);
        this.mViewType = typedArrayObtainStyledAttributes.getInt(R$styleable.PinView_viewType, 0);
        this.mPinItemCount = typedArrayObtainStyledAttributes.getInt(R$styleable.PinView_itemCount, 4);
        int i2 = R$styleable.PinView_itemHeight;
        int i3 = R$dimen.pv_pin_view_item_size;
        this.mPinItemHeight = (int) typedArrayObtainStyledAttributes.getDimension(i2, resources.getDimensionPixelSize(i3));
        this.mPinItemWidth = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.PinView_itemWidth, resources.getDimensionPixelSize(i3));
        this.mPinItemSpacing = typedArrayObtainStyledAttributes.getDimensionPixelSize(R$styleable.PinView_itemSpacing, resources.getDimensionPixelSize(R$dimen.pv_pin_view_item_spacing));
        this.mPinItemRadius = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.PinView_itemRadius, 0.0f);
        this.mLineWidth = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.PinView_lineWidth, resources.getDimensionPixelSize(R$dimen.pv_pin_view_item_line_width));
        this.mLineColor = typedArrayObtainStyledAttributes.getColorStateList(R$styleable.PinView_lineColor);
        this.isCursorVisible = typedArrayObtainStyledAttributes.getBoolean(R$styleable.PinView_android_cursorVisible, true);
        this.mCursorColor = typedArrayObtainStyledAttributes.getColor(R$styleable.PinView_cursorColor, getCurrentTextColor());
        this.mCursorWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(R$styleable.PinView_cursorWidth, resources.getDimensionPixelSize(R$dimen.pv_pin_view_cursor_width));
        this.mItemBackground = typedArrayObtainStyledAttributes.getDrawable(R$styleable.PinView_android_itemBackground);
        this.mHideLineWhenFilled = typedArrayObtainStyledAttributes.getBoolean(R$styleable.PinView_hideLineWhenFilled, false);
    ...
    private void setupAnimator() {
        ...
        this.mDefaultAddAnimator = valueAnimatorOfFloat;
        ...
        this.mDefaultAddAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.chaos.view.PinView.1
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                PinView.this.mAnimatorTextPaint.setTextSize(PinView.this.getTextSize() * fFloatValue);
                PinView.this.mAnimatorTextPaint.setAlpha((int) (255.0f * fFloatValue));
    ...
    private void drawTextAtBox(Canvas canvas, Paint paint, CharSequence charSequence, int i) {
        ...
        float f = pointF.x;
        float f2 = pointF.y;
        float fAbs = f - (Math.abs(this.mTextRect.width()) / 2.0f);
        Rect rect = this.mTextRect;
        canvas.drawText(charSequence, i, i2, fAbs - rect.left, (f2 + (Math.abs(rect.height()) / 2.0f)) - this.mTextRect.bottom, paint);
    }
    ...
    private void updateCenterPoint() {
        ...
        RectF rectF2 = this.mItemBorderRect;
        this.mItemCenterPoint.set(fAbs, rectF2.top + (Math.abs(rectF2.height()) / 2.0f));
    }
    ...
    public void setItemBackgroundResources(int i) throws Resources.NotFoundException {
    ...
    private void updateCursorHeight() {
        float fDpToPx = dpToPx(2.0f) * 2;
        this.mCursorHeight = ((float) this.mPinItemHeight) - getTextSize() > fDpToPx ? getTextSize() + fDpToPx : getTextSize();
    }
