...
public class TextLayer extends BaseLayer {
    ...
    private void configurePaint(DocumentData documentData, int i) {
        ...
        int iIntValue = ((((this.transform.getOpacity() == null ? 100 : this.transform.getOpacity().getValue().intValue()) * KotlinVersion.MAX_COMPONENT_VALUE) / 100) * i) / KotlinVersion.MAX_COMPONENT_VALUE;
