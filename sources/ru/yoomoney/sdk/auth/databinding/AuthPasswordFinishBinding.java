...
public final class AuthPasswordFinishBinding implements ViewBinding {
    ...
    private AuthPasswordFinishBinding(ConstraintLayout constraintLayout, TopBarDefault topBarDefault, PrimaryButtonView primaryButtonView, EmptyStateLargeView emptyStateLargeView, ConstraintLayout constraintLayout2) {
    ...
    public static AuthPasswordFinishBinding bind(View view) {
        int i = R.id.appBar;
    ...
    public static AuthPasswordFinishBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AuthPasswordFinishBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.auth_password_finish, viewGroup, false);
        if (z) {
