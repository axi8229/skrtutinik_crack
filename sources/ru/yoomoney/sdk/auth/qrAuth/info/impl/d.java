...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.qrAuth.info.impl.QrAuthInfoBusinessLogic$handStateContent$3$1", f = "QrAuthInfoBusinessLogic.kt", l = {77}, m = "invokeSuspend")
...
public final class d extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public d(QrAuthInfoBusinessLogic qrAuthInfoBusinessLogic, Continuation<? super d> continuation) {
