...
public final class UIntDeserializer extends StdDeserializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        return UInt.m2659boximpl(m2313deserializexfHcF5w(jsonParser, deserializationContext));
    }

    /* renamed from: deserialize-xfHcF5w, reason: not valid java name */
    public int m2313deserializexfHcF5w(JsonParser p, DeserializationContext ctxt) throws InputCoercionException {
        Intrinsics.checkNotNullParameter(p, "p");
        Intrinsics.checkNotNullParameter(ctxt, "ctxt");
        UInt uIntAsUInt = UnsignedNumbersKt.asUInt(p.getLongValue());
        if (uIntAsUInt != null) {
            return uIntAsUInt.getData();
        }
