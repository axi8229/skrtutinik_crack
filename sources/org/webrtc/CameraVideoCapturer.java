        ...
        public CameraStatistics(SurfaceTextureHelper surfaceTextureHelper, CameraEventsHandler cameraEventsHandler) {
            Runnable runnable = new Runnable() { // from class: org.webrtc.CameraVideoCapturer.CameraStatistics.1
                ...
                public void run() {
                    ...
                    CameraStatistics.this.surfaceTextureHelper.getHandler().postDelayed(this, YooProfilerImpl.TIMER_LIMIT);
                }
            };
            ...
            surfaceTextureHelper.getHandler().postDelayed(runnable, YooProfilerImpl.TIMER_LIMIT);
        }
