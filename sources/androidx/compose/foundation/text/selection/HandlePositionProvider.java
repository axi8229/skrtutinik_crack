...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m854getZeroF1C5BW0();
    ...
    public long mo198calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long jMo409provideF1C5BW0 = this.positionProvider.mo409provideF1C5BW0();
        if (!OffsetKt.m856isSpecifiedk4lQ0M(jMo409provideF1C5BW0)) {
            jMo409provideF1C5BW0 = this.prevPosition;
        }
        this.prevPosition = jMo409provideF1C5BW0;
        return IntOffset.m2142plusqkQi6aY(IntOffset.m2142plusqkQi6aY(anchorBounds.m2149getTopLeftnOccac(), IntOffsetKt.m2148roundk4lQ0M(jMo409provideF1C5BW0)), this.handleReferencePoint.mo752alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m2160getZeroYbymL2g(), layoutDirection));
    }
}
