...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.finishing.success.impl.AuthFinishingSuccessBusinessLogic$handleProgressState$7$1", f = "AuthFinishingSuccessBusinessLogic.kt", l = {65}, m = "invokeSuspend")
...
public final class m extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public m(AuthFinishingSuccessBusinessLogic authFinishingSuccessBusinessLogic, AuthFinishingSuccess.Action action, Continuation<? super m> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AuthFinishingSuccess.Effect.ShowNextStep showNextStep = new AuthFinishingSuccess.Effect.ShowNextStep(((AuthFinishingSuccess.Action.NextStep) this.c).getProcess());
            this.a = 1;
