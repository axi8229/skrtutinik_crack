...
public class TechnicalSupportFragmentArgs {
    ...
    public static final class Builder {
        ...
        public Builder(TechnicalSupportFragmentArgs technicalSupportFragmentArgs) {
            HashMap map = new HashMap();
            this.arguments = map;
            map.putAll(technicalSupportFragmentArgs.arguments);
        }
    }
    ...
    public static TechnicalSupportFragmentArgs fromBundle(Bundle bundle) {
        ...
        if (!a.a(TechnicalSupportFragmentArgs.class, bundle, FFmpegMediaMetadataRetriever.METADATA_KEY_TITLE)) {
        ...
        technicalSupportFragmentArgs.arguments.put(FFmpegMediaMetadataRetriever.METADATA_KEY_TITLE, string);
    ...
    public static TechnicalSupportFragmentArgs fromSavedStateHandle(SavedStateHandle savedStateHandle) {
        TechnicalSupportFragmentArgs technicalSupportFragmentArgs = new TechnicalSupportFragmentArgs();
        ...
        technicalSupportFragmentArgs.arguments.put(FFmpegMediaMetadataRetriever.METADATA_KEY_TITLE, str);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.arguments.containsKey(FFmpegMediaMetadataRetriever.METADATA_KEY_TITLE) != technicalSupportFragmentArgs.arguments.containsKey(FFmpegMediaMetadataRetriever.METADATA_KEY_TITLE)) {
            return false;
        }
    ...
    private TechnicalSupportFragmentArgs(HashMap map) {
