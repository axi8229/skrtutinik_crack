    ...
    */
    static androidx.core.provider.FontsContractCompat.FontInfo[] query(android.content.Context r16, androidx.core.provider.FontRequest r17, java.lang.String r18, android.os.CancellationSignal r19) {
        /*
            ...
            r3 = r16
            androidx.core.provider.FontProvider$ContentQueryWrapper r3 = androidx.core.provider.FontProvider.ContentQueryWrapper.make(r3, r2)
            r11 = 0
            ...
            java.lang.String[] r6 = new java.lang.String[]{r4, r5, r6, r7, r8, r9, r10}     // Catch: java.lang.Throwable -> L9f
            java.lang.String r7 = "query = ?"
            java.lang.String r4 = r17.getQuery()     // Catch: java.lang.Throwable -> L9f
            java.lang.String[] r8 = new java.lang.String[]{r4}     // Catch: java.lang.Throwable -> L9f
            r9 = 0
            r4 = r3
            r5 = r2
            r10 = r19
            android.database.Cursor r11 = r4.query(r5, r6, r7, r8, r9, r10)     // Catch: java.lang.Throwable -> L9f
            if (r11 == 0) goto Le0
            int r5 = r11.getCount()     // Catch: java.lang.Throwable -> L9f
            if (r5 <= 0) goto Le0
            ...
            int r6 = r11.getColumnIndex(r6)     // Catch: java.lang.Throwable -> L9f
            java.lang.String r7 = "file_id"
            int r7 = r11.getColumnIndex(r7)     // Catch: java.lang.Throwable -> L9f
            java.lang.String r8 = "font_ttc_index"
            int r8 = r11.getColumnIndex(r8)     // Catch: java.lang.Throwable -> L9f
            java.lang.String r9 = "font_weight"
            int r9 = r11.getColumnIndex(r9)     // Catch: java.lang.Throwable -> L9f
            java.lang.String r10 = "font_italic"
            int r10 = r11.getColumnIndex(r10)     // Catch: java.lang.Throwable -> L9f
        L91:
            boolean r12 = r11.moveToNext()     // Catch: java.lang.Throwable -> L9f
            if (r12 == 0) goto Ldf
            r12 = -1
            if (r1 == r12) goto La1
            int r13 = r11.getInt(r1)     // Catch: java.lang.Throwable -> L9f
            goto La2
        L9f:
            r0 = move-exception
            goto Lf2
        ...
        La2:
            if (r8 == r12) goto La9
            int r14 = r11.getInt(r8)     // Catch: java.lang.Throwable -> L9f
            goto Laa
        La9:
            r14 = 0
        Laa:
            if (r7 != r12) goto Lb7
            r17 = r5
            long r4 = r11.getLong(r6)     // Catch: java.lang.Throwable -> L9f
            android.net.Uri r4 = android.content.ContentUris.withAppendedId(r2, r4)     // Catch: java.lang.Throwable -> L9f
            goto Lc1
        Lb7:
            r17 = r5
            long r4 = r11.getLong(r7)     // Catch: java.lang.Throwable -> L9f
            android.net.Uri r4 = android.content.ContentUris.withAppendedId(r0, r4)     // Catch: java.lang.Throwable -> L9f
        Lc1:
            if (r9 == r12) goto Lc8
            int r5 = r11.getInt(r9)     // Catch: java.lang.Throwable -> L9f
            goto Lca
        Lc8:
            r5 = 400(0x190, float:5.6E-43)
        Lca:
            if (r10 == r12) goto Ld4
            int r12 = r11.getInt(r10)     // Catch: java.lang.Throwable -> L9f
            r15 = 1
            if (r12 != r15) goto Ld4
            goto Ld5
        Ld4:
            r15 = 0
        Ld5:
            androidx.core.provider.FontsContractCompat$FontInfo r4 = androidx.core.provider.FontsContractCompat.FontInfo.create(r4, r14, r5, r15, r13)     // Catch: java.lang.Throwable -> L9f
            r5 = r17
