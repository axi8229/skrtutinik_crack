...
public class SimpleAeadCipher {
    ...
    public Cipher getInitialisedCipher(Key key, byte[] bArr, int i, String str) throws InvalidKeyException, JoseException, InvalidAlgorithmParameterException {
    ...
    public CipherOutput encrypt(Key key, byte[] bArr, byte[] bArr2, byte[] bArr3, String str) throws BadPaddingException, IllegalBlockSizeException, InvalidKeyException, JoseException, InvalidAlgorithmParameterException {
