...
public final class AuthPhoneSelectBinding implements ViewBinding {
    ...
    public final FormSelectView select;
    public final TextTitle1View title;

    private AuthPhoneSelectBinding(ConstraintLayout constraintLayout, PrimaryButtonView primaryButtonView, TopBarDefault topBarDefault, TextBodyView textBodyView, TextCaption1View textCaption1View, ConstraintLayout constraintLayout2, FormSelectView formSelectView, TextTitle1View textTitle1View) {
        ...
        this.select = formSelectView;
        this.title = textTitle1View;
    }

    public static AuthPhoneSelectBinding bind(View view) {
        int i = R.id.action;
                    ...
                    if (textCaption1View != null) {
                        ...
                        if (formSelectView != null) {
                            ...
                            if (textTitle1View != null) {
                                return new AuthPhoneSelectBinding(constraintLayout, primaryButtonView, topBarDefault, textBodyView, textCaption1View, constraintLayout, formSelectView, textTitle1View);
                            }
                        }
                    }
                }
    ...
    public static AuthPhoneSelectBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AuthPhoneSelectBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.auth_phone_select, viewGroup, false);
        if (z) {
