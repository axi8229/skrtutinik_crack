...
public final class ActivityEsiaBinding implements ViewBinding {
    ...
    private ActivityEsiaBinding(StateFlipViewGroup stateFlipViewGroup, FrameLayout frameLayout, View view, StateFlipViewGroup stateFlipViewGroup2, TopBarDefault topBarDefault, EmptyStateLargeView emptyStateLargeView) {
    ...
    public static ActivityEsiaBinding bind(View view) {
        ...
        if (frameLayout != null && (viewFindChildViewById = ViewBindings.findChildViewById(view, (i = R.id.empty_container))) != null) {
            ...
            if (topBarDefault != null) {
                ...
                if (emptyStateLargeView != null) {
                    return new ActivityEsiaBinding(stateFlipViewGroup, frameLayout, viewFindChildViewById, stateFlipViewGroup, topBarDefault, emptyStateLargeView);
                }
            }
        }
    ...
    public static ActivityEsiaBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityEsiaBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_esia, viewGroup, false);
        if (z) {
