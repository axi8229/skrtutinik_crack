...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.oauth.notFound.impl.OauthNotFoundBusinessLogic$handleProgressRegistrationState$3$1", f = "OauthNotFoundBusinessLogic.kt", l = {60}, m = "invokeSuspend")
...
public final class m extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public m(OauthNotFoundBusinessLogic oauthNotFoundBusinessLogic, OauthNotFound.Action action, Continuation<? super m> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            OauthNotFound.Effect.ShowNextStep showNextStep = new OauthNotFound.Effect.ShowNextStep(((OauthNotFound.Action.EnrollmentSuccess) this.c).getProcess());
            this.a = 1;
