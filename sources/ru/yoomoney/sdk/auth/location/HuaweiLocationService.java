...
@Metadata(d1 = {"\u00007\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004*\u0001\n\b\u0000\u0018\u0000 \u001a2\u00020\u0001:\u0001\u001aB\u0005¢\u0006\u0002\u0010\u0002J\u0014\u0010\u0012\u001a\u0004\u0018\u00010\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u0015H\u0016J\b\u0010\u0016\u001a\u00020\u0017H\u0016J\b\u0010\u0018\u001a\u00020\u0017H\u0016J\b\u0010\u0019\u001a\u00020\u0017H\u0003R\u001e\u0010\u0003\u001a\u00020\u00048\u0006@\u0006X\u0087.¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\bR\u0010\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0004\n\u0002\u0010\u000bR\u001e\u0010\f\u001a\u00020\r8\u0006@\u0006X\u0087.¢\u0006\u000e\n\u0000\u001a\u0004\b\u000e\u0010\u000f\"\u0004\b\u0010\u0010\u0011¨\u0006\u001b"}, d2 = {"Lru/yoomoney/sdk/auth/location/HuaweiLocationService;", "Landroid/app/Service;", "()V", "fusedLocationClient", "Lcom/huawei/hms/location/FusedLocationProviderClient;", "getFusedLocationClient", "()Lcom/huawei/hms/location/FusedLocationProviderClient;", "setFusedLocationClient", "(Lcom/huawei/hms/location/FusedLocationProviderClient;)V", "locationCallback", "ru/yoomoney/sdk/auth/location/HuaweiLocationService$locationCallback$1", "Lru/yoomoney/sdk/auth/location/HuaweiLocationService$locationCallback$1;", "locationHeaderManager", "Lru/yoomoney/sdk/auth/location/LocationHeaderManager;", "getLocationHeaderManager", "()Lru/yoomoney/sdk/auth/location/LocationHeaderManager;", "setLocationHeaderManager", "(Lru/yoomoney/sdk/auth/location/LocationHeaderManager;)V", "onBind", "Landroid/os/IBinder;", CommonCode.Resolution.HAS_RESOLUTION_FROM_APK, "Landroid/content/Intent;", "onCreate", "", "onDestroy", "startLocationUpdates", "Companion", "auth_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class HuaweiLocationService extends Service {
    private static final String TAG;
    public FusedLocationProviderClient fusedLocationClient;
    private final HuaweiLocationService$locationCallback$1 locationCallback = new LocationCallback() { // from class: ru.yoomoney.sdk.auth.location.HuaweiLocationService$locationCallback$1
        @Override // com.huawei.hms.location.LocationCallback
        public void onLocationResult(LocationResult locationResult) {
            Intrinsics.checkNotNullParameter(locationResult, "locationResult");
            for (Location location : locationResult.getLocations()) {
                Log.d(HuaweiLocationService.TAG, "HuaweiLocationService get new location" + location.getLatitude() + "/" + location.getLongitude());
    ...
    static {
        String name = HuaweiLocationService.class.getName();
        Intrinsics.checkNotNullExpressionValue(name, "getName(...)");
        TAG = name;
    }

    @SuppressLint({"MissingPermission"})
    private final void startLocationUpdates() throws IllegalArgumentException {
        if (!UtilsKt.checkPermissions(this) || !UtilsKt.isGPSEnabled(this)) {
            Log.d(TAG, "checkPermissions or isGPSEnabled = false");
            return;
        }
        LocationRequest locationRequest = new LocationRequest();
        locationRequest.setInterval(UtilsKt.UPDATE_INTERVAL);
    ...
    public void onCreate() throws IllegalArgumentException {
        super.onCreate();
        Log.d(TAG, "HuaweiLocationService onCreate");
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d(TAG, "HuaweiLocationService onDestroy");
