...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo2742getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo2742getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = kotlinType.getConstructor().mo2742getDeclarationDescriptor();
        if (classifierDescriptorMo2742getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo2742getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = kotlinType.getConstructor().mo2742getDeclarationDescriptor();
        return (classifierDescriptorMo2742getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo2742getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
