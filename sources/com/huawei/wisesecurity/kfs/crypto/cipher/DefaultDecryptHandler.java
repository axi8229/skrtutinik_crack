...
public class DefaultDecryptHandler implements DecryptHandler {
    ...
    private byte[] doDecrypt() throws InvalidKeyException, CryptoException, InvalidAlgorithmParameterException {
        try {
            ...
            e = e6;
            StringBuilder sbA22222 = f.a("Fail to decrypt: ");
            sbA22222.append(e.getMessage());
            throw new CryptoException(sbA22222.toString());
        } catch (NoSuchPaddingException e7) {
            e = e7;
            StringBuilder sbA222222 = f.a("Fail to decrypt: ");
