...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2744getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo2744getContributedClassifier = this.javaScope.mo2744getContributedClassifier(name, location);
        if (classDescriptorMo2744getContributedClassifier != null) {
            return classDescriptorMo2744getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor classifierDescriptorMo2744getContributedClassifier = memberScope.mo2744getContributedClassifier(name, location);
            if (classifierDescriptorMo2744getContributedClassifier != null) {
                if (!(classifierDescriptorMo2744getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((ClassifierDescriptorWithTypeParameters) classifierDescriptorMo2744getContributedClassifier).isExpect()) {
                    return classifierDescriptorMo2744getContributedClassifier;
                }
