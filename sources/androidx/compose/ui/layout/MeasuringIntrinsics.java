...
final class MeasuringIntrinsics {
    ...
    public final int minWidth(LayoutModifier modifier, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        return modifier.mo89measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, h, 7, null)).get$w();
    }
    ...
    public final int minHeight(LayoutModifier modifier, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int w) {
        return modifier.mo89measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, w, 0, 0, 13, null)).get$h();
    }
    ...
    public final int maxWidth(LayoutModifier modifier, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        return modifier.mo89measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, h, 7, null)).get$w();
    }
        ...
        public Placeable mo1420measureBRTryo0(long constraints) {
            ...
            if (this.widthHeight == IntrinsicWidthHeight.Width) {
                if (this.minMax == IntrinsicMinMax.Max) {
                    iMinIntrinsicWidth = this.measurable.maxIntrinsicWidth(Constraints.m2083getMaxHeightimpl(constraints));
                } else {
                    iMinIntrinsicWidth = this.measurable.minIntrinsicWidth(Constraints.m2083getMaxHeightimpl(constraints));
                }
                return new EmptyPlaceable(iMinIntrinsicWidth, Constraints.m2079getHasBoundedHeightimpl(constraints) ? Constraints.m2083getMaxHeightimpl(constraints) : 32767);
            }
            if (this.minMax == IntrinsicMinMax.Max) {
                iMinIntrinsicHeight = this.measurable.maxIntrinsicHeight(Constraints.m2084getMaxWidthimpl(constraints));
            } else {
                iMinIntrinsicHeight = this.measurable.minIntrinsicHeight(Constraints.m2084getMaxWidthimpl(constraints));
            }
            return new EmptyPlaceable(Constraints.m2080getHasBoundedWidthimpl(constraints) ? Constraints.m2084getMaxWidthimpl(constraints) : 32767, iMinIntrinsicHeight);
        }
    ...
    private static final class EmptyPlaceable extends Placeable {
        ...
        public EmptyPlaceable(int i, int i2) {
            m1442setMeasuredSizeozmzZPI(IntSizeKt.IntSize(i, i2));
        }
    }
}
