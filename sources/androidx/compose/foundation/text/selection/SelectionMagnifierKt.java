...
public final class SelectionMagnifierKt {
    ...
    private static final TwoWayConverter<Offset, AnimationVector2D> UnspecifiedSafeOffsetVectorConverter = VectorConvertersKt.TwoWayConverter(new Function1<Offset, AnimationVector2D>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$UnspecifiedSafeOffsetVectorConverter$1
        ...
        public /* bridge */ /* synthetic */ AnimationVector2D invoke(Offset offset) {
            return m565invokek4lQ0M(offset.getPackedValue());
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final AnimationVector2D m565invokek4lQ0M(long j) {
        ...
        public /* bridge */ /* synthetic */ Offset invoke(AnimationVector2D animationVector2D) {
            return Offset.m833boximpl(m566invoketuRUvjQ(animationVector2D));
        }

        /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m566invoketuRUvjQ(AnimationVector2D animationVector2D) {
    ...
    static {
        ...
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m833boximpl(jOffset), 3, null);
    }
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$animatedSelectionMagnifier$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m833boximpl(m567invokeF1C5BW0());
                    }

                    /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m567invokeF1C5BW0() {
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer composer, int i) {
        ...
        if (objRememberedValue2 == companion.getEmpty()) {
            objRememberedValue2 = new Animatable(Offset.m833boximpl(rememberAnimatedMagnifierPosition$lambda$1(state)), UnspecifiedSafeOffsetVectorConverter, Offset.m833boximpl(OffsetDisplacementThreshold), null, 8, null);
