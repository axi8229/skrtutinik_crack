...
public final class SelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m977equalsimpl0(this.selectionHandleColor, selectionColors.selectionHandleColor) && Color.m977equalsimpl0(this.selectionBackgroundColor, selectionColors.selectionBackgroundColor);
    }

    public int hashCode() {
        return (Color.m983hashCodeimpl(this.selectionHandleColor) * 31) + Color.m983hashCodeimpl(this.selectionBackgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m984toStringimpl(this.selectionHandleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m984toStringimpl(this.selectionBackgroundColor)) + ')';
    }
}
