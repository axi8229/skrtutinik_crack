...
public final class SimpleActor<T> {
    ...
    public SimpleActor(CoroutineScope scope, final Function1<? super Throwable, Unit> onComplete, final Function2<? super T, ? super Throwable, Unit> onUndeliveredElement, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> consumeMessage) {
        ...
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
            ...
            public final void invoke2(Throwable th) {
                ...
                do {
                    Object objM2793getOrNullimpl = ChannelResult.m2793getOrNullimpl(((SimpleActor) this).messageQueue.mo2788tryReceivePtdJZtk());
                    if (objM2793getOrNullimpl == null) {
                        unit = null;
                    } else {
                        onUndeliveredElement.invoke(objM2793getOrNullimpl, th);
                        unit = Unit.INSTANCE;
                    }
                } while (unit != null);
            }
    ...
    public final void offer(T msg) {
        Object objMo2240trySendJP2dKIU = this.messageQueue.mo2240trySendJP2dKIU(msg);
        if (objMo2240trySendJP2dKIU instanceof ChannelResult.Closed) {
            Throwable thM2792exceptionOrNullimpl = ChannelResult.m2792exceptionOrNullimpl(objMo2240trySendJP2dKIU);
            if (thM2792exceptionOrNullimpl != null) {
                throw thM2792exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m2796isSuccessimpl(objMo2240trySendJP2dKIU)) {
