...
public final class DefaultXMSSOid implements XMSSOid {
    ...
    static {
        ...
        map.put(createKey("SHA-512", 64, 16, pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6, 10), new DefaultXMSSOid(4, "XMSS_SHA2_10_512"));
        map.put(createKey("SHA-512", 64, 16, pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6, 16), new DefaultXMSSOid(5, "XMSS_SHA2_16_512"));
        map.put(createKey("SHA-512", 64, 16, pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6, 20), new DefaultXMSSOid(6, "XMSS_SHA2_20_512"));
        ...
        map.put(createKey("SHAKE256", 64, 16, pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6, 10), new DefaultXMSSOid(10, "XMSS_SHAKE_10_512"));
        map.put(createKey("SHAKE256", 64, 16, pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6, 16), new DefaultXMSSOid(11, "XMSS_SHAKE_16_512"));
        map.put(createKey("SHAKE256", 64, 16, pjsip_transport_type_e.PJSIP_TRANSPORT_TLS6, 20), new DefaultXMSSOid(12, "XMSS_SHAKE_20_512"));
