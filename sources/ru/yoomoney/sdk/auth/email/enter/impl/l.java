...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.enter.impl.EmailEnterBusinessLogic$handleLoadingState$2$1", f = "EmailEnterBusinessLogic.kt", l = {77}, m = "invokeSuspend")
...
public final class l extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public l(EmailEnterBusinessLogic emailEnterBusinessLogic, EmailEnter.Action action, Continuation<? super l> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            EmailEnter.Effect.ShowNextRegistrationStep showNextRegistrationStep = new EmailEnter.Effect.ShowNextRegistrationStep(((EmailEnter.Action.SendEmailRegistrationSuccess) this.c).getProcess());
            this.a = 1;
