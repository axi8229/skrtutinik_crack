...
public final class SessionsSettings {
    ...
    private final boolean isValidSamplingRate(double samplingRate) {
        return ConfigValue.DOUBLE_DEFAULT_VALUE <= samplingRate && samplingRate <= 1.0d;
    }
    ...
    public final long m2454getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo2452getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo2452getSessionRestartTimeoutFghU774();
        if (durationMo2452getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo2452getSessionRestartTimeoutFghU774.getRawValue();
            if (m2453isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo2452getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo2452getSessionRestartTimeoutFghU774();
        if (durationMo2452getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = durationMo2452getSessionRestartTimeoutFghU7742.getRawValue();
            if (m2453isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m2453isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m2772isPositiveimpl(sessionRestartTimeout) && Duration.m2767isFiniteimpl(sessionRestartTimeout);
    }
