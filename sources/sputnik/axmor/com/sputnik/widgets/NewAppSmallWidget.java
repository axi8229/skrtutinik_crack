...
/* compiled from: NewAppSmallWidget.kt */
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0015\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J \u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016J\u0010\u0010\u000b\u001a\u00020\u00042\u0006\u0010\f\u001a\u00020\rH\u0002J\u0012\u0010\u000e\u001a\u00020\u00042\b\u0010\f\u001a\u0004\u0018\u00010\rH\u0002¨\u0006\u000f"}, d2 = {"Lsputnik/axmor/com/sputnik/widgets/NewAppSmallWidget;", "Lsputnik/axmor/com/sputnik/widgets/BaseOpenDoorWidget;", "()V", "onUpdate", "", "context", "Landroid/content/Context;", "appWidgetManager", "Landroid/appwidget/AppWidgetManager;", "appWidgetIds", "", "setNeedAuthView", "views", "Landroid/widget/RemoteViews;", "updateViews", "app_huaweiRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class NewAppSmallWidget extends BaseOpenDoorWidget {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i : appWidgetIds) {
            RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.new_small_app_widget);
    ...
    private final void updateViews(RemoteViews views) {
        ...
        if (views != null) {
            ...
            if (camerasWidget != null) {
                ...
                if (data != null && (cameraList = data.getCameraList()) != null && (body = cameraList.getBody()) != null && (doorLabels = body.getDoorLabels()) != null) {
                    titleClose = doorLabels.getTitleClose();
                }
                setText(views, R.id.text_small_widget, titleClose);
    ...
    private final void setNeedAuthView(RemoteViews views) {
        ...
        LocalizationLocalModel data = getLocalizationScreen().getData();
        setText(views, R.id.text_small_widget, (data == null || (widgets = data.getWidgets()) == null) ? null : widgets.getSettings());
