            ...
            switch (iType) {
                case 0:
                    if ((i6 & i2) == 0) {
                        ...
                        iComputeDoubleSize = CodedOutputStream.computeDoubleSize(iNumberAt, ConfigValue.DOUBLE_DEFAULT_VALUE);
                ...
                case 51:
                    if (isOneofPresent(t, iNumberAt, i4)) {
                        iComputeBoolSize = CodedOutputStream.computeDoubleSize(iNumberAt, ConfigValue.DOUBLE_DEFAULT_VALUE);
                        i5 += iComputeBoolSize;
                    }
                    break;
                case 52:
    ...
    */
    ...
    private boolean isFieldPresent(T t, int i) {
        if (this.proto3) {
            ...
            switch (type(iTypeAndOffsetAt)) {
                case 0:
                    return UnsafeUtil.getDouble(t, jOffset) != ConfigValue.DOUBLE_DEFAULT_VALUE;
                case 1:
