...
public final class WebRtcPlayerImpl$pcObserver$1 implements PeerConnectionObserver {
    ...
    WebRtcPlayerImpl$pcObserver$1(WebRtcPlayerImpl webRtcPlayerImpl) {
        this.this$0 = webRtcPlayerImpl;
    }
        ...
        if (this.this$0.needToAddTrack) {
            ...
            if (list != null) {
                ...
                for (Object obj : list) {
                    ...
                    webRtcPlayerImpl.videoTrack = videoTrack;
                    videoTrack.addSink(new VideoSink() { // from class: sputnik.axmor.com.sputnik.core.players.implementations.webrtc.WebRtcPlayerImpl$pcObserver$1$$ExternalSyntheticLambda0
                        @Override // org.webrtc.VideoSink
                        public final void onFrame(VideoFrame videoFrame) {
                            WebRtcPlayerImpl$pcObserver$1.onAddTrack$lambda$8$lambda$7$lambda$2(webRtcPlayerImpl, videoFrame);
                        }
                    });
                    ...
                    if ((state == null ? -1 : WhenMappings.$EnumSwitchMapping$1[state.ordinal()]) == 1) {
                        ...
                        webRtcPlayerImpl.activity.runOnUiThread(new Runnable() { // from class: sputnik.axmor.com.sputnik.core.players.implementations.webrtc.WebRtcPlayerImpl$pcObserver$1$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                WebRtcPlayerImpl$pcObserver$1.onAddTrack$lambda$8$lambda$7$lambda$6(webRtcPlayerImpl);
                            }
                        });
                    }
                    i = i2;
    ...
    public static final void onAddTrack$lambda$8$lambda$7$lambda$2(final WebRtcPlayerImpl this$0, VideoFrame videoFrame) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.surfaceViewRenderer.onFrame(videoFrame);
        this$0.activity.runOnUiThread(new Runnable() { // from class: sputnik.axmor.com.sputnik.core.players.implementations.webrtc.WebRtcPlayerImpl$pcObserver$1$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                WebRtcPlayerImpl$pcObserver$1.onAddTrack$lambda$8$lambda$7$lambda$2$lambda$1(this$0);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onAddTrack$lambda$8$lambda$7$lambda$2$lambda$1(WebRtcPlayerImpl this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        SurfaceViewRenderer unused = this$0.surfaceViewRenderer;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onAddTrack$lambda$8$lambda$7$lambda$6(final WebRtcPlayerImpl this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        try {
            surfaceViewRenderer.init(this$0.rootEglBase.getEglBaseContext(), new RendererCommon.RendererEvents() { // from class: sputnik.axmor.com.sputnik.core.players.implementations.webrtc.WebRtcPlayerImpl$pcObserver$1$onAddTrack$1$1$3$1$1$1
    ...
    public void onRenegotiationNeeded() {
        ...
        if (peerConnection != null) {
            final WebRtcPlayerImpl webRtcPlayerImpl = this.this$0;
            peerConnection.createOffer(new CustomSdpObserver() { // from class: sputnik.axmor.com.sputnik.core.players.implementations.webrtc.WebRtcPlayerImpl$pcObserver$1$onRenegotiationNeeded$1
                ...
                public void onCreateSuccess(SessionDescription p0) {
                    ...
                    PeerConnection peerConnection2 = webRtcPlayerImpl.peerConnection;
                    if (peerConnection2 != null) {
                        final WebRtcPlayerImpl webRtcPlayerImpl2 = webRtcPlayerImpl;
                        peerConnection2.setLocalDescription(new CustomSdpObserver() { // from class: sputnik.axmor.com.sputnik.core.players.implementations.webrtc.WebRtcPlayerImpl$pcObserver$1$onRenegotiationNeeded$1$onCreateSuccess$1
                            @Override // org.webrtc.SdpObserver
                            public void onCreateFailure(String str) {
                                CustomSdpObserver.DefaultImpls.onCreateFailure(this, str);
                            }
                            ...
                            public void onSetFailure(String p02) {
                                ...
                                webRtcPlayerImpl2.playerCallback.onStateChanged(PlayerStates.ERROR);
                            }
                        }, p0);
                    }
                }
    ...
    public void onConnectionChange(PeerConnection.PeerConnectionState newState) {
        ...
        if (i == 1) {
            WebRtcPlayerImpl webRtcPlayerImpl = this.this$0;
            webRtcPlayerImpl.play(String.valueOf(webRtcPlayerImpl.getLastKnownUrl()));
        } else {
            if (i != 2) {
                return;
            }
