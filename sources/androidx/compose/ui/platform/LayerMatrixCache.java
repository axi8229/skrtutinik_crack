...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m1624calculateMatrixGrdbGEg(T target) {
        float[] fArrM1031constructorimpl$default = this.matrixCache;
        if (fArrM1031constructorimpl$default == null) {
            fArrM1031constructorimpl$default = androidx.compose.ui.graphics.Matrix.m1031constructorimpl$default(null, 1, null);
            this.matrixCache = fArrM1031constructorimpl$default;
        }
        if (!this.isDirty) {
        ...
        if (matrix2 == null || !Intrinsics.areEqual(matrix, matrix2)) {
            AndroidMatrixConversions_androidKt.m902setFromtUYjHk(fArrM1031constructorimpl$default, matrix);
    ...
    public final float[] m1623calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m1622invertToJiSxe2E(m1624calculateMatrixGrdbGEg(target), fArrM1031constructorimpl$default);
