...
public final class C0554t0 extends AbstractC0538n1 implements A0 {
    public final Context c;
    public final Z0 d;
    public final LocationManager e;
    public final zone.bi.mobile.fingerprint.api.b f;

    public C0554t0(Context context, Z0 z0, LocationManager locationManager, zone.bi.mobile.fingerprint.api.b bVar) {
    ...
    public final Serializable h() throws e2 {
        ...
        if (AbstractC0547q1.b(locationManager2) == null) {
            throw new e2("bestLocation == null");
        }
        String string = Double.toString(r0.getSpeed());
        a(string);
        return string;
    }
}
