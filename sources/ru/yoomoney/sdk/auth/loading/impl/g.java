...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.loading.impl.AuthLoadingBusinessLogic$handleProgressState$11$1", f = "AuthLoadingBusinessLogic.kt", l = {80}, m = "invokeSuspend")
...
public final class g extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public g(AuthLoadingBusinessLogic authLoadingBusinessLogic, AuthLoading.Action action, Continuation<? super g> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AuthLoading.Effect.ShowLogin showLogin = new AuthLoading.Effect.ShowLogin(((AuthLoading.Action.EnterIdentifierSuccess) this.c).getProcess(), false, 2, null);
            this.a = 1;
