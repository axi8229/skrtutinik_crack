...
final class ContinuationCallback implements Callback, Function1<Throwable, Unit> {
    ...
    public void onResponse(Call call, Response response) {
        this.continuation.resumeWith(Result.m2628constructorimpl(response));
    }
    ...
    public void onFailure(Call call, IOException e) {
        ...
        cancellableContinuation.resumeWith(Result.m2628constructorimpl(ResultKt.createFailure(e)));
    }
