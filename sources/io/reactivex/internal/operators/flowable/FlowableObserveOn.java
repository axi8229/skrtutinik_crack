...
public final class FlowableObserveOn<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        if (subscriber instanceof ConditionalSubscriber) {
            this.source.subscribe(new ObserveOnConditionalSubscriber((ConditionalSubscriber) subscriber, workerCreateWorker, this.delayError, this.prefetch));
        } else {
            this.source.subscribe(new ObserveOnSubscriber(subscriber, workerCreateWorker, this.delayError, this.prefetch));
        }
    }
