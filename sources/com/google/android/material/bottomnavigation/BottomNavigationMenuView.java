...
public class BottomNavigationMenuView extends NavigationBarMenuView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size3, pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH);
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths.get(i11).intValue(), pj_ssl_cert_verify_flag_t.PJ_SSL_CERT_EIDENTITY_NOT_MATCH), iMakeMeasureSpec);
