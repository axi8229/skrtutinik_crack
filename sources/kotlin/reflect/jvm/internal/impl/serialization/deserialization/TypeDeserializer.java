...
public final class TypeDeserializer {
    ...
    public final SimpleType simpleType(final ProtoBuf$Type proto, boolean z) {
        ...
        if (ErrorUtils.isError(typeConstructor.mo2742getDeclarationDescriptor())) {
        ...
        if (z && (classifierDescriptorMo2742getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            SimpleType simpleTypeComputeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) classifierDescriptorMo2742getDeclarationDescriptor, list);
    ...
    private static final ClassDescriptor typeConstructor$notFoundClass(final TypeDeserializer typeDeserializer, ProtoBuf$Type protoBuf$Type, int i) {
        ...
        List<Integer> mutableList = SequencesKt.toMutableList(SequencesKt.map(SequencesKt.generateSequence(protoBuf$Type, new Function1<ProtoBuf$Type, ProtoBuf$Type>() { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.TypeDeserializer$typeConstructor$notFoundClass$typeParametersCount$1
            {
                super(1);
            }
    ...
    private final SimpleType transformRuntimeFunctionTypeToSuspendFunction(KotlinType kotlinType) {
        ...
        FqName fqNameSafe = classifierDescriptorMo2742getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameSafe(classifierDescriptorMo2742getDeclarationDescriptor) : null;
