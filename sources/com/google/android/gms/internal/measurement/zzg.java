...
public final class zzg {
    public static double zza(double d) {
        ...
        return (d > ConfigValue.DOUBLE_DEFAULT_VALUE ? 1 : -1) * Math.floor(Math.abs(d));
    }
    ...
    public static int zzb(double d) {
        ...
        return (int) (((d > ConfigValue.DOUBLE_DEFAULT_VALUE ? 1 : -1) * Math.floor(Math.abs(d))) % 4.294967296E9d);
    }
