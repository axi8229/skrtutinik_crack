...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.create.impl.PasswordCreateBusinessLogic$handleProgressState$1$1", f = "PasswordCreateBusinessLogic.kt", l = {108}, m = "invokeSuspend")
...
public final class k extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public k(PasswordCreateBusinessLogic passwordCreateBusinessLogic, PasswordCreate.Action action, Continuation<? super k> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PasswordCreate.Effect.ShowNextStep showNextStep = new PasswordCreate.Effect.ShowNextStep(((PasswordCreate.Action.SetPasswordSuccess) this.c).getProcess());
            this.a = 1;
