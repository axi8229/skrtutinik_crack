    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo2743getSupertypes = capturedTypeConstructorImpl.mo2743getSupertypes();
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo2743getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2743getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo2743getSupertypes2, 10));
            Iterator<T> it2 = collectionMo2743getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo2743getSupertypes3 = intersectionTypeConstructor.mo2743getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo2743getSupertypes3, 10));
        Iterator<T> it3 = collectionMo2743getSupertypes3.iterator();
        while (it3.hasNext()) {
