...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.passport.impl.PassportProfileBusinessLogic$handleLoadingState$7$1", f = "PassportProfileBusinessLogic.kt", l = {222}, m = "invokeSuspend")
...
public final class g0 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public g0(PassportProfileBusinessLogic passportProfileBusinessLogic, PassportProfile.Action action, Continuation<? super g0> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PassportProfile.Effect.ShowFailure showFailure = new PassportProfile.Effect.ShowFailure(((PassportProfile.Action.UnbindSocialAccountFailed) this.c).getFailure());
            this.a = 1;
