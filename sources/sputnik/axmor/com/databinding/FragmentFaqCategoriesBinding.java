...
public final class FragmentFaqCategoriesBinding implements ViewBinding {
    ...
    private FragmentFaqCategoriesBinding(NestedScrollView nestedScrollView, LinearLayout linearLayout, LinearLayout linearLayout2, RecyclerView recyclerView, Toolbar toolbar, TextView textView, TextView textView2) {
    ...
    public static FragmentFaqCategoriesBinding bind(View view) {
                ...
                if (recyclerView != null) {
                    ...
                    if (toolbar != null) {
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                return new FragmentFaqCategoriesBinding((NestedScrollView) view, linearLayout, linearLayout2, recyclerView, toolbar, textView, textView2);
                            }
                        }
                    }
                }
