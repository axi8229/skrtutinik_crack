...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.oauth.notFound.impl.OauthNotFoundBusinessLogic$handleProgressRegistrationState$4$1", f = "OauthNotFoundBusinessLogic.kt", l = {64}, m = "invokeSuspend")
...
public final class o extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public o(OauthNotFoundBusinessLogic oauthNotFoundBusinessLogic, OauthNotFound.Action action, Continuation<? super o> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            OauthNotFound.Effect.ShowFailure showFailure = new OauthNotFound.Effect.ShowFailure(((OauthNotFound.Action.EnrollmentFailure) this.c).getFailure());
            this.a = 1;
