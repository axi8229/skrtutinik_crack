...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo105measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo1420measureBRTryo0 = measurable.mo1420measureBRTryo0(Constraints.m2076copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m2084getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m2083getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo1420measureBRTryo0.getWidth(), Constraints.m2084getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo1420measureBRTryo0.getHeight(), Constraints.m2083getMaxHeightimpl(j));
        final int height = placeableMo1420measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo1420measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
