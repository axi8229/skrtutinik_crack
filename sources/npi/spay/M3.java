...
public final class M3 extends C2083z6 {
    public final int j;
    public final int k;
    public final int l;
    public final int m;
    ...
    public M3(int i, int i2, int i3, int i4, Integer num, String number, Integer num2, Bk title, String name, String str, boolean z, Integer num3) {
    ...
    public final String toString() {
        return "BankCard(paymentId=" + this.j + ", backgroundColor=" + this.k + ", statusImage=" + this.l + ", numberResId=" + this.m + ", pluralsResId=" + this.n + ", number='" + this.o + "', cardsCount=" + this.p + ", title=" + this.q + ", name='" + this.r + "', cardLogo=" + this.s + ", precalculatedBonuses='" + this.u + "')";
    }
}
