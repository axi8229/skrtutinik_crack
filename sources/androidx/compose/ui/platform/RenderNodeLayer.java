...
public final class RenderNodeLayer implements OwnedLayer {
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m996toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m996toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.m1104getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m1105getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((32768 & mutatedFields) != 0) {
            this.renderNode.mo1613setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
    ...
    public boolean mo1555isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM842getXimpl && fM842getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM843getYimpl && fM843getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mo1558resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m1104getPivotFractionXimpl(this.transformOrigin) * iM2156getWidthimpl);
        this.renderNode.setPivotY(TransformOrigin.m1105getPivotFractionYimpl(this.transformOrigin) * iM2155getHeightimpl);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM2156getWidthimpl, this.renderNode.getTop() + iM2155getHeightimpl)) {
            this.renderNode.setOutline(this.outlineResolver.getAndroidOutline());
            invalidate();
            this.matrixCache.invalidate();
        }
    ...
    public void mo1557movegyyYBs(long position) {
        ...
        if (left == iM2138getXimpl && top == iM2139getYimpl) {
            return;
        }
        if (left != iM2138getXimpl) {
            this.renderNode.offsetLeftAndRight(iM2138getXimpl - left);
        }
        if (top != iM2139getYimpl) {
            this.renderNode.offsetTopAndBottom(iM2139getYimpl - top);
        }
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.mo891concat58bKbWc(this.matrixCache.m1624calculateMatrixGrdbGEg(this.renderNode));
    ...
    public long mo1556mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM1623calculateInverseMatrixbWbORWo = this.matrixCache.m1623calculateInverseMatrixbWbORWo(this.renderNode);
        ...
        return androidx.compose.ui.graphics.Matrix.m1034mapMKHz9U(this.matrixCache.m1624calculateMatrixGrdbGEg(this.renderNode), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m1035mapimpl(this.matrixCache.m1624calculateMatrixGrdbGEg(this.renderNode), rect);
    }
    ...
    public void mo1559transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m1042timesAssign58bKbWc(matrix, this.matrixCache.m1624calculateMatrixGrdbGEg(this.renderNode));
    }
