...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.confirm.impl.PhoneConfirmBusinessLogic$processStateContentAction$3$1", f = "PhoneConfirmBusinessLogic.kt", l = {48}, m = "invokeSuspend")
...
public final class d extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public d(PhoneConfirmBusinessLogic phoneConfirmBusinessLogic, Continuation<? super d> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneConfirm.Effect.ShowExpireDialog showExpireDialog = PhoneConfirm.Effect.ShowExpireDialog.INSTANCE;
            this.a = 1;
