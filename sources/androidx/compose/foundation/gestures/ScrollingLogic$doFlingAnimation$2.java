...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    ScrollingLogic$doFlingAnimation$2(ScrollingLogic scrollingLogic, Ref$LongRef ref$LongRef, long j, Continuation<? super ScrollingLogic$doFlingAnimation$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m276toFloatk4lQ0M(nestedScrollScope.mo247scrollByWithOverscrollOzD1aCk(scrollingLogic4.m274reverseIfNeededMKHz9U(scrollingLogic4.m277toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m1312getSideEffectWNlRxjI())));
                }
            };
            ...
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m269toFloatTH1AsA0(j2));
        ...
        ref$LongRef.element = scrollingLogic.m270updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
