...
public final class AndroidAccessibilitySpannableString_androidKt {
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString annotatedString, Density density, FontFamily.Resolver resolver, URLSpanCache uRLSpanCache) {
        ...
        if (spanStylesOrNull$ui_text_release != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                setSpanStyle(spannableString, SpanStyle.m1759copyGSF8kmg$default(range.component1(), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65503, null), range.getStart(), range.getEnd(), density, resolver);
            }
        }
    ...
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i, int i2, Density density, FontFamily.Resolver resolver) {
        SpannableExtensions_androidKt.m1959setColorRPmYEkk(spannableString, spanStyle.m1763getColor0d7_KjU(), i, i2);
        SpannableExtensions_androidKt.m1960setFontSizeKmRG4DE(spannableString, spanStyle.getFontSize(), density, i, i2);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m1822getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle != null ? fontStyle.getValue() : FontStyle.INSTANCE.m1852getNormal_LCdwA())), i, i2, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m1832resolveDPcqOEQ$default(resolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m1862getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m1957setBackgroundRPmYEkk(spannableString, spanStyle.getBackground(), i, i2);
    }
