...
public class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
        ...
        try {
            if (isTransferAtFullNetworkSpeed(dataSpec, isNetwork)) {
                ...
                if (i > 0) {
                    ...
                    if (this.totalElapsedTimeMs >= YooProfilerImpl.TIMER_LIMIT || this.totalBytesTransferred >= 524288) {
    ...
    static class ConnectivityActionReceiver extends BroadcastReceiver {
        ...
        public synchronized void register(final DefaultBandwidthMeter bandwidthMeter) {
            ...
            this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.upstream.DefaultBandwidthMeter$ConnectivityActionReceiver$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.lambda$register$0(bandwidthMeter);
                }
            });
        }
        ...
        public void lambda$register$0(DefaultBandwidthMeter bandwidthMeter) {
