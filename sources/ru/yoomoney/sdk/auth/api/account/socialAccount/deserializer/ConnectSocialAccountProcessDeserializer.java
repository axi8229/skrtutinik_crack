...
import ru.yoomoney.sdk.auth.api.account.socialAccount.model.Step;

@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0003J \u0010\u0004\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016¨\u0006\u000b"}, d2 = {"Lru/yoomoney/sdk/auth/api/account/socialAccount/deserializer/ConnectSocialAccountProcessDeserializer;", "Lcom/google/gson/JsonDeserializer;", "Lru/yoomoney/sdk/auth/api/account/model/ConnectSocialAccountProcess;", "()V", "deserialize", "json", "Lcom/google/gson/JsonElement;", "typeOfT", "Ljava/lang/reflect/Type;", "context", "Lcom/google/gson/JsonDeserializationContext;", "auth_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class ConnectSocialAccountProcessDeserializer implements JsonDeserializer<ConnectSocialAccountProcess> {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[Step.ENTER_OAUTH_CODE.ordinal()] = 1;
    ...
    public ConnectSocialAccountProcess deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException, UpdateRequiredException {
        Type type;
        ...
        if (i == 1) {
            type = ConnectSocialAccountEnterOAuthCode.class;
        } else if (i == 2) {
            type = ConnectSocialAccountSuccess.class;
        } else {
            if (i != 3) {
                throw new UpdateRequiredException();
            }
            type = ConnectSocialAccountFailure.class;
        }
        Object objDeserialize = context.deserialize(json, type);
        Intrinsics.checkNotNullExpressionValue(objDeserialize, "deserialize(...)");
        return (ConnectSocialAccountProcess) objDeserialize;
    }
}
