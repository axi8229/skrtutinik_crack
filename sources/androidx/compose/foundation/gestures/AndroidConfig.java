...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo212calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset offsetM833boximpl = Offset.m833boximpl(Offset.INSTANCE.m854getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            offsetM833boximpl = Offset.m833boximpl(Offset.m847plusMKHz9U(offsetM833boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m848timestuRUvjQ(offsetM833boximpl.getPackedValue(), -density.mo254toPx0680j_4(Dp.m2102constructorimpl(64)));
    }
}
