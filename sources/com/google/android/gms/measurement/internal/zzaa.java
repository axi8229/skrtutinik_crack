...
abstract class zzaa {
    ...
    private static Boolean zza(String str, zzfo.zzf.zzb zzbVar, boolean z, String str2, List<String> list, String str3, zzgo zzgoVar) throws IllegalStateException {
        if (str == null) {
            return null;
        }
    ...
    static Boolean zza(long j, zzfo.zzd zzdVar) {
        try {
            return zza(new BigDecimal(j), zzdVar, ConfigValue.DOUBLE_DEFAULT_VALUE);
        } catch (NumberFormatException unused) {
            return null;
        }
    }
    ...
    static Boolean zza(String str, zzfo.zzd zzdVar) {
        ...
        try {
            return zza(new BigDecimal(str), zzdVar, ConfigValue.DOUBLE_DEFAULT_VALUE);
        } catch (NumberFormatException unused) {
            return null;
        }
    }
