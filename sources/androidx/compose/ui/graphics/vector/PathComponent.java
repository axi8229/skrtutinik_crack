...
public final class PathComponent extends VNode {
    ...
    public final void m1226setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo923setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m1227setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m1228setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo921getFillTypeRgk1Os = this.renderPath.mo921getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo923setFillTypeoQ8Xj4U(iMo921getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m1170drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m1170drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
