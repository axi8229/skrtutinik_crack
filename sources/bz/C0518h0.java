...
public final class C0518h0 extends AbstractC0538n1 implements A0 {
    public final Context c;
    public final Z0 d;
    public final LocationManager e;
    public final zone.bi.mobile.fingerprint.api.b f;

    public C0518h0(Context context, Z0 z0, LocationManager locationManager, zone.bi.mobile.fingerprint.api.b bVar) {
    ...
    public final Serializable h() throws e2 {
        ...
        String str2 = String.format(Locale.US, "%.1f", Float.valueOf(locationB.getBearing()));
        a(str2);
        return str2;
    }
}
