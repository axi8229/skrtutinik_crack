...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.confirm.impl.PhoneConfirmBusinessLogic$processStateContentAction$5$1", f = "PhoneConfirmBusinessLogic.kt", l = {60}, m = "invokeSuspend")
...
public final class f extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public f(PhoneConfirmBusinessLogic phoneConfirmBusinessLogic, Continuation<? super f> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneConfirm.Effect.ResetProcess resetProcess = PhoneConfirm.Effect.ResetProcess.INSTANCE;
            this.a = 1;
