...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.create.impl.PasswordCreateBusinessLogic$handleProgressState$4$2", f = "PasswordCreateBusinessLogic.kt", l = {136}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class r extends SuspendLambda implements Function1<Continuation<? super PasswordCreate.Action>, Object> {
    public int a;
    ...
    public r(PasswordCreateBusinessLogic passwordCreateBusinessLogic, Out.Builder<PasswordCreate.State.Content, PasswordCreate.Action> builder, Continuation<? super r> continuation) {
