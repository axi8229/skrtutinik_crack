...
public class Kwp implements KeyWrap {
        ...
        while (i3 < 6) {
            ...
            while (i4 < i2) {
                ...
                for (int i8 = 0; i8 < 4; i8++) {
                    int i9 = 7 - i8;
                    bArr2[i9] = (byte) (((byte) (i7 & KotlinVersion.MAX_COMPONENT_VALUE)) ^ bArr2[i9]);
                    i7 >>>= 8;
                }
        ...
        for (int i2 = 5; i2 >= 0; i2--) {
            for (int i3 = length - 2; i3 >= 0; i3--) {
                ...
                for (int i6 = 0; i6 < 4; i6++) {
                    int i7 = 7 - i6;
                    bArr[i7] = (byte) (bArr[i7] ^ ((byte) (i5 & KotlinVersion.MAX_COMPONENT_VALUE)));
                    i5 >>>= 8;
                }
    ...
    public byte[] wrap(final byte[] data) throws GeneralSecurityException {
        ...
        for (int i = 0; i < 4; i++) {
            bArr[i + 4] = (byte) ((data.length >> ((3 - i) * 8)) & KotlinVersion.MAX_COMPONENT_VALUE);
        }
