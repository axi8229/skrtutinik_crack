...
public final class io extends SuspendLambda implements Function2 {
    ...
    public io(BottomSheetDialogFragment bottomSheetDialogFragment, Lifecycle.State state, Flow flow, Continuation continuation, mo moVar) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new io(this.b, this.c, this.d, continuation, this.e);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ho hoVar = new ho(this.d, null, this.e);
            this.a = 1;
            if (RepeatOnLifecycleKt.repeatOnLifecycle(bottomSheetDialogFragment, state, hoVar, this) == coroutine_suspended) {
