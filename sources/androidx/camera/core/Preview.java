...
public final class Preview extends UseCase {
    ...
    private SessionConfig.Builder createPipeline(String str, PreviewConfig previewConfig, StreamSpec streamSpec) {
        ...
        if (effect != null) {
            ...
            final SurfaceEdge surfaceEdge = this.mNode.transform(SurfaceProcessorNode.In.of(this.mCameraEdge, Collections.singletonList(outConfigOf))).get(outConfigOf);
            Objects.requireNonNull(surfaceEdge);
            surfaceEdge.addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.core.Preview$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$createPipeline$0(surfaceEdge, cameraInternal);
                }
            });
    ...
    private void addCameraSurfaceAndErrorListener(SessionConfig.Builder builder, final String str, final PreviewConfig previewConfig, final StreamSpec streamSpec) {
        ...
        builder.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.Preview$$ExternalSyntheticLambda3
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.lambda$addCameraSurfaceAndErrorListener$1(str, previewConfig, streamSpec, sessionConfig, sessionError);
            }
        });
    }
