...
public class l1 extends n0<t, Void> {
    ...
    public void doExecute(t tVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<Void> taskCompletionSource) throws ApiException {
        try {
            HMSLocationLog.i("RequestReportLocationTaskApiCall", ((n0) this).a, "doExecute");
            ...
            HMSLocationLog.e("RequestReportLocationTaskApiCall", ((n0) this).a, "doExecute exception");
