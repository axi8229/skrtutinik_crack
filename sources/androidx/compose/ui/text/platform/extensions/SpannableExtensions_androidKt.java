...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float fM2169getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m2166equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m2166equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m2175isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m2175isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long jM2168getTypeUIouoOA = TextUnit.m2168getTypeUIouoOA(textIndent.getFirstLine());
            TextUnitType.Companion companion = TextUnitType.INSTANCE;
            float fM2169getValueimpl2 = 0.0f;
            if (TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA, companion.m2184getSpUIouoOA())) {
                fM2169getValueimpl = density.mo253toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM2169getValueimpl = TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA, companion.m2183getEmUIouoOA()) ? TextUnit.m2169getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM2168getTypeUIouoOA2 = TextUnit.m2168getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA2, companion.m2184getSpUIouoOA())) {
                fM2169getValueimpl2 = density.mo253toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA2, companion.m2183getEmUIouoOA())) {
                fM2169getValueimpl2 = TextUnit.m2169getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM2169getValueimpl), (int) Math.ceil(fM2169getValueimpl2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m1961setLineHeightKmRG4DE(Spannable spannable, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        float fM1956resolveLineHeightInPxo2QH7mI = m1956resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM1956resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightStyleSpan(fM1956resolveLineHeightInPxo2QH7mI, 0, (spannable.length() == 0 || StringsKt.last(spannable) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m2022isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m2023isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, spannable.length());
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m1962setLineHeightr9BaKPg(Spannable spannable, long j, float f, Density density) {
        float fM1956resolveLineHeightInPxo2QH7mI = m1956resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM1956resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(fM1956resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m1956resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        float fM2169getValueimpl;
        long jM2168getTypeUIouoOA = TextUnit.m2168getTypeUIouoOA(j);
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        if (TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA, companion.m2184getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo253toPxR2X_6o(j);
            }
            fM2169getValueimpl = TextUnit.m2169getValueimpl(j) / TextUnit.m2169getValueimpl(density.mo257toSpkPz2Gy4(f));
        } else {
            if (!TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA, companion.m2183getEmUIouoOA())) {
                return Float.NaN;
            }
            fM2169getValueimpl = TextUnit.m2169getValueimpl(j);
        }
        return fM2169getValueimpl * f;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan metricAffectingSpanM1955createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM1955createLetterSpacingSpaneAf_CNQ = m1955createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, metricAffectingSpanM1955createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m1807getFontStyle4Lr2A7w(), textStyle.m1808getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), null, 0L, null, null, null, 0L, null, null, null, null, 65475, null) : null, arrayList, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM1844boximpl, FontSynthesis.m1853boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m1862getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m1958setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m1959setColorRPmYEkk(spannable, item.m1763getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m1960setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m1957setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    private static final MetricAffectingSpan m1955createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM2168getTypeUIouoOA = TextUnit.m2168getTypeUIouoOA(j);
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        if (TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA, companion.m2184getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo253toPxR2X_6o(j));
        }
        if (TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA, companion.m2183getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m2169getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        long jM2168getTypeUIouoOA = TextUnit.m2168getTypeUIouoOA(spanStyle.getLetterSpacing());
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        return TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA, companion.m2184getSpUIouoOA()) || TextUnitType.m2179equalsimpl0(TextUnit.m2168getTypeUIouoOA(spanStyle.getLetterSpacing()), companion.m2183getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m996toArgb8_81llA(shadow.getColor()), Offset.m842getXimpl(shadow.getOffset()), Offset.m843getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m1957setBackgroundRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m996toArgb8_81llA(j)), i, i2);
        }
    }
    ...
    public static final void m1960setFontSizeKmRG4DE(Spannable spannable, long j, Density density, int i, int i2) {
        long jM2168getTypeUIouoOA = TextUnit.m2168getTypeUIouoOA(j);
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        if (TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA, companion.m2184getSpUIouoOA())) {
            setSpan(spannable, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo253toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m2179equalsimpl0(jM2168getTypeUIouoOA, companion.m2183getEmUIouoOA())) {
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m2169getValueimpl(j)), i, i2);
        }
    }
    ...
    public static final void m1959setColorRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m996toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m1958setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m1959setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m1808getFontSynthesisZQGJjVo() != null;
    }
