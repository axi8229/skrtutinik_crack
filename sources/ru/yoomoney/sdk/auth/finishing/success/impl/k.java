...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.finishing.success.impl.AuthFinishingSuccessBusinessLogic$handleProgressState$5$1", f = "AuthFinishingSuccessBusinessLogic.kt", l = {53}, m = "invokeSuspend")
...
public final class k extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public k(AuthFinishingSuccessBusinessLogic authFinishingSuccessBusinessLogic, AuthFinishingSuccess.Action action, Continuation<? super k> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AuthFinishingSuccess.Effect.Finish finish = new AuthFinishingSuccess.Effect.Finish(((AuthFinishingSuccess.Action.SuccessAccount) this.c).getAccessToken(), ((AuthFinishingSuccess.Action.SuccessAccount) this.c).getUserAccount());
            this.a = 1;
