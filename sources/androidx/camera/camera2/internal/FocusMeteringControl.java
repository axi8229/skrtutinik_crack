...
class FocusMeteringControl {
    ...
    CallbackToFutureAdapter.Completer<Object> mRunningActionCompleter;
    ...
    private void failActionFuture(String str) {
        ...
        CallbackToFutureAdapter.Completer<Object> completer = this.mRunningActionCompleter;
        if (completer != null) {
        ...
        if (this.mRunningCancelCompleter != null) {
            ...
            Camera2CameraControlImpl.CaptureResultListener captureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda0
                ...
                public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                    return this.f$0.lambda$cancelFocusAndMeteringInternal$9(supportedAfMode, jUpdateSessionConfigSynchronous, totalCaptureResult);
                }
            };
