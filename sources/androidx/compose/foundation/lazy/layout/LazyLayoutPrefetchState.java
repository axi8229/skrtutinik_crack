...
public final class LazyLayoutPrefetchState {
    ...
    public final PrefetchHandle m386schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle prefetchHandleM393schedulePrefetchVKLhPVY;
        PrefetchHandleProvider prefetchHandleProvider = this.prefetchHandleProvider;
        return (prefetchHandleProvider == null || (prefetchHandleM393schedulePrefetchVKLhPVY = prefetchHandleProvider.m393schedulePrefetchVKLhPVY(index, constraints, this.prefetchMetrics)) == null) ? DummyHandle.INSTANCE : prefetchHandleM393schedulePrefetchVKLhPVY;
    }
    ...
    private final class NestedPrefetchScopeImpl implements NestedPrefetchScope {
        ...
        public void schedulePrefetch(int index) {
            m387schedulePrefetch0kLqBqw(index, LazyLayoutPrefetchStateKt.ZeroConstraints);
        }

        /* renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
        public void m387schedulePrefetch0kLqBqw(int index, long constraints) {
            PrefetchHandleProvider prefetchHandleProvider = LazyLayoutPrefetchState.this.getPrefetchHandleProvider();
            if (prefetchHandleProvider == null) {
                return;
            }
            this._requests.add(prefetchHandleProvider.m392createNestedPrefetchRequestVKLhPVY(index, constraints, LazyLayoutPrefetchState.this.prefetchMetrics));
        }
    }
}
