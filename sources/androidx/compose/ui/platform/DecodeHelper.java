...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                ...
                if (bDecodeByte == 2) {
                    ...
                    mutableSpanStyle.m1628setFontSizeR2X_6o(m1612decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m1629setFontStylemLjRB2g(FontStyle.m1844boximpl(m1610decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (bDecodeByte != 8) {
                                if (bDecodeByte != 9) {
                                    if (bDecodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m1625setBackground8_81llA(m1609decodeColor0d7_KjU());
                                    }
                                } else {
                                    if (dataAvailable() < 8) {
                                        break;
                                ...
                                mutableSpanStyle.m1626setBaselineShift_isdbwI(BaselineShift.m1968boximpl(m1607decodeBaselineShifty9eOQZs()));
                            }
                        } else {
                            if (dataAvailable() < 5) {
                                break;
                            }
                            mutableSpanStyle.m1631setLetterSpacingR2X_6o(m1612decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m1630setFontSynthesistDdu0R4(FontSynthesis.m1853boximpl(m1611decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else {
                if (dataAvailable() < 8) {
                ...
                mutableSpanStyle2.m1627setColor8_81llA(m1609decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m1609decodeColor0d7_KjU() {
        return Color.m972constructorimpl(m1608decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m1612decodeTextUnitXSAIIZE() {
        long jM2185getUnspecifiedUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM2185getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m2184getSpUIouoOA();
        } else if (bDecodeByte == 2) {
            jM2185getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m2183getEmUIouoOA();
        } else {
            jM2185getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m2185getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m2179equalsimpl0(jM2185getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m2185getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m2173getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m2174TextUnitanM5pPY(decodeFloat(), jM2185getUnspecifiedUIouoOA);
    }
    ...
    public final int m1610decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontStyle.INSTANCE.m1852getNormal_LCdwA();
        }
        if (bDecodeByte == 1) {
            return FontStyle.INSTANCE.m1851getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m1852getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m1611decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontSynthesis.INSTANCE.m1863getNoneGVVA2EU();
        }
        if (bDecodeByte == 1) {
            return FontSynthesis.INSTANCE.m1862getAllGVVA2EU();
        }
        if (bDecodeByte == 3) {
            return FontSynthesis.INSTANCE.m1864getStyleGVVA2EU();
        }
        if (bDecodeByte == 2) {
            return FontSynthesis.INSTANCE.m1865getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m1863getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m1607decodeBaselineShifty9eOQZs() {
        return BaselineShift.m1969constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m1609decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m1608decodeULongsVKNKU() {
        return ULong.m2682constructorimpl(this.parcel.readLong());
    }
