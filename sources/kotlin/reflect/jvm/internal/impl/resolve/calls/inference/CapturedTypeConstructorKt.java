...
public final class CapturedTypeConstructorKt {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt.wrapWithCapturingSubstitution.2
            ...
            /* renamed from: get */
            public TypeProjection mo2747get(KotlinType key) {
                Intrinsics.checkNotNullParameter(key, "key");
                TypeProjection typeProjectionMo2747get = super.mo2747get(key);
                if (typeProjectionMo2747get == null) {
                    return null;
                }
                ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = key.getConstructor().mo2742getDeclarationDescriptor();
                return CapturedTypeConstructorKt.createCapturedIfNeeded(typeProjectionMo2747get, classifierDescriptorMo2742getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo2742getDeclarationDescriptor : null);
            }
        };
    }
