...
import ru.yoomoney.sdk.kassa.payments.paymentAuth.C2445t;
...
public final class k implements Factory {
    ...
    public final Object get() {
        ...
        if (testParameters.getMockConfiguration() != null) {
            apiV3PaymentAuthRepository = new C2445t();
        }
        return (D1) Preconditions.checkNotNullFromProvides(apiV3PaymentAuthRepository);
    }
}
