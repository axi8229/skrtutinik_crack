...
public final class DescriptorBasedTypeSignatureMappingKt {
    ...
    public static final <T> T mapType(KotlinType kotlinType, JvmTypeFactory<T> factory, TypeMappingMode mode, TypeMappingConfiguration<? extends T> typeMappingConfiguration, JvmDescriptorTypeWriter<T> jvmDescriptorTypeWriter, Function3<? super KotlinType, ? super T, ? super TypeMappingMode, Unit> writeGenericType) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            ...
            if (alternativeType == null) {
                alternativeType = typeMappingConfiguration.commonSupertype(intersectionTypeConstructor.mo2743getSupertypes());
            }
        ...
        if (ErrorUtils.isError(classifierDescriptorMo2742getDeclarationDescriptor)) {
            T t2 = (T) factory.createObjectType("error/NonExistentClass");
            typeMappingConfiguration.processErrorType(kotlinType, (ClassDescriptor) classifierDescriptorMo2742getDeclarationDescriptor);
            return t2;
        }
        boolean z = classifierDescriptorMo2742getDeclarationDescriptor instanceof ClassDescriptor;
        ...
        if (z) {
            if (InlineClassesUtilsKt.isInlineClass(classifierDescriptorMo2742getDeclarationDescriptor) && !mode.getNeedInlineClassWrapping() && (kotlinType2 = (KotlinType) ExpandedTypeUtilsKt.computeExpandedTypeForInlineClass(simpleClassicTypeSystemContext, kotlinType)) != null) {
            ...
            if (mode.isForAnnotationParameter() && KotlinBuiltIns.isKClass((ClassDescriptor) classifierDescriptorMo2742getDeclarationDescriptor)) {
                t = (Object) factory.getJavaLangClassType();
            } else {
                ClassDescriptor classDescriptor = (ClassDescriptor) classifierDescriptorMo2742getDeclarationDescriptor;
        ...
        if (classifierDescriptorMo2742getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            KotlinType representativeUpperBound = TypeUtilsKt.getRepresentativeUpperBound((TypeParameterDescriptor) classifierDescriptorMo2742getDeclarationDescriptor);
        ...
        if ((classifierDescriptorMo2742getDeclarationDescriptor instanceof TypeAliasDescriptor) && mode.getMapTypeAliases()) {
            return (T) mapType(((TypeAliasDescriptor) classifierDescriptorMo2742getDeclarationDescriptor).getExpandedType(), factory, mode, typeMappingConfiguration, jvmDescriptorTypeWriter, writeGenericType);
        }
    ...
    public static final String computeInternalName(ClassDescriptor klass, TypeMappingConfiguration<?> typeMappingConfiguration) {
        ...
        if (containingDeclaration instanceof PackageFragmentDescriptor) {
            ...
            sb.append(StringsKt.replace$default(strAsString, '.', JsonPointer.SEPARATOR, false, 4, (Object) null));
