    ...
    */
    ...
    private final int _decodeUtf8_2(int i) throws IOException {
        ...
        if ((unsignedByte & 192) != 128) {
            _reportInvalidOther(unsignedByte & KotlinVersion.MAX_COMPONENT_VALUE);
        }
    ...
    private final int _decodeUtf8_3(int i) throws IOException {
        ...
        if ((unsignedByte2 & 192) != 128) {
            _reportInvalidOther(unsignedByte2 & KotlinVersion.MAX_COMPONENT_VALUE);
        }
    ...
    private final int _decodeUtf8_4(int i) throws IOException {
        ...
        if ((unsignedByte3 & 192) != 128) {
            _reportInvalidOther(unsignedByte3 & KotlinVersion.MAX_COMPONENT_VALUE);
        }
        return ((i3 << 6) | (unsignedByte3 & 63)) - pj_ssl_sock_proto.PJ_SSL_SOCK_PROTO_DTLS1;
    }
