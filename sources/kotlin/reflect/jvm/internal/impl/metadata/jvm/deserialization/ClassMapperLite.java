...
public final class ClassMapperLite {
    ...
    private static final String f48kotlin = CollectionsKt.joinToString$default(CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), "", null, null, 0, null, null, 62, null);
    ...
    static {
        ...
        if (progressionLastElement >= 0) {
            ...
            while (true) {
                ...
                String str = f48kotlin;
                sb.append(str);
                sb.append(JsonPointer.SEPARATOR);
                sb.append((String) listListOf.get(i));
                int i2 = i + 1;
                linkedHashMap.put(sb.toString(), listListOf.get(i2));
                linkedHashMap.put(str + JsonPointer.SEPARATOR + ((String) listListOf.get(i)) + "Array", '[' + ((String) listListOf.get(i2)));
        ...
        linkedHashMap.put(f48kotlin + "/Unit", "V");
        ...
        for (String str5 : CollectionsKt.listOf((Object[]) new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"})) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f48kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }

    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f48kotlin + JsonPointer.SEPARATOR + str, 'L' + str2 + ';');
    }
