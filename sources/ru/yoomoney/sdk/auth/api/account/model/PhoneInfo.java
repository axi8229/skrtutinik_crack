...
public final /* data */ class PhoneInfo implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<PhoneInfo> {
        ...
        public final PhoneInfo createFromParcel(Parcel parcel) {
            ...
            return new PhoneInfo(parcel.readString(), parcel.readInt() != 0);
        }
    ...
    public PhoneInfo(String str, boolean z) {
        this.title = str;
        this.modifiable = z;
    }

    public static /* synthetic */ PhoneInfo copy$default(PhoneInfo phoneInfo, String str, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            str = phoneInfo.title;
        }
        if ((i & 2) != 0) {
            z = phoneInfo.modifiable;
        }
        return phoneInfo.copy(str, z);
    }
    ...
    public final PhoneInfo copy(String title, boolean modifiable) {
        return new PhoneInfo(title, modifiable);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.title, phoneInfo.title) && this.modifiable == phoneInfo.modifiable;
    }
    ...
    public String toString() {
        return "PhoneInfo(title=" + this.title + ", modifiable=" + this.modifiable + ")";
    }
