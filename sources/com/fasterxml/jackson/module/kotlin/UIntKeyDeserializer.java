...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÀ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J*\u0010\u0003\u001a\u0004\u0018\u00010\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002¢\u0006\u0002\b\t\u0082\u0002\u000f\n\u0002\b\u0019\n\u0002\b!\n\u0005\b¡\u001e0\u0001¨\u0006\n"}, d2 = {"Lcom/fasterxml/jackson/module/kotlin/UIntKeyDeserializer;", "Lcom/fasterxml/jackson/databind/deser/std/StdKeyDeserializer;", "()V", "deserializeKey", "Lkotlin/UInt;", "key", "", "ctxt", "Lcom/fasterxml/jackson/databind/DeserializationContext;", "deserializeKey-uT2Fmlo", "jackson-module-kotlin"}, k = 1, mv = {1, 5, 1}, xi = 48)
...
public final class UIntKeyDeserializer extends StdKeyDeserializer {
    ...
    public UInt deserializeKey(String key, DeserializationContext ctxt) throws IOException {
        Intrinsics.checkNotNullParameter(ctxt, "ctxt");
        Object objDeserializeKey = super.deserializeKey(key, ctxt);
        if (objDeserializeKey == null) {
            return null;
        }
        UInt uIntAsUInt = UnsignedNumbersKt.asUInt(((Long) objDeserializeKey).longValue());
        if (uIntAsUInt != null) {
            return UInt.m2659boximpl(uIntAsUInt.getData());
        }
