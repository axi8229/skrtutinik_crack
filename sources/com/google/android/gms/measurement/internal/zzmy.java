...
public final class zzmy<T extends Context & zznc> {
    ...
    final /* synthetic */ void zza(int i, zzgo zzgoVar, Intent intent) throws IllegalStateException {
        if (this.zza.zza(i)) {
    ...
    final /* synthetic */ void zza(zzgo zzgoVar, JobParameters jobParameters) throws IllegalStateException {
