...
public final class InsetsPaddingModifier implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo89measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo1420measureBRTryo0 = measurable.mo1420measureBRTryo0(ConstraintsKt.m2099offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.layout$default(measureScope, ConstraintsKt.m2098constrainWidthK40F9xA(j, placeableMo1420measureBRTryo0.getWidth() + right), ConstraintsKt.m2097constrainHeightK40F9xA(j, placeableMo1420measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo1420measureBRTryo0, left, top, 0.0f, 4, null);
            }
        }, 4, null);
    }
