...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo1420measureBRTryo0(long constraints) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, Constraints.m2079getHasBoundedHeightimpl(constraints) ? Constraints.m2083getMaxHeightimpl(constraints) : 32767);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m2080getHasBoundedWidthimpl(constraints) ? Constraints.m2084getMaxWidthimpl(constraints) : 32767, iMinIntrinsicHeight);
    }
