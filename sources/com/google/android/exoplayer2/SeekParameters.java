...
public final class SeekParameters {
    ...
    public long resolveSeekPositionUs(long positionUs, long firstSyncUs, long secondSyncUs) {
        ...
        boolean z = false;
        boolean z2 = jSubtractWithOverflowDefault <= firstSyncUs && firstSyncUs <= jAddWithOverflowDefault;
        if (jSubtractWithOverflowDefault <= secondSyncUs && secondSyncUs <= jAddWithOverflowDefault) {
            z = true;
        }
        return (z2 && z) ? Math.abs(firstSyncUs - positionUs) <= Math.abs(secondSyncUs - positionUs) ? firstSyncUs : secondSyncUs : z2 ? firstSyncUs : z ? secondSyncUs : jSubtractWithOverflowDefault;
    }
