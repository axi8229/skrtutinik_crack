...
public final class ItemImageRoundDetailLargeView extends ItemImageDetailLargeView {
    public /* synthetic */ ItemImageRoundDetailLargeView(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i2 & 2) != 0 ? null : attributeSet, (i2 & 4) != 0 ? 0 : i);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ItemImageRoundDetailLargeView(Context context, AttributeSet attributeSet, int i) {
