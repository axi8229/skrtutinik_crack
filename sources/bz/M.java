...
public final class M extends AbstractC0538n1 implements A0 {
    public final Context c;
    public final Z0 d;
    public final LocationManager e;
    public final zone.bi.mobile.fingerprint.api.b f;

    public M(Context context, Z0 z0, LocationManager locationManager, zone.bi.mobile.fingerprint.api.b bVar) {
    ...
    public final Serializable h() throws e2 {
        ...
        String strSubstring = (String) a(this.f.a);
        if (strSubstring == null || ((locationManager = this.e) != null && AbstractC0547q1.a(locationManager))) {
            ...
            String string = Double.toString(locationB.getAltitude());
            strSubstring = (string.isEmpty() || !string.contains(".")) ? "" : string.substring(0, string.indexOf(46));
            a(strSubstring);
        }
        return strSubstring;
    }
