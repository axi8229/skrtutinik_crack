        ...
        int encodeUtf8(CharSequence charSequence, byte[] bArr, int i, int i2) {
            ...
            while (i6 < length) {
                ...
                if (cCharAt2 < 128 && i7 < i5) {
                    ...
                    bArr[i7] = (byte) ((cCharAt2 >>> '\f') | pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE);
                    int i11 = i7 + 2;
            ...
            while (i4 < length) {
                ...
                if (cCharAt2 >= 128 || j4 >= j5) {
                    if (cCharAt2 >= 2048 || j4 > j5 - 2) {
                        ...
                        UnsafeUtil.putByte(bArr, j4, (byte) ((cCharAt2 >>> '\f') | pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE));
                        long j7 = j4 + 2;
