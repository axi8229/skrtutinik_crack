...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long jM2149getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m2149getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTargetM = ScrollCapture$$ExternalSyntheticApiModelOutline2.m(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(rectBoundsInRoot)), new Point(IntOffset.m2138getXimpl(jM2149getTopLeftnOccac), IntOffset.m2139getYimpl(jM2149getTopLeftnOccac)), ScrollCapture$$ExternalSyntheticApiModelOutline0.m(composeScrollCaptureCallback));
