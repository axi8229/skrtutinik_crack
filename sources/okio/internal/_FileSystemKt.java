...
public final class _FileSystemKt {
    ...
    @DebugMetadata(c = "okio.internal._FileSystemKt", f = "-FileSystem.kt", l = {113, pjsip_transport_type_e.PJSIP_TRANSPORT_DTLS6, 142}, m = "collectRecursively")
    ...
    */
    ...
    static final class C21071 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C21071(Path path, FileSystem fileSystem, boolean z, Continuation<? super C21071> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C21071 c21071 = new C21071(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c21071.L$0 = obj;
            return c21071;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C21071) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Sequence<Path> commonListRecursively(FileSystem fileSystem, Path dir, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(fileSystem, "<this>");
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C21071(dir, fileSystem, z, null));
    }
