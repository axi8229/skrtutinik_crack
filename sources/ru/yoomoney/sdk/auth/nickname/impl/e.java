...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.nickname.impl.NicknameBusinessLogic$handleProgressState$1$2", f = "NicknameBusinessLogic.kt", l = {58}, m = "invokeSuspend")
...
public final class e extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public e(NicknameBusinessLogic nicknameBusinessLogic, Nickname.Action action, Continuation<? super e> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Nickname.Effect.Finish finish = new Nickname.Effect.Finish(((Nickname.Action.SetNicknameSuccess) this.c).getUserAccount());
            this.a = 1;
