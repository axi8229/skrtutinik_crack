package ru.yoomoney.sdk.auth.api.enrollment.deserializer;
...
import ru.yoomoney.sdk.auth.api.enrollment.model.Step;

@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0003J \u0010\u0004\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0016¨\u0006\u000b"}, d2 = {"Lru/yoomoney/sdk/auth/api/enrollment/deserializer/EnrollmentProcessDeserializer;", "Lcom/google/gson/JsonDeserializer;", "Lru/yoomoney/sdk/auth/api/enrollment/model/EnrollmentProcess;", "()V", "deserialize", "json", "Lcom/google/gson/JsonElement;", "typeOfT", "Ljava/lang/reflect/Type;", "context", "Lcom/google/gson/JsonDeserializationContext;", "auth_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class EnrollmentProcessDeserializer implements JsonDeserializer<EnrollmentProcess> {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[Step.SUGGEST_ACCOUNT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[Step.SET_EMAIL.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[Step.CONFIRM_EMAIL.ordinal()] = 6;
            ...
            try {
                iArr[Step.ENROLLMENT_FAILURE.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                iArr[Step.ENROLLMENT_SUCCESS.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                iArr[Step.FORCE_LOGIN.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                iArr[Step.ACCEPT_TERMS.ordinal()] = 11;
    ...
    public EnrollmentProcess deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException, UpdateRequiredException {
        Type type;
        ...
        switch (step == null ? -1 : WhenMappings.$EnumSwitchMapping$0[step.ordinal()]) {
            case 1:
                type = EnrollmentProcessSetPhone.class;
                break;
            case 2:
                type = EnrollmentProcessConfirmPhone.class;
                break;
            case 3:
                type = EnrollmentProcessSetPassword.class;
                break;
            case 4:
                type = EnrollmentProcessSuggestAccount.class;
                break;
            case 5:
                type = EnrollmentProcessSetEmail.class;
                break;
            case 6:
                type = EnrollmentProcessConfirmEmail.class;
                break;
            case 7:
                type = EnrollmentProcessAcquireAuthorization.class;
                break;
            case 8:
                type = EnrollmentProcessFailure.class;
                break;
            case 9:
                type = EnrollmentProcessSuccess.class;
                break;
            case 10:
                type = EnrollmentProcessForceLogin.class;
                break;
            case 11:
                type = EnrollmentProcessAcceptTerms.class;
                break;
            default:
        ...
        return (EnrollmentProcess) objDeserialize;
    }
}
