...
public final class MigrationProcessDeserializer implements JsonDeserializer<MigrationProcess> {
    ...
    public MigrationProcess deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException, UpdateRequiredException {
        Type type;
        ...
        return (MigrationProcess) objDeserialize;
    }
}
