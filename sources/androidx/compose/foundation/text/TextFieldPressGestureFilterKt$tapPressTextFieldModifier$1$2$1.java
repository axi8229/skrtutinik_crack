...
final class TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        if (i == 0) {
            ...
            Function1<Offset, Unit> function1 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.TextFieldPressGestureFilterKt$tapPressTextFieldModifier$1$2$1.2
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m478invokek4lQ0M(offset.getPackedValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                public final void m478invokek4lQ0M(long j) {
                    state.getValue().invoke(Offset.m833boximpl(j));
                }
            };
            this.label = 1;
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m477invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
        }

        /* renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m477invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(this.$scope, null, null, new C00251(this.$pressedInteraction, this.J$0, this.$interactionSource, null), 3, null);
                this.label = 1;
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (value != null) {
                        ...
                        if (z) {
                            pressInteraction$Cancel = new PressInteraction$Release(value);
                        } else {
                            pressInteraction$Cancel = new PressInteraction$Cancel(value);
                        }
