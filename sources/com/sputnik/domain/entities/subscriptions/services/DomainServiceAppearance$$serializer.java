...
public final class DomainServiceAppearance$$serializer implements GeneratedSerializer<DomainServiceAppearance> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sputnik.domain.entities.subscriptions.services.DomainServiceAppearance", domainServiceAppearance$$serializer, 5);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(stringSerializer), BuiltinSerializersKt.getNullable(DomainBadge$$serializer.INSTANCE)};
    }
    ...
    public DomainServiceAppearance deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            domainBadge = (DomainBadge) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, DomainBadge$$serializer.INSTANCE, null);
            i = 31;
            str3 = str8;
            str2 = str7;
            str = str6;
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    domainBadge2 = (DomainBadge) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, DomainBadge$$serializer.INSTANCE, domainBadge2);
                    i2 |= 16;
                }
            }
            i = i2;
        ...
        return new DomainServiceAppearance(i, str, str2, str3, str4, domainBadge, null);
    }
