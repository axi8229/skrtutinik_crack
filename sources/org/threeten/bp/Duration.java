...
public final class Duration implements TemporalAmount, Comparable<Duration>, Serializable {
    ...
    public static Duration ofDays(long j) {
        return create(Jdk8Methods.safeMultiply(j, RemoteMessageConst.DEFAULT_TTL), 0);
    }
        ...
        if (temporal.isSupported(chronoField) && temporal2.isSupported(chronoField)) {
            try {
                ...
                if (jUntil > 0 && j3 < 0) {
                    ...
                    try {
                        jUntil = temporal.until(temporal2.with(chronoField, j2), chronoUnit);
    ...
    public static Duration parse(CharSequence charSequence) {
        ...
        if (matcher.matches() && !"T".equals(matcher.group(3))) {
            ...
            if (strGroup != null || strGroup2 != null || strGroup3 != null || strGroup4 != null) {
                long number = parseNumber(charSequence, strGroup, RemoteMessageConst.DEFAULT_TTL, "days");
    ...
    private static Duration create(boolean z, long j, long j2, long j3, long j4, int i) {
        long jSafeAdd = Jdk8Methods.safeAdd(j, Jdk8Methods.safeAdd(j2, Jdk8Methods.safeAdd(j3, j4)));
        if (z) {
            return ofSeconds(jSafeAdd, i).negated();
        }
        return ofSeconds(jSafeAdd, i);
    }
    ...
    public Duration plus(long j, TemporalUnit temporalUnit) {
        ...
        if (temporalUnit == ChronoUnit.DAYS) {
            return plus(Jdk8Methods.safeMultiply(j, RemoteMessageConst.DEFAULT_TTL), 0L);
        }
