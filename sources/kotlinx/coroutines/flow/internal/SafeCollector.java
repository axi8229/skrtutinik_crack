...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM2631exceptionOrNullimpl = Result.m2631exceptionOrNullimpl(result);
        if (thM2631exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM2631exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
