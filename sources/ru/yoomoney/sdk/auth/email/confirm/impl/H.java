...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.confirm.impl.EmailConfirmBusinessLogic$handleValidState$7$1", f = "EmailConfirmBusinessLogic.kt", l = {TimelineAnimator.DURATION}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class H extends SuspendLambda implements Function1<Continuation<? super EmailConfirm.Action>, Object> {
    public int a;
    ...
    public H(EmailConfirmBusinessLogic emailConfirmBusinessLogic, Out.Builder<EmailConfirm.State.Progress, EmailConfirm.Action> builder, Continuation<? super H> continuation) {
