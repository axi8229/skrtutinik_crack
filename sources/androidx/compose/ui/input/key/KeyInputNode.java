...
final class KeyInputNode extends Modifier.Node implements KeyInputModifierNode {
    ...
    public boolean mo152onKeyEventZmokQxo(android.view.KeyEvent event) {
        Function1<? super KeyEvent, Boolean> function1 = this.onEvent;
        if (function1 != null) {
            return function1.invoke(KeyEvent.m1282boximpl(event)).booleanValue();
        }
        return false;
    }
    ...
    public boolean mo154onPreKeyEventZmokQxo(android.view.KeyEvent event) {
