...
public class AccountSipConfig extends PersistentObject {
        ...
        try {
            ...
            if (j != 0) {
                if (this.swigCMemOwn) {
                    ...
                    pjsua2JNI.delete_AccountSipConfig(j);
                }
                this.swigCPtr = 0L;
            }
            super.delete();
    ...
    public AuthCredInfoVector getAuthCreds() {
        long jAccountSipConfig_authCreds_get = pjsua2JNI.AccountSipConfig_authCreds_get(this.swigCPtr, this);
        if (jAccountSipConfig_authCreds_get == 0) {
            return null;
        }
        return new AuthCredInfoVector(jAccountSipConfig_authCreds_get, false);
    }
    ...
    public StringVector getProxies() {
        long jAccountSipConfig_proxies_get = pjsua2JNI.AccountSipConfig_proxies_get(this.swigCPtr, this);
        if (jAccountSipConfig_proxies_get == 0) {
            return null;
        }
        return new StringVector(jAccountSipConfig_proxies_get, false);
    }
