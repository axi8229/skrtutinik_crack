...
public final class LayoutNodeDrawScopeKt {
    ...
    public static final Modifier.Node nextDrawNode(DelegatableNode delegatableNode) {
        ...
        int iM1552constructorimpl2 = NodeKind.m1552constructorimpl(2);
        Modifier.Node child = delegatableNode.getNode().getChild();
        if (child == null || (child.getAggregateChildKindSet() & iM1552constructorimpl) == 0) {
            return null;
        }
        while (child != null && (child.getKindSet() & iM1552constructorimpl2) == 0) {
