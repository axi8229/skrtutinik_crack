...
public final class DomainHeader$$serializer implements GeneratedSerializer<DomainHeader> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sputnik.domain.entities.subscriptions.subscriptions.DomainHeader", domainHeader$$serializer, 1);
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{BuiltinSerializersKt.getNullable(DomainHeader.$childSerializers[0])};
    }
    ...
    public DomainHeader deserialize(Decoder decoder) {
        ...
        return new DomainHeader(i, list, null);
    }
    ...
    public void serialize(Encoder encoder, DomainHeader value) {
        ...
        compositeEncoderBeginStructure.encodeNullableSerializableElement(descriptor2, 0, DomainHeader.$childSerializers[0], value.title);
