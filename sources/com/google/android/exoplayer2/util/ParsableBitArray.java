...
public final class ParsableBitArray {
    ...
    public void readBits(byte[] buffer, int offset, int numBits) {
        ...
        byte b3 = (byte) (buffer[i] & (KotlinVersion.MAX_COMPONENT_VALUE >> i5));
        buffer[i] = b3;
    ...
    public void putInt(int value, int numBits) {
        ...
        byte b = (byte) (((65280 >> i) | ((1 << i2) - 1)) & bArr[i3]);
        bArr[i3] = b;
        int i4 = numBits - iMin;
        bArr[i3] = (byte) (b | ((value >>> i4) << i2));
        int i5 = i3 + 1;
        while (i4 > 8) {
        ...
        int i6 = 8 - i4;
        byte[] bArr2 = this.data;
        byte b2 = (byte) (bArr2[i5] & ((1 << i6) - 1));
        bArr2[i5] = b2;
        bArr2[i5] = (byte) (((value & ((1 << i4) - 1)) << i6) | b2);
        skipBits(numBits);
        assertValidOffset();
    }
