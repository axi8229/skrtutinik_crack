...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    static class DecodeJobFactory {
        ...
        final Pools$Pool<DecodeJob<?>> pool = FactoryPools.threadSafe(TimelineAnimator.DURATION, new FactoryPools.Factory<DecodeJob<?>>() { // from class: com.bumptech.glide.load.engine.Engine.DecodeJobFactory.1
    ...
    static class EngineJobFactory {
        ...
        final Pools$Pool<EngineJob<?>> pool = FactoryPools.threadSafe(TimelineAnimator.DURATION, new FactoryPools.Factory<EngineJob<?>>() { // from class: com.bumptech.glide.load.engine.Engine.EngineJobFactory.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.bumptech.glide.util.pool.FactoryPools.Factory
