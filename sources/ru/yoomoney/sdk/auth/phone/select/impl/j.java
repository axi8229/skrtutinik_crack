...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.select.impl.PhoneSelectBusinessLogic$handleProgressState$2$1", f = "PhoneSelectBusinessLogic.kt", l = {104}, m = "invokeSuspend")
...
public final class j extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public j(PhoneSelectBusinessLogic phoneSelectBusinessLogic, PhoneSelect.Action action, Continuation<? super j> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneSelect.Effect.ShowFailure showFailure = new PhoneSelect.Effect.ShowFailure(((PhoneSelect.Action.ShowFailure) this.c).getFailure());
            this.a = 1;
