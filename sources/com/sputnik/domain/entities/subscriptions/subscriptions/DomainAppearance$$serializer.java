...
public final class DomainAppearance$$serializer implements GeneratedSerializer<DomainAppearance> {
    public static final DomainAppearance$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        DomainAppearance$$serializer domainAppearance$$serializer = new DomainAppearance$$serializer();
        INSTANCE = domainAppearance$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sputnik.domain.entities.subscriptions.subscriptions.DomainAppearance", domainAppearance$$serializer, 3);
    ...
    private DomainAppearance$$serializer() {
    }

    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public KSerializer<?>[] childSerializers() {
        KSerializer<?> nullable = BuiltinSerializersKt.getNullable(DomainBadge$$serializer.INSTANCE);
    ...
    public DomainAppearance deserialize(Decoder decoder) {
        int i;
        ...
        DomainBadge domainBadge2 = null;
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            DomainBadge domainBadge3 = (DomainBadge) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, DomainBadge$$serializer.INSTANCE, null);
            StringSerializer stringSerializer = StringSerializer.INSTANCE;
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    domainBadge2 = (DomainBadge) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, DomainBadge$$serializer.INSTANCE, domainBadge2);
                    i2 |= 1;
        ...
        return new DomainAppearance(i, domainBadge, str, str2, null);
    }
    ...
    public void serialize(Encoder encoder, DomainAppearance value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        DomainAppearance.write$Self(value, compositeEncoderBeginStructure, descriptor2);
