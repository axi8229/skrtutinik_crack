...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.confirm.impl.PhoneConfirmBusinessLogic$processStateProgressAction$5$2", f = "PhoneConfirmBusinessLogic.kt", l = {pjsip_transport_type_e.PJSIP_TRANSPORT_TCP6}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class t extends SuspendLambda implements Function1<Continuation<? super PhoneConfirm.Action>, Object> {
    public int a;
    ...
    public t(PhoneConfirmBusinessLogic phoneConfirmBusinessLogic, Out.Builder<PhoneConfirm.State.Content, PhoneConfirm.Action> builder, Continuation<? super t> continuation) {
