...
public final class UByteSerializer extends StdSerializer<UByte> {
    ...
    public /* bridge */ /* synthetic */ void serialize(Object obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        m2312serializedjbwkw(((UByte) obj).getData(), jsonGenerator, serializerProvider);
    }

    /* renamed from: serialize-d-jbwkw, reason: not valid java name */
    public void m2312serializedjbwkw(byte value, JsonGenerator gen, SerializerProvider provider) throws IOException {
