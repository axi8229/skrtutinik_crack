...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.select.impl.EmailSelectBusinessLogic$handleContent$2$1", f = "EmailSelectBusinessLogic.kt", l = {102}, m = "invokeSuspend")
...
public final class b extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public b(EmailSelectBusinessLogic emailSelectBusinessLogic, Continuation<? super b> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            EmailSelect.Effect.ResetProcess resetProcess = EmailSelect.Effect.ResetProcess.INSTANCE;
            this.a = 1;
