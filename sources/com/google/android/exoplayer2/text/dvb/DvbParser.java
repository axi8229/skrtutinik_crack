...
final class DvbParser {
    ...
    private static RegionComposition parseRegionComposition(ParsableBitArray data, int length) {
        ...
        SparseArray sparseArray = new SparseArray();
        while (i4 > 0) {
            int bits12 = data.readBits(i2);
            int bits13 = data.readBits(i3);
            int bits14 = data.readBits(i3);
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray data, int length) {
        ...
        while (i4 > 0) {
            ...
            double d2 = bits4 - 128;
            double d3 = bits - 128;
            iArr[bits6] = getColor((byte) (255 - (bits2 & KotlinVersion.MAX_COMPONENT_VALUE)), Util.constrainValue((int) (d + (1.402d * d2)), 0, KotlinVersion.MAX_COMPONENT_VALUE), Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, KotlinVersion.MAX_COMPONENT_VALUE), Util.constrainValue((int) (d + (d3 * 1.772d)), 0, KotlinVersion.MAX_COMPONENT_VALUE));
            i4 = i;
            bits5 = bits5;
            i2 = 8;
            i3 = 2;
    ...
    private static int[] generateDefault4BitClutEntries() {
        ...
        for (int i = 1; i < 16; i++) {
            if (i < 8) {
                iArr[i] = getColor(KotlinVersion.MAX_COMPONENT_VALUE, (i & 1) != 0 ? 255 : 0, (i & 2) != 0 ? 255 : 0, (i & 4) != 0 ? 255 : 0);
            } else {
                iArr[i] = getColor(KotlinVersion.MAX_COMPONENT_VALUE, (i & 1) != 0 ? 127 : 0, (i & 2) != 0 ? 127 : 0, (i & 4) == 0 ? 0 : 127);
            }
        }
        return iArr;
    }
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            if (i < 8) {
                ...
                int i5 = i & 136;
                if (i5 == 0) {
                    iArr[i] = getColor(KotlinVersion.MAX_COMPONENT_VALUE, ((i & 1) != 0 ? 85 : 0) + ((i & 16) != 0 ? 170 : 0), ((i & 2) != 0 ? 85 : 0) + ((i & 32) != 0 ? 170 : 0), ((i & 4) == 0 ? 0 : 85) + ((i & 64) == 0 ? 0 : 170));
                } else if (i5 == 8) {
                    iArr[i] = getColor(127, ((i & 1) != 0 ? 85 : 0) + ((i & 16) != 0 ? 170 : 0), ((i & 2) != 0 ? 85 : 0) + ((i & 32) != 0 ? 170 : 0), ((i & 4) == 0 ? 0 : 85) + ((i & 64) == 0 ? 0 : 170));
                } else if (i5 == 128) {
                    iArr[i] = getColor(KotlinVersion.MAX_COMPONENT_VALUE, ((i & 1) != 0 ? 43 : 0) + 127 + ((i & 16) != 0 ? 85 : 0), ((i & 2) != 0 ? 43 : 0) + 127 + ((i & 32) != 0 ? 85 : 0), ((i & 4) == 0 ? 0 : 43) + 127 + ((i & 64) == 0 ? 0 : 85));
                } else if (i5 == 136) {
                    iArr[i] = getColor(KotlinVersion.MAX_COMPONENT_VALUE, ((i & 1) != 0 ? 43 : 0) + ((i & 16) != 0 ? 85 : 0), ((i & 2) != 0 ? 43 : 0) + ((i & 32) != 0 ? 85 : 0), ((i & 4) == 0 ? 0 : 43) + ((i & 64) == 0 ? 0 : 85));
                }
            }
        }
        return iArr;
