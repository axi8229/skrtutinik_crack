...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.email.select.impl.EmailSelectBusinessLogic$handleContent$4$1", f = "EmailSelectBusinessLogic.kt", l = {110}, m = "invokeSuspend")
...
public final class d extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public d(EmailSelectBusinessLogic emailSelectBusinessLogic, Continuation<? super d> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            EmailSelect.Effect.ShowExpireDialog showExpireDialog = EmailSelect.Effect.ShowExpireDialog.INSTANCE;
            this.a = 1;
