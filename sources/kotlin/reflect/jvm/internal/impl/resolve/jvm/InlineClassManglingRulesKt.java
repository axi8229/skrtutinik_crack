...
public final class InlineClassManglingRulesKt {
    ...
    public static final boolean isValueClassThatRequiresMangling(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo2742getDeclarationDescriptor != null) {
            return (InlineClassesUtilsKt.isInlineClass(classifierDescriptorMo2742getDeclarationDescriptor) && isValueClassThatRequiresMangling(classifierDescriptorMo2742getDeclarationDescriptor)) || InlineClassesUtilsKt.needsMfvcFlattening(kotlinType);
        }
        return false;
    }
    ...
    private static final boolean isTypeParameterWithUpperBoundThatRequiresMangling(KotlinType kotlinType, boolean z) {
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = kotlinType.getConstructor().mo2742getDeclarationDescriptor();
        TypeParameterDescriptor typeParameterDescriptor = classifierDescriptorMo2742getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo2742getDeclarationDescriptor : null;
