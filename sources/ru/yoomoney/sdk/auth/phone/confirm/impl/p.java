...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.confirm.impl.PhoneConfirmBusinessLogic$processStateProgressAction$3$1", f = "PhoneConfirmBusinessLogic.kt", l = {117}, m = "invokeSuspend")
...
public final class p extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public p(PhoneConfirmBusinessLogic phoneConfirmBusinessLogic, PhoneConfirm.Action action, Continuation<? super p> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneConfirm.Effect.ShowFailure showFailure = new PhoneConfirm.Effect.ShowFailure(((PhoneConfirm.Action.TechnicalError) this.c).getFailure());
            this.a = 1;
