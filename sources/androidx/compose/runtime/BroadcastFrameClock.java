...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                objM2628constructorimpl = Result.m2628constructorimpl(this.onFrame.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
        ...
        synchronized (this.lock) {
            try {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuation.resumeWith(Result.m2628constructorimpl(ResultKt.createFailure(cause)));
                }
                this.awaiters.clear();
                this.hasAwaitersUnlocked.set(0);
                Unit unit = Unit.INSTANCE;
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m2628constructorimpl(ResultKt.createFailure(th)));
            } else {
