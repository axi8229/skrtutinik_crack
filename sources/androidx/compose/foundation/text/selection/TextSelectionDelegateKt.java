...
public final class TextSelectionDelegateKt {
    public static final long getSelectionHandleCoordinates(TextLayoutResult textLayoutResult, int i, boolean z, boolean z2) {
        ...
        return lineForOffset >= textLayoutResult.getLineCount() ? Offset.INSTANCE.m853getUnspecifiedF1C5BW0() : OffsetKt.Offset(RangesKt.coerceIn(getHorizontalPosition(textLayoutResult, i, z, z2), 0.0f, IntSize.m2156getWidthimpl(textLayoutResult.getSize())), RangesKt.coerceIn(textLayoutResult.getLineBottom(lineForOffset), 0.0f, IntSize.m2155getHeightimpl(textLayoutResult.getSize())));
    }
