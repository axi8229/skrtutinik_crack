        ...
        for (Pair<String, ? extends Object> pair : pairArr) {
            ...
            if (objComponent2 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    ...
                    throw new IllegalArgumentException("Illegal value array type " + componentType.getCanonicalName() + " for key \"" + strComponent1 + JsonFactory.DEFAULT_QUOTE_CHAR);
                }
                ...
                throw new IllegalArgumentException("Illegal value type " + objComponent2.getClass().getCanonicalName() + " for key \"" + strComponent1 + JsonFactory.DEFAULT_QUOTE_CHAR);
            }
        }
        return bundle;
    }
