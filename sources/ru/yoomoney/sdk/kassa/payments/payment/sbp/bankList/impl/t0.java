...
public final class t0 extends Lambda implements Function1 {
    ...
    public t0(RuntimeViewModelDependencies runtimeViewModelDependencies, w0 w0Var) {
        super(1);
    ...
    public final Object invoke(Object obj) {
        ...
        CoreKt.input(invoke, new r0(this.a, invoke, null));
        CoreKt.input(invoke, new s0(this.b, null));
