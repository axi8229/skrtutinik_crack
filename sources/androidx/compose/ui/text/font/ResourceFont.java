...
public final class ResourceFont implements Font {
    ...
    public boolean equals(Object other) {
        ...
        return this.resId == resourceFont.resId && Intrinsics.areEqual(getWeight(), resourceFont.getWeight()) && FontStyle.m1847equalsimpl0(getStyle(), resourceFont.getStyle()) && Intrinsics.areEqual(this.variationSettings, resourceFont.variationSettings) && FontLoadingStrategy.m1837equalsimpl0(getLoadingStrategy(), resourceFont.getLoadingStrategy());
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m1848hashCodeimpl(getStyle())) * 31) + FontLoadingStrategy.m1838hashCodeimpl(getLoadingStrategy())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m1849toStringimpl(getStyle())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m1839toStringimpl(getLoadingStrategy())) + ')';
    }
}
