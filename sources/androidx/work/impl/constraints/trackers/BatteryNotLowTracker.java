...
public final class BatteryNotLowTracker extends BroadcastReceiverConstraintTracker<Boolean> {
    ...
    public Boolean readSystemState() {
        ...
        int intExtra = intentRegisterReceiver.getIntExtra(UpdateKey.STATUS, -1);
