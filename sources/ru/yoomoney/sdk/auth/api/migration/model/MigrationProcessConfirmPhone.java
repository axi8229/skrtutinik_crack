...
public final /* data */ class MigrationProcessConfirmPhone extends MigrationProcess {
    ...
    public MigrationProcessConfirmPhone(String id, OffsetDateTime expireAt, boolean z, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int i, String phone, int i2) {
        super(null);
    ...
    public final MigrationProcessConfirmPhone copy(String id, OffsetDateTime expireAt, boolean addToBackStack, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int secretLength, String phone, int attemptsLeft) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(expireAt, "expireAt");
        Intrinsics.checkNotNullParameter(validUntil, "validUntil");
        Intrinsics.checkNotNullParameter(nextResendFrom, "nextResendFrom");
        Intrinsics.checkNotNullParameter(phone, "phone");
        return new MigrationProcessConfirmPhone(id, expireAt, addToBackStack, validUntil, nextResendFrom, secretLength, phone, attemptsLeft);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MigrationProcessConfirmPhone)) {
            return false;
        }
        MigrationProcessConfirmPhone migrationProcessConfirmPhone = (MigrationProcessConfirmPhone) other;
        return Intrinsics.areEqual(this.id, migrationProcessConfirmPhone.id) && Intrinsics.areEqual(this.expireAt, migrationProcessConfirmPhone.expireAt) && this.addToBackStack == migrationProcessConfirmPhone.addToBackStack && Intrinsics.areEqual(this.validUntil, migrationProcessConfirmPhone.validUntil) && Intrinsics.areEqual(this.nextResendFrom, migrationProcessConfirmPhone.nextResendFrom) && this.secretLength == migrationProcessConfirmPhone.secretLength && Intrinsics.areEqual(this.phone, migrationProcessConfirmPhone.phone) && this.attemptsLeft == migrationProcessConfirmPhone.attemptsLeft;
    }
    ...
    public String toString() {
        return "MigrationProcessConfirmPhone(id=" + this.id + ", expireAt=" + this.expireAt + ", addToBackStack=" + this.addToBackStack + ", validUntil=" + this.validUntil + ", nextResendFrom=" + this.nextResendFrom + ", secretLength=" + this.secretLength + ", phone=" + this.phone + ", attemptsLeft=" + this.attemptsLeft + ")";
    }
}
