...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m703setColorDxMtmZc(long color, float alpha) {
        long jM702calculateRippleColor5vOe2sY = m702calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m977equalsimpl0(color2.getValue(), jM702calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m971boximpl(jM702calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m996toArgb8_81llA(jM702calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m702calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m975copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
