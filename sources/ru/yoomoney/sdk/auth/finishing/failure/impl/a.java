...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.finishing.failure.impl.AuthFinishingFailureBusinessLogic$handleContentState$1$1", f = "AuthFinishingFailureBusinessLogic.kt", l = {42}, m = "invokeSuspend")
...
public final class a extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public a(AuthFinishingFailureBusinessLogic authFinishingFailureBusinessLogic, Continuation<? super a> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AuthFinishingFailure.Effect.Finish finish = AuthFinishingFailure.Effect.Finish.INSTANCE;
            this.a = 1;
