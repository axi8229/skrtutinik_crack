...
public class MediaConfig extends PersistentObject {
        ...
        try {
            ...
            if (j != 0) {
                if (this.swigCMemOwn) {
                    ...
                    pjsua2JNI.delete_MediaConfig(j);
                }
                this.swigCPtr = 0L;
            }
            super.delete();
    ...
    public void setJbDiscardAlgo(SWIGTYPE_p_pjmedia_jb_discard_algo sWIGTYPE_p_pjmedia_jb_discard_algo) {
        pjsua2JNI.MediaConfig_jbDiscardAlgo_set(this.swigCPtr, this, SWIGTYPE_p_pjmedia_jb_discard_algo.getCPtr(sWIGTYPE_p_pjmedia_jb_discard_algo));
    }

    public SWIGTYPE_p_pjmedia_jb_discard_algo getJbDiscardAlgo() {
        return new SWIGTYPE_p_pjmedia_jb_discard_algo(pjsua2JNI.MediaConfig_jbDiscardAlgo_get(this.swigCPtr, this), true);
    }
