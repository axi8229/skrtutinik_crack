...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        int iM1790getMinimpl = TextRange.m1790getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(iM1790getMinimpl, TextRange.m1789getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, iM1790getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int iM1789getMaximpl = composition2 != null ? TextRange.m1789getMaximpl(composition2.getPackedValue()) : -1;
            if (iM1790getMinimpl2 >= 0 && iM1790getMinimpl2 < iM1789getMaximpl) {
                builder.setComposingText(iM1790getMinimpl2, textFieldValue.getText().subSequence(iM1790getMinimpl2, iM1789getMaximpl));
                addCharacterBounds(builder, iM1790getMinimpl2, iM1789getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
    ...
    private static final CursorAnchorInfo.Builder setInsertionMarker(CursorAnchorInfo.Builder builder, int i, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        float fCoerceIn = RangesKt.coerceIn(cursorRect.getLeft(), 0.0f, IntSize.m2156getWidthimpl(textLayoutResult.getSize()));
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, androidx.compose.ui.text.input.OffsetMapping r20, androidx.compose.ui.text.TextLayoutResult r21, androidx.compose.ui.geometry.Rect r22) {
        /*
            ...
            r5 = 0
            r7.m1711fillBoundingBoxes8ffj60Q(r8, r6, r5)
        L22:
            if (r2 >= r0) goto L8e
