...
public final class UIntSerializer extends StdSerializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ void serialize(Object obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        m2315serializeOzbTUA(((UInt) obj).getData(), jsonGenerator, serializerProvider);
    }

    /* renamed from: serialize-OzbTU-A, reason: not valid java name */
    public void m2315serializeOzbTUA(int value, JsonGenerator gen, SerializerProvider provider) throws IOException {
