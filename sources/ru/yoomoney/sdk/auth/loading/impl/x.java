...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.loading.impl.AuthLoadingBusinessLogic$handleSocialAccountAuthState$2$1", f = "AuthLoadingBusinessLogic.kt", l = {166}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class x extends SuspendLambda implements Function1<Continuation<? super AuthLoading.Action>, Object> {
    public int a;
    ...
    public x(AuthLoadingBusinessLogic authLoadingBusinessLogic, Out.Builder<AuthLoading.State.Progress, AuthLoading.Action> builder, Continuation<? super x> continuation) {
