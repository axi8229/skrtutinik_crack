...
public final class PathParserKt {
    ...
    public static final Path toPath(List<? extends PathNode> list, Path path) {
        ...
        Path path2 = path;
        int iMo921getFillTypeRgk1Os = path.mo921getFillTypeRgk1Os();
        path.rewind();
        path2.mo923setFillTypeoQ8Xj4U(iMo921getFillTypeRgk1Os);
                            ...
                            if (pathNode3 instanceof PathNode.RelativeHorizontalTo) {
                                ...
                                if (pathNode3 instanceof PathNode.RelativeCurveTo) {
                                    ...
                                    if (pathNode3 instanceof PathNode.CurveTo) {
                                        ...
                                        f = 0.0f;
                                        i2 = size;
                                        drawArc(path, arcStartX, y, arcStartDx, arcStartDy, relativeArcTo.getHorizontalEllipseRadius(), relativeArcTo.getVerticalEllipseRadius(), relativeArcTo.getTheta(), relativeArcTo.getIsMoreThanHalf(), relativeArcTo.getIsPositiveArc());
                                        ...
                                        if (pathNode instanceof PathNode.ArcTo) {
                                            ...
                                            drawArc(path, arcStartX, y, arcTo.getArcStartX(), arcTo.getArcStartY(), arcTo.getHorizontalEllipseRadius(), arcTo.getVerticalEllipseRadius(), arcTo.getTheta(), arcTo.getIsMoreThanHalf(), arcTo.getIsPositiveArc());
    ...
    private static final void drawArc(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, boolean z, boolean z2) {
        double d8;
        double d9;
        double d10 = (d7 / pjsip_status_code.PJSIP_SC_RINGING) * 3.141592653589793d;
        ...
        if (d21 < ConfigValue.DOUBLE_DEFAULT_VALUE) {
