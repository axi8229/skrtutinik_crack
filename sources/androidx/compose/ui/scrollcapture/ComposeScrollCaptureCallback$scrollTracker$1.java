    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (scrollCaptureScrollByAction != null) {
                ...
                Offset offsetM833boximpl = Offset.m833boximpl(OffsetKt.Offset(0.0f, f));
                this.Z$0 = reverseScrolling;
                this.label = 1;
                obj = scrollCaptureScrollByAction.invoke(offsetM833boximpl, this);
        ...
        float fM843getYimpl = Offset.m843getYimpl(((Offset) obj).getPackedValue());
        if (z) {
            fM843getYimpl = -fM843getYimpl;
        }
        return Boxing.boxFloat(fM843getYimpl);
    }
}
