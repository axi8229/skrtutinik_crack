...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo2742getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = mo2742getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo2742getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo2742getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor = mo2742getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor2 = typeConstructor.mo2742getDeclarationDescriptor();
        if (classifierDescriptorMo2742getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo2742getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo2742getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo2742getDeclarationDescriptor2);
        }
        return false;
    }
