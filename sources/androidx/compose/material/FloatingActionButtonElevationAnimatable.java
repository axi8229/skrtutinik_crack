...
final class FloatingActionButtonElevationAnimatable {
    ...
    @DebugMetadata(c = "androidx.compose.material.FloatingActionButtonElevationAnimatable", f = "FloatingActionButton.kt", l = {395}, m = "animateElevation")
    ...
    private FloatingActionButtonElevationAnimatable(float f, float f2, float f3, float f4) {
        ...
        this.animatable = new Animatable<>(Dp.m2100boximpl(this.defaultElevation), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
    }

    /* renamed from: calculateTarget-u2uoSUM, reason: not valid java name */
    private final float m644calculateTargetu2uoSUM(Interaction interaction) {
    ...
    public final Object m645updateElevationlDy3nrA(float f, float f2, float f3, float f4, Continuation<? super Unit> continuation) throws Throwable {
        this.defaultElevation = f;
        this.pressedElevation = f2;
        this.hoveredElevation = f3;
        this.focusedElevation = f4;
    ...
    */
    public final java.lang.Object snapElevation(kotlin.coroutines.Continuation<? super kotlin.Unit> r5) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r5 instanceof androidx.compose.material.FloatingActionButtonElevationAnimatable.C04251
            if (r0 == 0) goto L13
            r0 = r5
            androidx.compose.material.FloatingActionButtonElevationAnimatable$snapElevation$1 r0 = (androidx.compose.material.FloatingActionButtonElevationAnimatable.C04251) r0
            int r1 = r0.label
        ...
        L37:
            ...
            float r5 = r4.m644calculateTargetu2uoSUM(r5)
            ...
            boolean r2 = androidx.compose.ui.unit.Dp.m2104equalsimpl0(r2, r5)
            if (r2 != 0) goto L70
            ...
            androidx.compose.ui.unit.Dp r5 = androidx.compose.ui.unit.Dp.m2100boximpl(r5)     // Catch: java.lang.Throwable -> L69
    ...
    */
    public final java.lang.Object animateElevation(androidx.compose.foundation.interaction.Interaction r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) throws java.lang.Throwable {
        ...
        L3b:
            ...
            float r7 = r5.m644calculateTargetu2uoSUM(r6)
            ...
            boolean r2 = androidx.compose.ui.unit.Dp.m2104equalsimpl0(r2, r7)     // Catch: java.lang.Throwable -> L67
            if (r2 != 0) goto L6a
            androidx.compose.animation.core.Animatable<androidx.compose.ui.unit.Dp, androidx.compose.animation.core.AnimationVector1D> r2 = r5.animatable     // Catch: java.lang.Throwable -> L67
            ...
            java.lang.Object r7 = androidx.compose.material.ElevationKt.m635animateElevationrAjV9yQ(r2, r7, r4, r6, r0)     // Catch: java.lang.Throwable -> L67
            if (r7 != r1) goto L6a
            return r1
        L67:
            r7 = move-exception
