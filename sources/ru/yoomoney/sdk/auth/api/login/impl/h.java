...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.api.login.impl.LoginEnterBusinessLogic$handleProgressState$1$1", f = "LoginEnterBusinessLogic.kt", l = {65}, m = "invokeSuspend")
...
public final class h extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public h(LoginEnterBusinessLogic loginEnterBusinessLogic, LoginEnter.Action action, Continuation<? super h> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            LoginEnter.Effect.ShowNextStep showNextStep = new LoginEnter.Effect.ShowNextStep(((LoginEnter.Action.EnterIdentifierSuccess) this.c).getProcess());
            this.a = 1;
