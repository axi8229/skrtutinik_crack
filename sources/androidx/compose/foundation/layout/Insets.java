...
final class Insets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo248roundToPx0680j_4(this.left);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo248roundToPx0680j_4(this.top);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo248roundToPx0680j_4(this.right);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo248roundToPx0680j_4(this.bottom);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m2106toStringimpl(this.left)) + ", top=" + ((Object) Dp.m2106toStringimpl(this.top)) + ", right=" + ((Object) Dp.m2106toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m2106toStringimpl(this.bottom)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m2104equalsimpl0(this.left, insets.left) && Dp.m2104equalsimpl0(this.top, insets.top) && Dp.m2104equalsimpl0(this.right, insets.right) && Dp.m2104equalsimpl0(this.bottom, insets.bottom);
    }

    public int hashCode() {
        return (((((Dp.m2105hashCodeimpl(this.left) * 31) + Dp.m2105hashCodeimpl(this.top)) * 31) + Dp.m2105hashCodeimpl(this.right)) * 31) + Dp.m2105hashCodeimpl(this.bottom);
    }
}
