...
public final class IconValuePrimaryView extends IconValueView {
    public /* synthetic */ IconValuePrimaryView(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i2 & 2) != 0 ? null : attributeSet, (i2 & 4) != 0 ? R$attr.ym_ListVectorPrimaryView_Style : i);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IconValuePrimaryView(Context context, AttributeSet attributeSet, int i) {
