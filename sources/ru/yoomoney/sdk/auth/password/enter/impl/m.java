...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.password.enter.impl.PasswordEnterBusinessLogic$handleProgressState$3$1", f = "PasswordEnterBusinessLogic.kt", l = {73}, m = "invokeSuspend")
...
public final class m extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public m(PasswordEnterBusinessLogic passwordEnterBusinessLogic, PasswordEnter.Action action, Continuation<? super m> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PasswordEnter.Effect.ShowFailure showFailure = new PasswordEnter.Effect.ShowFailure(((PasswordEnter.Action.PasswordEnterFailure) this.c).getFailure());
            this.a = 1;
