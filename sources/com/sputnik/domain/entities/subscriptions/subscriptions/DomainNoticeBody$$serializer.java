...
/* compiled from: DomainNoticeBody.kt */
...
public final class DomainNoticeBody$$serializer implements GeneratedSerializer<DomainNoticeBody> {
    public static final DomainNoticeBody$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        DomainNoticeBody$$serializer domainNoticeBody$$serializer = new DomainNoticeBody$$serializer();
        INSTANCE = domainNoticeBody$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sputnik.domain.entities.subscriptions.subscriptions.DomainNoticeBody", domainNoticeBody$$serializer, 1);
        pluginGeneratedSerialDescriptor.addElement("body", false);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private DomainNoticeBody$$serializer() {
    }
    ...
    public DomainNoticeBody deserialize(Decoder decoder) {
        String str;
        ...
        return new DomainNoticeBody(i, str, null);
    }
    ...
    public void serialize(Encoder encoder, DomainNoticeBody value) {
