    ...
    public static final String getDesc(Class<?> cls) {
        ...
        if (!cls.isPrimitive()) {
            if (cls.isArray()) {
                ...
                return StringsKt.replace$default(name, '.', JsonPointer.SEPARATOR, false, 4, (Object) null);
            }
            StringBuilder sb = new StringBuilder();
            sb.append('L');
            String name2 = cls.getName();
            Intrinsics.checkNotNullExpressionValue(name2, "getName(...)");
            sb.append(StringsKt.replace$default(name2, '.', JsonPointer.SEPARATOR, false, 4, (Object) null));
            sb.append(';');
            return sb.toString();
        }
