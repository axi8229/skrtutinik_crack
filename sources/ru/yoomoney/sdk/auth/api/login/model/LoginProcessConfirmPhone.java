...
public final /* data */ class LoginProcessConfirmPhone extends LoginProcess {
    ...
    public LoginProcessConfirmPhone(String id, OffsetDateTime expireAt, boolean z, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int i, String phone, int i2) {
        super(null);
    ...
    public final LoginProcessConfirmPhone copy(String id, OffsetDateTime expireAt, boolean addToBackStack, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int secretLength, String phone, int attemptsLeft) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(expireAt, "expireAt");
        Intrinsics.checkNotNullParameter(validUntil, "validUntil");
        Intrinsics.checkNotNullParameter(nextResendFrom, "nextResendFrom");
        Intrinsics.checkNotNullParameter(phone, "phone");
        return new LoginProcessConfirmPhone(id, expireAt, addToBackStack, validUntil, nextResendFrom, secretLength, phone, attemptsLeft);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LoginProcessConfirmPhone)) {
            return false;
        }
        LoginProcessConfirmPhone loginProcessConfirmPhone = (LoginProcessConfirmPhone) other;
        return Intrinsics.areEqual(this.id, loginProcessConfirmPhone.id) && Intrinsics.areEqual(this.expireAt, loginProcessConfirmPhone.expireAt) && this.addToBackStack == loginProcessConfirmPhone.addToBackStack && Intrinsics.areEqual(this.validUntil, loginProcessConfirmPhone.validUntil) && Intrinsics.areEqual(this.nextResendFrom, loginProcessConfirmPhone.nextResendFrom) && this.secretLength == loginProcessConfirmPhone.secretLength && Intrinsics.areEqual(this.phone, loginProcessConfirmPhone.phone) && this.attemptsLeft == loginProcessConfirmPhone.attemptsLeft;
    }
    ...
    public String toString() {
        return "LoginProcessConfirmPhone(id=" + this.id + ", expireAt=" + this.expireAt + ", addToBackStack=" + this.addToBackStack + ", validUntil=" + this.validUntil + ", nextResendFrom=" + this.nextResendFrom + ", secretLength=" + this.secretLength + ", phone=" + this.phone + ", attemptsLeft=" + this.attemptsLeft + ")";
    }
}
