...
public final /* data */ class ShadowGraphicsLayerElement extends ModifierNodeElement<BlockGraphicsLayerModifier> {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m2104equalsimpl0(this.elevation, shadowGraphicsLayerElement.elevation) && Intrinsics.areEqual(this.shape, shadowGraphicsLayerElement.shape) && this.clip == shadowGraphicsLayerElement.clip && Color.m977equalsimpl0(this.ambientColor, shadowGraphicsLayerElement.ambientColor) && Color.m977equalsimpl0(this.spotColor, shadowGraphicsLayerElement.spotColor);
    }

    public int hashCode() {
        return (((((((Dp.m2105hashCodeimpl(this.elevation) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31) + Color.m983hashCodeimpl(this.ambientColor)) * 31) + Color.m983hashCodeimpl(this.spotColor);
    }

    public String toString() {
        return "ShadowGraphicsLayerElement(elevation=" + ((Object) Dp.m2106toStringimpl(this.elevation)) + ", shape=" + this.shape + ", clip=" + this.clip + ", ambientColor=" + ((Object) Color.m984toStringimpl(this.ambientColor)) + ", spotColor=" + ((Object) Color.m984toStringimpl(this.spotColor)) + ')';
    }
    ...
    private final Function1<GraphicsLayerScope, Unit> createBlock() {
        return new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowGraphicsLayerElement.createBlock.1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                graphicsLayerScope.setShadowElevation(graphicsLayerScope.mo254toPx0680j_4(ShadowGraphicsLayerElement.this.getElevation()));
                ...
                graphicsLayerScope.mo1016setAmbientShadowColor8_81llA(ShadowGraphicsLayerElement.this.getAmbientColor());
                graphicsLayerScope.mo1018setSpotShadowColor8_81llA(ShadowGraphicsLayerElement.this.getSpotColor());
            }
        };
    }
