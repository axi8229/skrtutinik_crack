...
public final class TextFieldSelectionManagerKt {
    ...
    public static final void TextFieldSelectionHandle(final boolean z, final ResolvedTextDirection resolvedTextDirection, final TextFieldSelectionManager textFieldSelectionManager, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (zChangedInstance || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = new OffsetProvider() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$TextFieldSelectionHandle$1$1
                    ...
                    public final long mo409provideF1C5BW0() {
                        return textFieldSelectionManager.m583getHandlePositiontuRUvjQ$foundation_release(z);
                    }
                };
                composerStartRestartGroup.updateRememberedValue(objRememberedValue2);
            }
            OffsetProvider offsetProvider = (OffsetProvider) objRememberedValue2;
            boolean zM1791getReversedimpl = TextRange.m1791getReversedimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
            ...
            AndroidSelectionHandles_androidKt.m559SelectionHandlepzduO1o(offsetProvider, z, resolvedTextDirection, zM1791getReversedimpl, 0L, SuspendingPointerInputFilterKt.pointerInput(companion, textDragObserver, (Function2) objRememberedValue3), composerStartRestartGroup, (i2 << 3) & 1008, 16);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final boolean isSelectionHandleInVisibleBound(TextFieldSelectionManager textFieldSelectionManager, boolean z) {
        ...
        return SelectionManagerKt.m570containsInclusiveUv8p0NA(rectVisibleBounds, textFieldSelectionManager.m583getHandlePositiontuRUvjQ$foundation_release(z));
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c, reason: not valid java name */
    public static final long m586calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager textFieldSelectionManager, long j) {
        int iM1792getStartimpl;
        TextLayoutResultProxy layoutResult;
        TextDelegate textDelegate;
        AnnotatedString text;
        Offset offsetM581getCurrentDragPosition_m7T9E = textFieldSelectionManager.m581getCurrentDragPosition_m7T9E();
        if (offsetM581getCurrentDragPosition_m7T9E == null) {
            return Offset.INSTANCE.m853getUnspecifiedF1C5BW0();
        }
        long packedValue = offsetM581getCurrentDragPosition_m7T9E.getPackedValue();
        ...
        if (i == 1 || i == 2) {
            iM1792getStartimpl = TextRange.m1792getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
        } else {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            iM1792getStartimpl = TextRange.m1787getEndimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
        }
        LegacyTextFieldState state = textFieldSelectionManager.getState();
        ...
        int iCoerceIn = RangesKt.coerceIn(textFieldSelectionManager.getOffsetMapping().originalToTransformed(iM1792getStartimpl), 0, text.length());
        float fM842getXimpl = Offset.m842getXimpl(layoutResult.m489translateDecorationToInnerCoordinatesMKHz9U$foundation_release(packedValue));
        ...
        float fCoerceIn = RangesKt.coerceIn(fM842getXimpl, Math.min(lineLeft, lineRight), Math.max(lineLeft, lineRight));
        if (!IntSize.m2154equalsimpl0(j, IntSize.INSTANCE.m2160getZeroYbymL2g()) && Math.abs(fM842getXimpl - fCoerceIn) > IntSize.m2156getWidthimpl(j) / 2) {
            return Offset.INSTANCE.m853getUnspecifiedF1C5BW0();
        }
