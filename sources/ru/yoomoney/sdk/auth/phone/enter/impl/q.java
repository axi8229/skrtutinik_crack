...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.phone.enter.impl.PhoneEnterBusinessLogic$handleLoadingState$2$1", f = "PhoneEnterBusinessLogic.kt", l = {125}, m = "invokeSuspend")
...
public final class q extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public q(PhoneEnterBusinessLogic phoneEnterBusinessLogic, PhoneEnter.Action action, Continuation<? super q> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            PhoneEnter.Effect.ShowNextRegistrationStep showNextRegistrationStep = new PhoneEnter.Effect.ShowNextRegistrationStep(((PhoneEnter.Action.RegistrationPhoneSetSuccess) this.c).getProcess());
            this.a = 1;
