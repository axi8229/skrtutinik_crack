...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.auxToken.impl.AuxTokenIssueBusinessLogic$handleLoadingAuxAuthorizationInfoState$1$1", f = "AuxTokenIssueBusinessLogic.kt", l = {35}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class h extends SuspendLambda implements Function1<Continuation<? super AuxTokenIssue.Action>, Object> {
    public int a;
    public final /* synthetic */ AuxTokenIssueBusinessLogic b;
    public final /* synthetic */ AuxTokenIssue.Action c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(AuxTokenIssueBusinessLogic auxTokenIssueBusinessLogic, AuxTokenIssue.Action action, Continuation<? super h> continuation) {
