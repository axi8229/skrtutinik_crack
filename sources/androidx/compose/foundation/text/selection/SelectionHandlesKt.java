...
public final class SelectionHandlesKt {
    ...
    public static final long m563getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m842getXimpl(j), Offset.m843getYimpl(j) - 1.0f);
    }
    ...
    static {
        float f = 25;
        HandleWidth = Dp.m2102constructorimpl(f);
        HandleHeight = Dp.m2102constructorimpl(f);
    }
