...
public final class KeyEvent {
    ...
    public static final /* synthetic */ KeyEvent m1282boximpl(android.view.KeyEvent keyEvent) {
        return new KeyEvent(keyEvent);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static android.view.KeyEvent m1283constructorimpl(android.view.KeyEvent keyEvent) {
        return keyEvent;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1284equalsimpl(android.view.KeyEvent keyEvent, Object obj) {
        return (obj instanceof KeyEvent) && Intrinsics.areEqual(keyEvent, ((KeyEvent) obj).getNativeKeyEvent());
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1285hashCodeimpl(android.view.KeyEvent keyEvent) {
        return keyEvent.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1286toStringimpl(android.view.KeyEvent keyEvent) {
        return "KeyEvent(nativeKeyEvent=" + keyEvent + ')';
    }

    public boolean equals(Object obj) {
        return m1284equalsimpl(this.nativeKeyEvent, obj);
    }

    public int hashCode() {
        return m1285hashCodeimpl(this.nativeKeyEvent);
    }

    public String toString() {
        return m1286toStringimpl(this.nativeKeyEvent);
    }
