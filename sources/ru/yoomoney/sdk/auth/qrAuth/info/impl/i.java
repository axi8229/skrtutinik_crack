...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.qrAuth.info.impl.QrAuthInfoBusinessLogic$handStateErrorInfo$1$2", f = "QrAuthInfoBusinessLogic.kt", l = {90}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class i extends SuspendLambda implements Function1<Continuation<? super QrAuthInfo.Action>, Object> {
    public int a;
    public final /* synthetic */ QrAuthInfoBusinessLogic b;
    public final /* synthetic */ QrAuthInfo.Action c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(QrAuthInfoBusinessLogic qrAuthInfoBusinessLogic, QrAuthInfo.Action action, Continuation<? super i> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            String processId = ((QrAuthInfo.Action.LoadInfo) this.c).getProcessId();
            this.a = 1;
