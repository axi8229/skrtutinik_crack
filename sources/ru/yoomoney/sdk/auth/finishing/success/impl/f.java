...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.finishing.success.impl.AuthFinishingSuccessBusinessLogic$handleErrorAcquireState$1$2", f = "AuthFinishingSuccessBusinessLogic.kt", l = {108}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class f extends SuspendLambda implements Function1<Continuation<? super AuthFinishingSuccess.Action>, Object> {
    public int a;
    ...
    public f(AuthFinishingSuccessBusinessLogic authFinishingSuccessBusinessLogic, AuthFinishingSuccess.Action action, Continuation<? super f> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AuthFinishingSuccess.Action.LoadAcquire loadAcquire = (AuthFinishingSuccess.Action.LoadAcquire) this.c;
            this.a = 1;
