...
final class ChronoZonedDateTimeImpl<D extends ChronoLocalDate> extends ChronoZonedDateTime<D> implements Serializable {
    ...
    private ChronoZonedDateTimeImpl(ChronoLocalDateTimeImpl<D> chronoLocalDateTimeImpl, ZoneOffset zoneOffset, ZoneId zoneId) {
        ...
        this.f53zone = (ZoneId) Jdk8Methods.requireNonNull(zoneId, "zone");
    }
    ...
    public ChronoZonedDateTime<D> withEarlierOffsetAtOverlap() {
        ...
        if (transition != null && transition.isOverlap()) {
            ...
            if (!offsetBefore.equals(this.offset)) {
                return new ChronoZonedDateTimeImpl(this.dateTime, offsetBefore, this.f53zone);
            }
        }
        return this;
    }
    ...
    public ChronoZonedDateTime<D> withLaterOffsetAtOverlap() {
        ...
        if (transition != null) {
            ...
            if (!offsetAfter.equals(getOffset())) {
                return new ChronoZonedDateTimeImpl(this.dateTime, offsetAfter, this.f53zone);
            }
        }
        return this;
    }
    ...
    public ChronoZonedDateTime<D> withZoneSameInstant(ZoneId zoneId) {
        Jdk8Methods.requireNonNull(zoneId, "zone");
        return this.f53zone.equals(zoneId) ? this : create(this.dateTime.toInstant(this.offset), zoneId);
    }
    ...
    public ChronoZonedDateTime<D> with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
            ...
            if (i == 2) {
                return create(this.dateTime.toInstant(ZoneOffset.ofTotalSeconds(chronoField.checkValidIntValue(j))), this.f53zone);
            }
            return ofBest(this.dateTime.with(temporalField, j), this.f53zone, this.offset);
        }
    ...
    void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeObject(this.f53zone);
    }
