...
public final class UnsignedTypes {
    ...
    public static final boolean isUnsignedType(KotlinType type) {
        ClassifierDescriptor classifierDescriptorMo2742getDeclarationDescriptor;
        Intrinsics.checkNotNullParameter(type, "type");
        if (TypeUtils.noExpectedType(type) || (classifierDescriptorMo2742getDeclarationDescriptor = type.getConstructor().mo2742getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(classifierDescriptorMo2742getDeclarationDescriptor);
    }
