...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f46me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f46me.tracker = VelocityTracker.obtain();
            return f46me;
        }
    ...
    public void setTransition(int beginId, int endId) {
        ...
        this.mScene.getConstraintSet(beginId);
        this.mScene.getConstraintSet(endId);
        throw null;
    }
    ...
    public void touchAnimateTo(int touchUpMode, float position, float currentVelocity) {
        ...
        if (touchUpMode != 0 && touchUpMode != 1 && touchUpMode != 2) {
            if (touchUpMode == 4) {
                this.mScene.getMaxAcceleration();
                throw null;
            }
            if (touchUpMode == 5) {
        ...
        this.mScene.getSpringMass();
        this.mScene.getSpringStiffiness();
        this.mScene.getSpringDamping();
        this.mScene.getSpringStopThreshold();
        this.mScene.getSpringBoundary();
        throw null;
    }
    ...
    public void transitionToState(int id, int screenWidth, int screenHeight, int duration) {
        ...
        this.mInTransition = true;
        this.mScene.getConstraintSet(id);
        throw null;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (z2) {
            if (this.mBeginState != -1) {
                super.onMeasure(widthMeasureSpec, heightMeasureSpec);
                this.mScene.getConstraintSet(startId);
                this.mScene.getConstraintSet(endId);
                throw null;
            }
            if (z2) {
    ...
    private void evaluateLayout() {
        ...
        float interpolation = this.mTransitionLastPosition + ((((nanoTime - this.mTransitionLastTime) * fSignum) * 1.0E-9f) / this.mTransitionDuration);
    ...
    void evaluate(boolean force) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (force || this.mTransitionGoalPosition != f))) {
            ...
            long nanoTime = getNanoTime();
            Interpolator interpolator = this.mInterpolator;
            float f2 = !(interpolator instanceof MotionInterpolator) ? (((nanoTime - this.mTransitionLastTime) * fSignum) * 1.0E-9f) / this.mTransitionDuration : 0.0f;
            ...
            if (interpolator != null && !z) {
                if (this.mTemporalInterpolator) {
                    ...
                    if (interpolator3 instanceof MotionInterpolator) {
                        ...
                        this.mLastVelocity = ((interpolator3.getInterpolation(f3 + f2) - interpolation) * fSignum) / f2;
                    }
                }
                f3 = interpolation;
            } else {
            ...
            if (interpolator5 != null) {
                float interpolation3 = interpolator5.getInterpolation((fSignum / this.mTransitionDuration) + f3);
