...
final class SingleSampleMediaPeriod implements MediaPeriod, Loader.Callback<SourceLoadable> {
    ...
    public Loader.LoadErrorAction onLoadError(SourceLoadable loadable, long elapsedRealtimeMs, long loadDurationMs, IOException error, int errorCount) {
        ...
        long retryDelayMsFor = this.loadErrorHandlingPolicy.getRetryDelayMsFor(1, loadDurationMs, error, errorCount);
        boolean z = retryDelayMsFor == -9223372036854775807L || errorCount >= this.loadErrorHandlingPolicy.getMinimumLoadableRetryCount(1);
        ...
        this.eventDispatcher.loadError(loadable.dataSpec, loadable.dataSource.getLastOpenedUri(), loadable.dataSource.getLastResponseHeaders(), 1, -1, this.format, 0, null, 0L, this.durationUs, elapsedRealtimeMs, loadDurationMs, loadable.dataSource.getBytesRead(), error, !loadErrorActionCreateRetryAction.isRetry());
