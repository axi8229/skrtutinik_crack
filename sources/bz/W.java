...
public final class W extends AbstractC0538n1 implements A0 {
    public final Context c;
    public final Z0 d;
    public final LocationManager e;
    public final zone.bi.mobile.fingerprint.api.b f;

    public W(Context context, Z0 z0, LocationManager locationManager, zone.bi.mobile.fingerprint.api.b bVar) {
    ...
    public final Serializable h() throws e2 {
        ...
        String strValueOf = String.valueOf(locationB.getTime());
        a(strValueOf);
        return strValueOf;
    }
}
