...
public class TransitionManager {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo2245clone = transition.mo2245clone();
        sceneChangeSetup(viewGroup, transitionMo2245clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo2245clone);
    }
    ...
    public static TransitionSeekController controlDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo2245clone);
