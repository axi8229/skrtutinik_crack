...
public final class LegacyProtoKey extends Key {
    ...
    private static void throwIfMissingAccess(ProtoKeySerialization protoKeySerialization, SecretKeyAccess access) throws GeneralSecurityException {
    ...
    public LegacyProtoKey(ProtoKeySerialization serialization, SecretKeyAccess access) throws GeneralSecurityException {
    ...
    public ProtoKeySerialization getSerialization(SecretKeyAccess access) throws GeneralSecurityException {
