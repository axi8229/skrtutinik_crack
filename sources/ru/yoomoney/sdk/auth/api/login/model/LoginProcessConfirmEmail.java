...
public final /* data */ class LoginProcessConfirmEmail extends LoginProcess {
    ...
    public LoginProcessConfirmEmail(String id, OffsetDateTime expireAt, boolean z, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int i, int i2, String email) {
        super(null);
    ...
    public final LoginProcessConfirmEmail copy(String id, OffsetDateTime expireAt, boolean addToBackStack, OffsetDateTime validUntil, OffsetDateTime nextResendFrom, int secretLength, int attemptsLeft, String email) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(expireAt, "expireAt");
        Intrinsics.checkNotNullParameter(validUntil, "validUntil");
        Intrinsics.checkNotNullParameter(nextResendFrom, "nextResendFrom");
        Intrinsics.checkNotNullParameter(email, "email");
        return new LoginProcessConfirmEmail(id, expireAt, addToBackStack, validUntil, nextResendFrom, secretLength, attemptsLeft, email);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LoginProcessConfirmEmail)) {
            return false;
        }
        LoginProcessConfirmEmail loginProcessConfirmEmail = (LoginProcessConfirmEmail) other;
        return Intrinsics.areEqual(this.id, loginProcessConfirmEmail.id) && Intrinsics.areEqual(this.expireAt, loginProcessConfirmEmail.expireAt) && this.addToBackStack == loginProcessConfirmEmail.addToBackStack && Intrinsics.areEqual(this.validUntil, loginProcessConfirmEmail.validUntil) && Intrinsics.areEqual(this.nextResendFrom, loginProcessConfirmEmail.nextResendFrom) && this.secretLength == loginProcessConfirmEmail.secretLength && this.attemptsLeft == loginProcessConfirmEmail.attemptsLeft && Intrinsics.areEqual(this.email, loginProcessConfirmEmail.email);
    }
    ...
    public String toString() {
        return "LoginProcessConfirmEmail(id=" + this.id + ", expireAt=" + this.expireAt + ", addToBackStack=" + this.addToBackStack + ", validUntil=" + this.validUntil + ", nextResendFrom=" + this.nextResendFrom + ", secretLength=" + this.secretLength + ", attemptsLeft=" + this.attemptsLeft + ", email=" + this.email + ")";
    }
}
