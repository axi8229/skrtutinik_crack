...
@DebugMetadata(c = "ru.yoomoney.sdk.auth.finishing.success.impl.AuthFinishingSuccessBusinessLogic$handleProgressState$8$1", f = "AuthFinishingSuccessBusinessLogic.kt", l = {69}, m = "invokeSuspend")
...
public final class n extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public n(AuthFinishingSuccessBusinessLogic authFinishingSuccessBusinessLogic, AuthFinishingSuccess.Action action, Continuation<? super n> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AuthFinishingSuccess.Effect.ShowNextRegistrationStep showNextRegistrationStep = new AuthFinishingSuccess.Effect.ShowNextRegistrationStep(((AuthFinishingSuccess.Action.NextRegistrationStep) this.c).getProcess());
            this.a = 1;
