...
import com.sputnik.subscriptions.di.SubscriptionsComponent;
import com.sputnik.subscriptions.ui.sheets.BottomSheetAboutService;
import com.sputnik.subscriptions.ui.sheets.BottomSheetAboutService_MembersInjector;
import com.sputnik.subscriptions.ui.sheets.BottomSheetSuccessPayment;
import com.sputnik.subscriptions.ui.sheets.BottomSheetSuccessPayment_MembersInjector;
...
public final class DaggerSubscriptionsComponent {
    ...
    private static final class Builder implements SubscriptionsComponent.Builder {
        private SubscriptionsDeps subscriptionsDeps;

        private Builder() {
        }

        @Override // com.sputnik.subscriptions.di.SubscriptionsComponent.Builder
        public Builder deps(SubscriptionsDeps subscriptionsDeps) {
            this.subscriptionsDeps = (SubscriptionsDeps) Preconditions.checkNotNull(subscriptionsDeps);
            return this;
        }

        @Override // com.sputnik.subscriptions.di.SubscriptionsComponent.Builder
        public SubscriptionsComponent build() {
            Preconditions.checkBuilderRequirement(this.subscriptionsDeps, SubscriptionsDeps.class);
            return new SubscriptionsComponentImpl(new NetworkModule(), new ListMappersModule(), new DomainCommonListMapperModule(), new OnBoardingListMapperModule(), new LocalizationUseCaseModule(), new CountryCodeUseCaseModule(), new ProfileUseCaseModule(), new AlertsUseCaseModule(), new StoriesUseCaseModule(), new PopupStoriesUseCaseModule(), new InvitesUseCaseModule(), new SubscriptionsUseCaseModule(), new PhysicalKeysUseCaseModule(), this.subscriptionsDeps);
        }
    }
    ...
    private static final class SubscriptionsComponentImpl implements SubscriptionsComponent {
        ...
        private void initialize(NetworkModule networkModule, ListMappersModule listMappersModule, DomainCommonListMapperModule domainCommonListMapperModule, OnBoardingListMapperModule onBoardingListMapperModule, LocalizationUseCaseModule localizationUseCaseModule, CountryCodeUseCaseModule countryCodeUseCaseModule, ProfileUseCaseModule profileUseCaseModule, AlertsUseCaseModule alertsUseCaseModule, StoriesUseCaseModule storiesUseCaseModule, PopupStoriesUseCaseModule popupStoriesUseCaseModule, InvitesUseCaseModule invitesUseCaseModule, SubscriptionsUseCaseModule subscriptionsUseCaseModule, PhysicalKeysUseCaseModule physicalKeysUseCaseModule, SubscriptionsDeps subscriptionsDeps) {
            this.getConfigProvider = new GetConfigProvider(subscriptionsDeps);
            this.getApplicationProvider = new GetApplicationProvider(subscriptionsDeps);
            GetPrefManagerProvider getPrefManagerProvider = new GetPrefManagerProvider(subscriptionsDeps);
            ...
            GetLocalizationStorageProvider getLocalizationStorageProvider = new GetLocalizationStorageProvider(subscriptionsDeps);
            ...
            GetAnalyticsProvider getAnalyticsProvider = new GetAnalyticsProvider(subscriptionsDeps);
        ...
        @Override // com.sputnik.subscriptions.di.SubscriptionsComponent
        public void inject(BottomSheetAboutService bottomSheetAboutService) {
            injectBottomSheetAboutService(bottomSheetAboutService);
        }

        @Override // com.sputnik.subscriptions.di.SubscriptionsComponent
        public void inject(BottomSheetSuccessPayment bottomSheetSuccessPayment) {
            injectBottomSheetSuccessPayment(bottomSheetSuccessPayment);
        }

        private BottomSheetAboutService injectBottomSheetAboutService(BottomSheetAboutService bottomSheetAboutService) {
            BottomSheetAboutService_MembersInjector.injectLocalizationStorage(bottomSheetAboutService, (LocalizationStorage) Preconditions.checkNotNullFromComponent(this.subscriptionsDeps.getLocalizationStorage()));
            BottomSheetAboutService_MembersInjector.injectFactory(bottomSheetAboutService, this.multiViewModelFactoryProvider.get());
            BottomSheetAboutService_MembersInjector.injectAnalytics(bottomSheetAboutService, (Analytics) Preconditions.checkNotNullFromComponent(this.subscriptionsDeps.getAnalytics()));
            return bottomSheetAboutService;
        }

        private BottomSheetSuccessPayment injectBottomSheetSuccessPayment(BottomSheetSuccessPayment bottomSheetSuccessPayment) {
            BottomSheetSuccessPayment_MembersInjector.injectLocalizationStorage(bottomSheetSuccessPayment, (LocalizationStorage) Preconditions.checkNotNullFromComponent(this.subscriptionsDeps.getLocalizationStorage()));
            BottomSheetSuccessPayment_MembersInjector.injectFactory(bottomSheetSuccessPayment, this.multiViewModelFactoryProvider.get());
            BottomSheetSuccessPayment_MembersInjector.injectAnalytics(bottomSheetSuccessPayment, (Analytics) Preconditions.checkNotNullFromComponent(this.subscriptionsDeps.getAnalytics()));
            return bottomSheetSuccessPayment;
        }

        private static final class GetConfigProvider implements Provider<IConfig> {
            private final SubscriptionsDeps subscriptionsDeps;

            GetConfigProvider(SubscriptionsDeps subscriptionsDeps) {
                this.subscriptionsDeps = subscriptionsDeps;
            }
            ...
            public IConfig get() {
                return (IConfig) Preconditions.checkNotNullFromComponent(this.subscriptionsDeps.getConfig());
            }
        }
        ...
        private static final class GetApplicationProvider implements Provider<Application> {
            ...
            GetApplicationProvider(SubscriptionsDeps subscriptionsDeps) {
                this.subscriptionsDeps = subscriptionsDeps;
            }
            ...
            public Application get() {
                return (Application) Preconditions.checkNotNullFromComponent(this.subscriptionsDeps.getApplication());
            }
        }
        ...
        private static final class GetPrefManagerProvider implements Provider<PrefManager> {
            ...
            GetPrefManagerProvider(SubscriptionsDeps subscriptionsDeps) {
                this.subscriptionsDeps = subscriptionsDeps;
            }
            ...
            public PrefManager get() {
                return (PrefManager) Preconditions.checkNotNullFromComponent(this.subscriptionsDeps.getPrefManager());
            }
        }
        ...
        private static final class GetLocalizationStorageProvider implements Provider<LocalizationStorage> {
            ...
            GetLocalizationStorageProvider(SubscriptionsDeps subscriptionsDeps) {
                this.subscriptionsDeps = subscriptionsDeps;
            }
            ...
            public LocalizationStorage get() {
                return (LocalizationStorage) Preconditions.checkNotNullFromComponent(this.subscriptionsDeps.getLocalizationStorage());
            }
        }
        ...
        private static final class GetAnalyticsProvider implements Provider<Analytics> {
            ...
            GetAnalyticsProvider(SubscriptionsDeps subscriptionsDeps) {
                this.subscriptionsDeps = subscriptionsDeps;
            }
            ...
            public Analytics get() {
                return (Analytics) Preconditions.checkNotNullFromComponent(this.subscriptionsDeps.getAnalytics());
            }
        }
    }
}
