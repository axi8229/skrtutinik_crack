...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        if (classifierDescriptorMo2742getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : classifierDescriptorMo2742getDeclarationDescriptor instanceof ClassDescriptor ? true : classifierDescriptorMo2742getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(classifierDescriptorMo2742getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo2742getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) throws IOException {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo2742getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo2736getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo2736getUnsubstitutedPrimaryConstructor = annotationClass.mo2736getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo2736getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
        ...
        while (it3.hasNext()) {
            ...
            sb.append(" = ");
            sb.append(!listEmptyList.contains(name2) ? renderConstant(constantValue) : "...");
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo2738getCompileTimeInitializer;
        String strRenderConstant;
        if (!getIncludePropertyConstant() || (constantValueMo2738getCompileTimeInitializer = variableDescriptor.mo2738getCompileTimeInitializer()) == null || (strRenderConstant = renderConstant(constantValueMo2738getCompileTimeInitializer)) == null) {
            return;
        }
        sb.append(" = ");
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) throws IOException {
        ...
        if (!getStartFromName()) {
            ...
            renderModifier(sb, getModifiers().contains(DescriptorRendererModifier.DATA) && classDescriptor.isData(), RemoteMessageConst.DATA);
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo2736getUnsubstitutedPrimaryConstructor = classDescriptor.mo2736getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, classConstructorDescriptorMo2736getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo2736getUnsubstitutedPrimaryConstructor.getVisibility();
            ...
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, classConstructorDescriptorMo2736getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) throws IOException {
        ...
        if (collectionMo2743getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo2743getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo2743getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt___CollectionsKt.joinTo(collectionMo2743getSupertypes, sb, (124 & 2) != 0 ? ", " : ", ", (124 & 4) != 0 ? "" : null, (124 & 8) == 0 ? null : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderSuperTypes.1
            {
                super(1);
            }
