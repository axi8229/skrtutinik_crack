...
final class StateLayer {
    ...
    /* compiled from: Ripple.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.material.ripple.StateLayer$handleInteraction$2", f = "Ripple.kt", l = {pjsip_status_code.PJSIP_SC_USE_PROXY}, m = "invokeSuspend")
    ...
    public final void m701drawStateLayerH2RKhps(DrawScope drawScope, float f, long j) {
        float fMo254toPx0680j_4;
        if (Float.isNaN(f)) {
            fMo254toPx0680j_4 = RippleAnimationKt.m692getRippleEndRadiuscSwnlzA(drawScope, this.bounded, drawScope.mo1176getSizeNHjbRc());
        } else {
            fMo254toPx0680j_4 = drawScope.mo254toPx0680j_4(f);
        }
        float f2 = fMo254toPx0680j_4;
        float fFloatValue = this.animatedAlpha.getValue().floatValue();
        if (fFloatValue > 0.0f) {
            long jM975copywmQWz5c$default = Color.m975copywmQWz5c$default(j, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m1166drawCircleVaOC9Bg$default(drawScope, jM975copywmQWz5c$default, f2, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
