...
public final class AndroidComposeViewAccessibilityDelegateCompat extends AccessibilityDelegateCompat {
    ...
    public final boolean m1596canScroll0AR0LA0$ui_release(boolean vertical, int direction, long position) {
        if (Intrinsics.areEqual(Looper.getMainLooper().getThread(), Thread.currentThread())) {
            return m1595canScrollmoWRBKg(getCurrentSemanticsNodes(), vertical, direction, position);
        }
        return false;
    }
    ...
    */
    private final boolean m1595canScrollmoWRBKg(androidx.collection.IntObjectMap<androidx.compose.ui.platform.SemanticsNodeWithAdjustedBounds> r21, boolean r22, int r23, long r24) {
        /*
            Method dump skipped, instructions count: 237
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat.m1595canScrollmoWRBKg(androidx.collection.IntObjectMap, boolean, int, long):boolean");
    }
    ...
    public final Rect boundsInScreen(SemanticsNodeWithAdjustedBounds node) {
        ...
        long jMo1384localToScreenMKHz9U = this.view.mo1384localToScreenMKHz9U(OffsetKt.Offset(adjustedBounds.left, adjustedBounds.top));
        long jMo1384localToScreenMKHz9U2 = this.view.mo1384localToScreenMKHz9U(OffsetKt.Offset(adjustedBounds.right, adjustedBounds.bottom));
        return new Rect((int) Math.floor(Offset.m842getXimpl(jMo1384localToScreenMKHz9U)), (int) Math.floor(Offset.m843getYimpl(jMo1384localToScreenMKHz9U)), (int) Math.ceil(Offset.m842getXimpl(jMo1384localToScreenMKHz9U2)), (int) Math.ceil(Offset.m843getYimpl(jMo1384localToScreenMKHz9U2)));
    }
    ...
    private final List<SemanticsNode> sortByGeometryGroupings(boolean layoutIsRtl, ArrayList<SemanticsNode> parentListToSort, MutableIntObjectMap<List<SemanticsNode>> containerChildrenMapping) {
        ...
        CollectionsKt.sortWith(arrayList2, new Comparator() { // from class: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat$$ExternalSyntheticLambda0
            @Override // java.util.Comparator
        ...
        while (size <= CollectionsKt.getLastIndex(arrayList2)) {
            List<SemanticsNode> list2 = containerChildrenMapping.get(((SemanticsNode) arrayList2.get(size)).getId());
            if (list2 != null) {
    ...
    */
    ...
    private final String getInfoStateDescriptionOrNull(SemanticsNode node) throws Resources.NotFoundException {
        ...
        if (toggleableState != null) {
            ...
            if (i == 1) {
                if ((role == null ? false : Role.m1659equalsimpl0(role.getValue(), Role.INSTANCE.m1668getSwitcho7Vup1c())) && orNull == null) {
        ...
        if (bool != null) {
            ...
            if (!(role == null ? false : Role.m1659equalsimpl0(role.getValue(), Role.INSTANCE.m1669getTabo7Vup1c())) && orNull == null) {
                if (zBooleanValue) {
    ...
    private final boolean getInfoIsCheckable(SemanticsNode node) {
        ...
        if (((Boolean) SemanticsConfigurationKt.getOrNull(node.getUnmergedConfig(), semanticsProperties.getSelected())) != null) {
            return role != null ? Role.m1659equalsimpl0(role.getValue(), Role.INSTANCE.m1669getTabo7Vup1c()) : false ? z : true;
        }
        return z;
    }
    ...
    private final boolean requestAccessibilityFocus(int virtualViewId) {
        ...
        if (i != Integer.MIN_VALUE) {
            sendEventForVirtualView$default(this, i, pj_ssl_sock_proto.PJ_SSL_SOCK_PROTO_DTLS1, null, null, 12, null);
        }
        this.focusedVirtualViewId = virtualViewId;
        this.view.invalidate();
        sendEventForVirtualView$default(this, virtualViewId, pjmedia_tp_proto.PJMEDIA_TP_PROFILE_AVP, null, null, 12, null);
        return true;
    }
    ...
    private final boolean clearAccessibilityFocus(int virtualViewId) {
        ...
        this.view.invalidate();
        sendEventForVirtualView$default(this, virtualViewId, pj_ssl_sock_proto.PJ_SSL_SOCK_PROTO_DTLS1, null, null, 12, null);
        return true;
    }
    ...
    public final void addExtraDataToAccessibilityNodeInfoHelper(int virtualViewId, AccessibilityNodeInfoCompat info, String extraDataKey, Bundle arguments) {
        ...
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
        if (unmergedConfig$ui_release.contains(semanticsProperties.getTestTag()) && arguments != null && Intrinsics.areEqual(extraDataKey, "androidx.compose.ui.semantics.testTag")) {
    ...
    private final RectF toScreenCoords(SemanticsNode textNode, androidx.compose.ui.geometry.Rect bounds) {
        ...
        androidx.compose.ui.geometry.Rect rectM863translatek4lQ0M = bounds.m863translatek4lQ0M(textNode.m1671getPositionInRootF1C5BW0());
        androidx.compose.ui.geometry.Rect boundsInRoot = textNode.getBoundsInRoot();
        androidx.compose.ui.geometry.Rect rectIntersect = rectM863translatek4lQ0M.overlaps(boundsInRoot) ? rectM863translatek4lQ0M.intersect(boundsInRoot) : null;
        if (rectIntersect == null) {
            return null;
        }
        long jMo1384localToScreenMKHz9U = this.view.mo1384localToScreenMKHz9U(OffsetKt.Offset(rectIntersect.getLeft(), rectIntersect.getTop()));
        long jMo1384localToScreenMKHz9U2 = this.view.mo1384localToScreenMKHz9U(OffsetKt.Offset(rectIntersect.getRight(), rectIntersect.getBottom()));
        return new RectF(Offset.m842getXimpl(jMo1384localToScreenMKHz9U), Offset.m843getYimpl(jMo1384localToScreenMKHz9U), Offset.m842getXimpl(jMo1384localToScreenMKHz9U2), Offset.m843getYimpl(jMo1384localToScreenMKHz9U2));
    }
    ...
    public final int hitTestSemanticsAt$ui_release(float x, float y) {
        ...
        this.view.getRoot().m1481hitTestSemanticsM_7yMNQ$ui_release(OffsetKt.Offset(x, y), hitTestResult, (12 & 4) != 0, (12 & 8) != 0);
        ...
        if (layoutNodeRequireLayoutNode != null && (nodes = layoutNodeRequireLayoutNode.getNodes()) != null && nodes.m1520hasH91voCI$ui_release(NodeKind.m1552constructorimpl(8)) && AndroidComposeViewAccessibilityDelegateCompat_androidKt.isVisible(SemanticsNodeKt.SemanticsNode(layoutNodeRequireLayoutNode, false)) && this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().get(layoutNodeRequireLayoutNode) == null) {
    ...
    */
    ...
    private final void sendSubtreeChangeAccessibilityEvents(LayoutNode layoutNode, MutableIntSet subtreeChangedSemanticsNodesIds) {
        ...
        if (layoutNode.isAttached() && !this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().containsKey(layoutNode)) {
            if (!layoutNode.getNodes().m1520hasH91voCI$ui_release(NodeKind.m1552constructorimpl(8))) {
                layoutNode = AndroidComposeViewAccessibilityDelegateCompat_androidKt.findClosestParentNode(layoutNode, new Function1<LayoutNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat$sendSubtreeChangeAccessibilityEvents$semanticsNode$1
                    ...
                    public final Boolean invoke(LayoutNode layoutNode2) {
                        return Boolean.valueOf(layoutNode2.getNodes().m1520hasH91voCI$ui_release(NodeKind.m1552constructorimpl(8)));
                    }
                });
            }
    ...
    */
    ...
    private final int getAccessibilitySelectionStart(SemanticsNode node) {
        SemanticsConfiguration unmergedConfig$ui_release = node.getUnmergedConfig();
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
        if (!unmergedConfig$ui_release.contains(semanticsProperties.getContentDescription()) && node.getUnmergedConfig().contains(semanticsProperties.getTextSelectionRange())) {
            return TextRange.m1792getStartimpl(((TextRange) node.getUnmergedConfig().get(semanticsProperties.getTextSelectionRange())).getPackedValue());
        }
    ...
    private final int getAccessibilitySelectionEnd(SemanticsNode node) {
        ...
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
        if (!unmergedConfig$ui_release.contains(semanticsProperties.getContentDescription()) && node.getUnmergedConfig().contains(semanticsProperties.getTextSelectionRange())) {
            return TextRange.m1787getEndimpl(((TextRange) node.getUnmergedConfig().get(semanticsProperties.getTextSelectionRange())).getPackedValue());
        }
        return this.accessibilityCursorPosition;
    }
