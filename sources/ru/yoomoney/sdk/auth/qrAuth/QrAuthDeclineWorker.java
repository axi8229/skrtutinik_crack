...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u000e\u0010\t\u001a\u00020\nH\u0096@¢\u0006\u0002\u0010\u000bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\f"}, d2 = {"Lru/yoomoney/sdk/auth/qrAuth/QrAuthDeclineWorker;", "Landroidx/work/CoroutineWorker;", "context", "Landroid/content/Context;", "params", "Landroidx/work/WorkerParameters;", "(Landroid/content/Context;Landroidx/work/WorkerParameters;)V", "getContext", "()Landroid/content/Context;", "doWork", "Landroidx/work/ListenableWorker$Result;", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "auth_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class QrAuthDeclineWorker extends CoroutineWorker {
    ...
    public static final class b extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ListenableWorker.Result>, Object> {
        ...
        public static final class a extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    SignInRepositoryImpl signInRepositoryImpl = this.b;
                    String str = this.c;
                    this.a = 1;
                    if (signInRepositoryImpl.mo3305declinegIAlus(str, this) == coroutine_suspended) {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            b bVar = QrAuthDeclineWorker.this.new b(continuation);
            bVar.a = obj;
            return bVar;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            String string = QrAuthDeclineWorker.this.getInputData().getString(QrAuthDeclineWorkerKt.KEY_PROCESS_ID);
            if (string == null) {
                throw new IllegalArgumentException("Required value was null.");
            }
            Intrinsics.checkNotNullExpressionValue(string, "requireNotNull(...)");
            String string2 = QrAuthDeclineWorker.this.getInputData().getString("logoutBaseURL");
            if (string2 == null) {
                throw new IllegalArgumentException("Required value was null.");
            }
            Intrinsics.checkNotNullExpressionValue(string2, "requireNotNull(...)");
            boolean z = QrAuthDeclineWorker.this.getInputData().getBoolean("isDebugMode", false);
            String string3 = QrAuthDeclineWorker.this.getInputData().getString("logoutToken");
            if (string3 == null) {
                throw new IllegalArgumentException("Required value was null.");
            }
            Intrinsics.checkNotNullExpressionValue(string3, "requireNotNull(...)");
            String string4 = QrAuthDeclineWorker.this.getInputData().getString(QrAuthDeclineWorkerKt.KEY_APPLICATION_USER_AGENT);
            Context applicationContext = QrAuthDeclineWorker.this.getApplicationContext();
            Intrinsics.checkNotNullExpressionValue(applicationContext, "getApplicationContext(...)");
            BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new a(new SignInRepositoryImpl(ApiClientUtilsKt.createApiClient(applicationContext, string2, z, string4).getSignInApi(), string3), string, null), 3, null);
