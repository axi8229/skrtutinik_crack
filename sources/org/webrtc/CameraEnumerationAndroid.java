...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size(160, 120), new Size(240, 160), new Size(320, 240), new Size(400, 240), new Size(pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE, 320), new Size(640, 360), new Size(640, pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE), new Size(768, pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE), new Size(854, pjsip_status_code.PJSIP_SC_TEMPORARILY_UNAVAILABLE), new Size(800, pjsip_status_code.PJSIP_SC_BUSY_EVERYWHERE), new Size(960, 540), new Size(960, 640), new Size(1024, 576), new Size(1024, pjsip_status_code.PJSIP_SC_BUSY_EVERYWHERE), new Size(1280, 720), new Size(1280, 1024), new Size(1920, 1080), new Size(1920, 1440), new Size(2560, 1440), new Size(3840, 2160)));
