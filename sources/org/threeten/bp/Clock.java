...
public abstract class Clock {
    ...
    static final class SystemClock extends Clock implements Serializable {
        ...
        public Clock withZone(ZoneId zoneId) {
            return zoneId.equals(this.f51zone) ? this : new SystemClock(zoneId);
        }
        ...
        public boolean equals(Object obj) {
            if (obj instanceof SystemClock) {
                return this.f51zone.equals(((SystemClock) obj).f51zone);
            }
            return false;
        }
        ...
        @Override // org.threeten.bp.Clock
        public int hashCode() {
            return this.f51zone.hashCode() + 1;
        }

        public String toString() {
            return "SystemClock[" + this.f51zone + "]";
        }
    }
    ...
    static final class FixedClock extends Clock implements Serializable {
        ...
        @Override // org.threeten.bp.Clock
        public Clock withZone(ZoneId zoneId) {
            return zoneId.equals(this.f50zone) ? this : new FixedClock(this.instant, zoneId);
        }
        ...
        public boolean equals(Object obj) {
            ...
            return this.instant.equals(fixedClock.instant) && this.f50zone.equals(fixedClock.f50zone);
        }

        @Override // org.threeten.bp.Clock
        public int hashCode() {
            return this.instant.hashCode() ^ this.f50zone.hashCode();
        }

        public String toString() {
            return "FixedClock[" + this.instant + "," + this.f50zone + "]";
        }
    }
